...
#include <android/hardware/manager/1.0/BnServiceManager.h>
...
using android::hardware::manager::V1_0::BnServiceManager;
using android::hardware::manager::V1_0::IServiceManager;
using Version = android::hardware::manager::V1_0::IServiceManager::Version;

// android.hardware.manager@1.0-service
using android::hardware::manager::V1_0::implementation::ServiceManager;
...
int main() {
    ...
    manager->HIDL_INTERNAL_addService(name, service, version);
