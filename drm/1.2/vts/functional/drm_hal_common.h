<<<<<<< TARGET BRANCH (d973ce [automerger skipped] Fix tests for devices that don't have d)
=======
/*
...
>>>>>>> SOURCE BRANCH (8a006c drm@1.2 vts: force provision multiple security levels)
