...
In Android Pie, an `<fqname>` tag was introduced to express DRM HAL versions
...
satisfy requirements, because older version of `libvintf` does not recognize it,
causing errors during OTA update.

Assuming that the HAL provides `@1.0::I*/default`,
`@1.1::I*/clearkey` and `@1.1::I*/widevine` instances:
