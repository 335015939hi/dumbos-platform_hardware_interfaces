 ...
 * {@link android.hardware.automotive.audiocontrol.IAudioControl#onDevicesToDuckChange} and
 * {@link android.hardware.automotive.audiocontrol.IAudioControl#onDevicesToMuteChange} APIs.
 *
...
oneway interface IAudioGainCallback {
     ...
     *                by gain limitation that shall be notified/enforced at CarAudioService layer.
     *
     * @param gains List of gains affected by the change.
     */
    void onAudioDeviceGainsChanged(in int[] reasons, in AudioGainConfigInfo[] gains);
}
