 ...
 *
 * Also, expecting to expose device type as soon as {@link android.media.AudioManager} would expose
 * non hidden API to retrieve list of port
 * and make the matching.
 */
@VintfStability
parcelable AudioGainConfigInfo {
     ...
     *
     * At JAVA layer, it is retrieved from {@link audio.media.AudioDeviceInfo#getId} right after
     * retrieving the list of Audio Devices using {@link android.media.AudioManager#getDevices}
