 ...
 *
 * Also, expecting to expose device type and device port handle id as soon as
 * {@link android.media.AudioManager} would expose non hidden API to retrieve list of port
