...
enum Reasons {
     ...
     * This may be used in case of cyber attach to ensure driver can safely drive back to garage
     * to restore sw.
     */
    ...
    * For regulation issue, the action of mute could be managed by HAL itself.
    ...
    NAV_DUCKING                     = 0x10,
    /**
     * Some Smartphone projection stack may send signal to IVI to duck / unduck main audio stream.
     * In this case, Contextual Volume Policy may be adapted to control the alternate / secondary
     * audio stream.
     */
    SMARTPHONE_PROJECTION_DUCKING   = 0x20,
    /**
