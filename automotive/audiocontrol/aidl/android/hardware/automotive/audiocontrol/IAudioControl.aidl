...
interface IAudioControl {
     ...
     * @param focusChange the AudioFocusChange that has occurred.
     */
    oneway void onAudioFocusChangeV2(in PlaybackTrackMetadata playbackMetaData,
     ...
     * @param gains List of gains the change is intended to.
      */
     oneway void setAudioDeviceGainsChanged(in int[] reasons, in AudioGainConfigInfo[] gains);
