...
import android.hardware.automotive.audiocontrol.PlaybackTrackMetadataExt;
...
interface IFocusListener {
     ...
     *
     * Deprecated in API 2 to allow generic interface callback listener.
     * Use {@link android.hardware.automotive.audiocontrol.IFocusListener#abandonHalAudioFocus}
     * instead
     *
     ...
     *
     * Deprecated in API 2 to allow generic interface callback listener.
     * Use {@link android.hardware.automotive.audiocontrol.IFocusListener#requestHalAudioFocus}
     * instead
     *
     ...
     * {@link android.hardware.automotive.audiocontrol.PlaybackTrackMetadataExt} has released
     * the focus.
     *
     * @param playbackMetaDataExt The output stream metadata associated with the focus request
     */
    oneway void abandonHalAudioFocus(in PlaybackTrackMetadataExt playbackMetaDataExt);

    /**
     * Used to indicate that the audio output stream associated with
     * {@link android.hardware.automotive.audiocontrol.PlaybackTrackMetadataExt} has taken
     * the focus.
     *
     * @param playbackMetaDataExt The output stream metadata associated with the focus request
     ...
     */
    oneway void requestHalAudioFocus(in PlaybackTrackMetadataExt playbackMetaDataExt,
