...
class AudioControl : public BnAudioControl {
  public:
    ...
    ndk::ScopedAStatus onAudioFocusChangeWithMetaData(
            const audiohalcommon::PlaybackTrackMetadata& in_playbackMetaData,
            int32_t in_zoneId, AudioFocusChange in_focusChange) override;
