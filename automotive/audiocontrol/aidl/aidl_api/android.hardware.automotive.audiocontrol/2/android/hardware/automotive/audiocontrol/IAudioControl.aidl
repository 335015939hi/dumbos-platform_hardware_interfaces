...
interface IAudioControl {
  ...
  oneway void onAudioFocusChangeV2(in android.hardware.audio.common.PlaybackTrackMetadata playbackMetaData, in int zoneId, in android.hardware.automotive.audiocontrol.AudioFocusChange focusChange);
  oneway void setAudioDeviceGainsChanged(in int[] reasons, in android.hardware.automotive.audiocontrol.AudioGainConfigInfo[] gains);
