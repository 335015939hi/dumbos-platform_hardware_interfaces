        ...
        auto surroundView3dFunc = mFuzzedDataProvider->PickValueInArray<
                ...
                [&]() {
                    ...
                    config.height = mFuzzedDataProvider->ConsumeIntegralInRange<uint32_t>(
                            kMinConfigDimension, kMaxConfigDimension);
                    config.carDetails = mFuzzedDataProvider->ConsumeBool() ? (SvQuality::HIGH)
                                                                           : (SvQuality::LOW);
                ...
                [&]() {
                    ...
                    surroundView3dSession->projectCameraPointsTo3dSurface(
                            ...
                            [&points3d](
                                    [[maybe_unused]] const hidl_vec<Point3dFloat>& points3dproj) {
                                points3d = points3dproj;
                            });
                },
                [&]() {
                    auto updateOverlaysFunc = mFuzzedDataProvider->PickValueInArray<
                            const std::function<void()>>({
                            [&]() {
                                // success case
                            ...
                            [&]() {
                                ...
                                setIndexOfOverlaysMemory(
                                        overlaysDescVector, pIMemory, indexPosition,
