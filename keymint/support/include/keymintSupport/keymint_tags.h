...
DECLARE_TYPED_TAG(ATTESTATION_CERTIFICATE_SERIAL);
DECLARE_TYPED_TAG(ATTESTATION_CERTIFICATE_SUBJECT);
...
using all_tags_t = MetaList<
        ...
        TAG_TRUSTED_USER_PRESENCE_REQUIRED_t, TAG_ATTESTATION_CERTIFICATE_SERIAL_t,
        TAG_ATTESTATION_CERTIFICATE_SUBJECT_t, TAG_IDENTITY_CREDENTIAL_KEY_t, TAG_STORAGE_KEY_t,
        TAG_DEVICE_UNIQUE_ATTESTATION_t, TAG_EARLY_BOOT_ONLY_t>;
...
MAKE_TAG_VALUE_ACCESSOR(TagType::DATE, integer)
