...
enum Tag {
     ...
     * Must be hardware-enforced.
     */
    BLOCK_MODE = (2 << 28) /* TagType:ENUM_REP */ | 4, /* BlockMode. */
     ...
     */
    ACTIVE_DATETIME = (6 << 28) /* TagType:DATE */ | 400, /* Start of validity. */
     ...
     * Must be hardware-enforced.
     */
    USER_SECURE_ID = (4 << 28) /* TagType:UINT_REP */ | 502, /* Secure ID of authorized user or authenticator(s).
     ...
     * Must be hardware-enforced.
     */
    NO_AUTH_REQUIRED = (7 << 28) /* TagType:BOOL */ | 503, /* If key is usable without authentication. */
     ...
     * Must never appear in KeyCharacteristics.
     */
    ATTESTATION_CHALLENGE = (9 << 28) /* TagType:BYTES */ | 708, /* Used to provide challenge in attestation */
     ...
     * Must never appear in KeyCharacteristics.
     */
    ATTESTATION_ID_IMEI = (9 << 28) /* TagType:BYTES */ | 714, /* Used to provide the device's IMEI to be included
                                                  * in attestation */
     ...
     * Must never appear in KeyCharacteristics.
     */
    ATTESTATION_ID_MEID = (9 << 28) /* TagType:BYTES */ | 715, /* Used to provide the device's MEID to be included
                                                  * in attestation */
     ...
     */
    ATTESTATION_CERTIFICATE_SERIAL = (9 << 28) /* TagType:BYTES */ | 1006,

    /**
     * Tag::ATTESTATION_CERTIFICATE_SUBJECT specify the subject of the certificate to be attached
     * with the attestation certificate generated for the given key.  he serial number to be
     * assigned to the attestation certificate to be generated for the given key.  This parameter
     * should only be passed to keyMint in the attestation parameters during generateKey() and
     * importKey().
     */
    ATTESTATION_CERTIFICATE_SUBJECT = (9 << 28) /* TagType:BYTES */ | 1007,
}
