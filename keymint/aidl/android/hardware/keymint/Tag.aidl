...
enum Tag {
     ...
     * must be decremented after the finish() call. Once the value is decreased to zero, the key
     * must be deleted which would result in all subsequent attempts to use this key to fail with
     ...
     * of this tag is zero and the IkeyMintDevice should return ErrorCode::USAGE_LIMIT_EXHAUSTED.
     *
