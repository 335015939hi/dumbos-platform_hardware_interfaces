...
interface IKeyMintDevice {
     ...
     * == Attestation ==
     *
     * If the generated key is an asymmetric key, and Tag::ATTESTATION_CHALLENGE is included in
     * keyParams, then an attestation certificate for the generated key in the format of X.509
     * will be signed and returned in the field outCertChain. If the generated key is an asymmetric
     * signing key, but no challenge is provided, then a self signed single certificate will be
     * returned. If the generated key is an asymmetric encryption key with no challenge provided,
     * then a fake X.509 certificate will be returned with invalid signature.  If the generated
     * key is a symmetric key, then the attestation certificate will return null.
     *
     ...
     *   attestation parameter using CERTIFICATE_SERIAL tag.  If the tag is missing, then
     ...
     *   self signed certificates and fake certificates (no challenge provided and not an signing
     ...
     *   CERTIFICATE_SUBJECT is missing in the attestation parameter, then subject of
     ...
     *
     * In addition to the above, with the exception of fake certificates and self signed
     ...
     *
     * @param keyParams Key generation and attestation parameters are defined as KeyMintDevice
     *        tag/value pairs, provided in params.  See above for detailed specifications of
     ...
     *
     * @param inKeyParams Key generation and attestation parameters are defined as
     *        KeyMintDevice tag/value pairs, provided in params. For more details see
     *        documentation in generateKey section.
     *
     ...
     */
    void importKey(in KeyParameter[] inKeyParams,
     ...
     *        modes must be specified in this argument. Attestation parameters should also be
     *        included in this argument. For more details see the documentation in generateKey
     *        section.
     *
