 ...
 * and "strongboxEnforced" elements of the KeyCharacteristics struct. Note that those software
 * enforced authorization list are not returned as they are not enforced by keymint.  The
 ...
 *
 * The caller must always provide the current date time in the keyParameter tags.
 *
 ...
 *
 * IKeyMintDevice implementations must place any tags they cannot fully and completely enforce in
 ...
 * possible for the IKeyMintDevice to enforce this tag.  An IKeyMintDevice implementation may
 ...
 *
 * It is recommended that IKeyMintDevices not enforce any tags they place in the softwareEnforced
 ...
 * state is changed, then all of the IKeyMintDevice-protected keys created by the previous system
 ...
 * operating system to use IKeyMintDevice keys.
 *
 * == Version Binding ==
 *
 ...
 * must be upgraded (See IKeyMintDevice::upgradeKey()) before it can be used, and the previous
 ...
 */
@VintfStability interface IKeyMintDevice {
    /**
     * Returns information about the underlying IKeyMintDevice hardware.
     *
     * @return security level of the IKeyMintDevice implementation accessed through this HAL.
     *
     * @return keyMintName is the name of the IKeyMintDevice implementation.
     *
     * @return keyMintAuthorName is the name of the author of the IKeyMintDevice implementation
     ...
     * returned by StrongBox begin().  If it cannot verify any, the parametersVerified
     * field of the VerificationToken must be empty.  Keystore must then pass the
     ...
     *
     * @return keyCharacteristics Description of the generated key, divided into two sets:
     ...
     *
     * @return outCertChain If the key is an asymetric key, and proper keyparameters for
     ...
     *         value. The certificates must be DER-encoded.
     */
     ...
     *
     * @return keyBlob descriptor of the imported key.  The format of the keyblob will be the
     *         google specified keyblob format.
     *
     * @return keyCharacteristics Description of the generated key.  See the keyCharacteristics
     *         description in generateKey.
     *
    ...
    void importKey(in KeyParameter[] inKeyParams, in KeyFormat inKeyFormat,
                   in byte[] inKeyData, out byte[] outImportedKeyBlob,
     ...
     *       with the @3.0::IKeyMintDevice::importKey.  See attestKey() for documentation of the
     ...
     *         hardware.
     *
     * @return keyCharacteristics Description of the generated key.  See the description of
