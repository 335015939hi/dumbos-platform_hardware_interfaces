...
@VintfStability interface IKeyMintDevice {
     ...
     * must thread the single attestation certificate returned in generateKey() and importKey()
     ...
     * chain returned in this function with the single attestation certificate returned when
     ...
     *         attestation (such as challenge) are provided, then this parameter will return the
     ...
     *         attestation certificate will not contain the creation datetime.  The first
     *         certificate in the vector is the attestation for the generated key itself, the
     *         next certificate is the key that signs the first certificate, and so forth.
     *         The last certificate in the chain is the root certificate.  If the key is a
     *         symetric key, then no certificate will be returned and this variable will return
     *         empty. Please see generateKey for more details on the attestation certificate and
     *         challenge.
     */
