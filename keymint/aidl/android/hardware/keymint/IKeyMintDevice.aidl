...
@VintfStability interface IKeyMintDevice {
     ...
     *
     * @return info.versionNumber of the hardware version.
     *
     * @return info.securityLevel of the IKeyMintDevice implementation accessed through this HAL.
     *
     * @return info.keyMintName is the name of the IKeyMintDevice implementation.
     *
     * @return info.keyMintAuthorName is the name of the author of the IKeyMintDevice implementation
