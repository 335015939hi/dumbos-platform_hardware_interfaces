...
parcelable HardwareAuthToken {
     ...
     * structure.
     *
     * Note that mac could be empty when unused.  As documented in the IKeyMintDevice::begin,
     * IKeyMintDevice::update and IKeyMintDevice::finish doc comments, an empty mac indicates
     * that this auth token is empty.  TODO: make this nullable.
     */
    byte[] mac;
}
