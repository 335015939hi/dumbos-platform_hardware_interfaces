...
enum KeyOrigin {
    ...
    /**
     * KeyMint did not record origin.  This value can only be seen on keys in a keymaster0
     * implementation.  The keymaster0 adapter uses this value to document the fact that it is
     * unknown whether the key was generated inside or imported into keymaster / keyMint.
     *
     * TODO(seleneh) eleminate this from the code and tests.
     */
    UNKNOWN = 3,
