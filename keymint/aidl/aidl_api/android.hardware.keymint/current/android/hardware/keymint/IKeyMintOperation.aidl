...
interface IKeyMintOperation {
  int update(in @nullable android.hardware.keymint.KeyParameterArray inParams, in byte[] input, in @nullable android.hardware.keymint.VerificationToken inVerificationToken, out @nullable android.hardware.keymint.KeyParameterArray outParams, out @nullable byte[] output);
