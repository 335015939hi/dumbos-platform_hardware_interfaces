...
interface IKeyMintDevice {
  ...
  void generateKey(in android.hardware.keymint.KeyParameter[] keyParams, in android.hardware.keymint.KeyParameter[] attestParams, in @nullable byte[] attestKeyBlob, out android.hardware.keymint.ByteArray generatedKeyBlob, out android.hardware.keymint.KeyCharacteristics generatedKeyCharacteristics, out android.hardware.keymint.Certificate[] outCertChain);
  void importKey(in android.hardware.keymint.KeyParameter[] inKeyParams, in android.hardware.keymint.KeyFormat inKeyFormat, in byte[] inKeyData, in android.hardware.keymint.KeyParameter[] attestParams, in @nullable byte[] attestKeyBlob, out android.hardware.keymint.ByteArray outImportedKeyBlob, out android.hardware.keymint.KeyCharacteristics outImportedKeyCharacteristics, out android.hardware.keymint.Certificate[] outCertChain);
