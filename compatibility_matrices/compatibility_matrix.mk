...
$(warning Bill:$(LOCAL_MODULE) my_matrix_src_files=$(my_matrix_src_files))

$(warning Bill:$(LOCAL_MODULE) LOCAL_ASSEMBLE_VINTF_ENV_VARS=$(LOCAL_ASSEMBLE_VINTF_ENV_VARS))

$(warning Bill:$(LOCAL_MODULE) LOCAL_SRC_FILES=$(LOCAL_SRC_FILES))

$(warning Bill:$(LOCAL_MODULE) LOCAL_GENERATED_SOURCES=$(LOCAL_GENERATED_SOURCES))
