...
class Bump(object):
    ...
    def __init__(self, cmdline_args):
        ...
        self.bugline = f"Bug: {cmdline_args.bug}\n" if cmdline_args.bug else ""
    ...
    def copy_matrix(self):
        ...
        check_call(f"git -C {self.interfaces_dir} add {rel_next_xml}",
                   shell=True)
    ...
    def edit_android_bp(self):
        ...
        check_call(f"git -C {self.interfaces_dir} add {rel_android_bp}",
                   shell=True)
    ...
    def edit_android_mk(self):
        ...
        check_call(f"git -C {self.interfaces_dir} add {rel_android_mk}",
                   shell=True)
    ...
    def print_summary(self):
        ...
        check_call(f"git -C {self.interfaces_dir} show -s --format=%B HEAD",
                   shell=True)
