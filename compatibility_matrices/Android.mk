...
LOCAL_SRC_FILES := compatibility_matrix.legacy.xml
...
LOCAL_SRC_FILES := compatibility_matrix.1.xml
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_PATH := $(TARGET_OUT)/etc/vintf
include $(BUILD_PREBUILT)
...
LOCAL_SRC_FILES := compatibility_matrix.2.xml
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_PATH := $(TARGET_OUT)/etc/vintf
include $(BUILD_PREBUILT)
...
LOCAL_SRC_FILES := compatibility_matrix.current.xml
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_PATH := $(TARGET_OUT)/etc/vintf
include $(BUILD_PREBUILT)
