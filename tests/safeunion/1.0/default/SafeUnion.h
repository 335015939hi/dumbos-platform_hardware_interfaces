...
struct SafeUnion : public ISafeUnion {
    ...
    Return<void> setE(const LargeSafeUnion& myUnion, const hidl_array<uint8_t, 13>& e, setE_cb _hidl_cb) override;
    Return<void> setF(const LargeSafeUnion& myUnion, const hidl_array<uint64_t, 5>& f, setF_cb _hidl_cb) override;
