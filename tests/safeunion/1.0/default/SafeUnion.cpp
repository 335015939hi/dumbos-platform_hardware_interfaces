...
Return<void> SafeUnion::setInterfaceD(const InterfaceTypeSafeUnion& myUnion, const hidl_string& d, setInterfaceD_cb _hidl_cb) {
...
Return<void> SafeUnion::setInterfaceE(const InterfaceTypeSafeUnion& myUnion, const hidl_vec<hidl_string>& e, setInterfaceE_cb _hidl_cb) {
...
Return<void> SafeUnion::setInterfaceF(const InterfaceTypeSafeUnion& myUnion, const hidl_handle& f, setInterfaceF_cb _hidl_cb) {
...
Return<void> SafeUnion::setInterfaceG(const InterfaceTypeSafeUnion& myUnion, const hidl_vec<hidl_handle>& g, setInterfaceG_cb _hidl_cb) {
...
Return<void> SafeUnion::setHandleA(const ::android::hardware::tests::safeunion::V1_0::ISafeUnion::HandleTypeSafeUnion& myUnion, const hidl_handle& a, setHandleA_cb _hidl_cb) {
...
Return<void> SafeUnion::setHandleB(const HandleTypeSafeUnion& myUnion, const hidl_array<hidl_handle, 5>& b, setHandleB_cb _hidl_cb) {
...
Return<void> SafeUnion::setHandleC(const HandleTypeSafeUnion& myUnion, const hidl_vec<hidl_handle>& c, setHandleC_cb _hidl_cb) {
