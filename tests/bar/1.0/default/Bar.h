...
struct Bar : public IBar {
    ...
    Return<void> getMyPrecious(bool sendRemote, getMyPrecious_cb _hidl_cb)  override;
    Return<void> getYourPrecious(bool sendRemote, getYourPrecious_cb _hidl_cb)  override;

private:
    sp<IFoo> mFoo;
    sp<IYourPrecious> mPrecious;
};
