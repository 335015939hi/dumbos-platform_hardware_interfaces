...
class ISensorsSubHalBase : public ISensorsEventCallback {
  ...
  protected:
     ...
     */
    std::map<int32_t, std::shared_ptr<AmbientLightSensor>> mSensors;
...
class SensorsSubHal : public SubHalVersion {
  public:
    SensorsSubHal() {
        ISensorsSubHalBase::AddSensor<AmbientLightSensor>();
    }
};

class SetOperationModeFailingSensorsSubHal : public SensorsSubHal<SensorsSubHalV2_0> {
  public:
    Return<Result> setOperationMode(OperationMode mode) override;
};

class AllSupportDirectChannelSensorsSubHal : public SensorsSubHal<SensorsSubHalV2_0> {
  public:
    Return<void> getSensorsList(V2_0::ISensors::getSensorsList_cb _hidl_cb) override;
};

class DoesNotSupportDirectChannelSensorsSubHal : public SensorsSubHal<SensorsSubHalV2_0> {
  public:
    Return<void> getSensorsList(V2_0::ISensors::getSensorsList_cb _hidl_cb) override;
};

class AddAndRemoveDynamicSensorsSubHal : public SensorsSubHal<SensorsSubHalV2_0> {
  public:
