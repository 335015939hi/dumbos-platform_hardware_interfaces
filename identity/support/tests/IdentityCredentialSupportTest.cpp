...
TEST(IdentityCredentialSupport, CoseMac0) {
    ...
    vector<uint8_t> additionalData = {0x20, 0x21, 0x22, 0x23, 0x24};
    vector<uint8_t> mac;

    ASSERT_TRUE(support::coseMac0(key, data, additionalData, mac));
    string out;
    ...
    EXPECT_EQ(
            ...
            "  {},\n"
            "  {0x10, 0x11, 0x12, 0x13},\n"
            "  {0x3a, 0x13, 0x92, 0x2a, 0xfa, 0xfd, 0xae, 0x85, 0xc5, 0x97, 0x94, 0xfa,"
            " 0x13, 0xb3, 0x3d, 0xa0, 0x0c, 0x1b, 0xa6, 0x50, 0xc2, 0x79, 0xc7, 0x83, 0x5a, "
            "0xda, 0xa4, 0x07, 0x8c, 0x0a, 0xcd, 0x3b},\n"
            "]",
            out);
}
