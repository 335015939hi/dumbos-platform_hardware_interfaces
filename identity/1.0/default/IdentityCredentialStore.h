...
#ifndef ANDROID_HARDWARE_IDENTITY_V1_0_IDENTITYCREDENTIALSTORE_H
#define ANDROID_HARDWARE_IDENTITY_V1_0_IDENTITYCREDENTIALSTORE_H
...
using ::android::hardware::identity::V1_0::CipherSuite;
...
class IdentityCredentialStore : public IIdentityCredentialStore {
  public:
    ...
    // Methods from ::android::hardware::identity::V1_0::IIdentityCredentialStore follow.
    ...
    Return<void> getCredential(const hidl_vec<uint8_t>& credentialData, CipherSuite cipherSuite,
...
#endif  // ANDROID_HARDWARE_IDENTITY_V1_0_IDENTITYCREDENTIALSTORE_H
