...
Return<void> WritableIdentityCredential::getAttestationCertificate(
    ...
    // TODO update this when app id CL is in.
    vector<uint8_t> attestationApplicationId(10, 'c');
    optional<std::pair<vector<uint8_t>, vector<uint8_t>>> keyAttestationPair =
    ...
    _hidl_cb(support::resultOK(), certificateChain_);
    return Void();
}
