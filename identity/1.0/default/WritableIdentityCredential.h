...
#ifndef ANDROID_HARDWARE_IDENTITY_V1_0_WRITABLEIDENTITYCREDENTIAL_H
#define ANDROID_HARDWARE_IDENTITY_V1_0_WRITABLEIDENTITYCREDENTIAL_H
...
struct WritableIdentityCredential : public IWritableIdentityCredential {
    ...
    // Methods from ::android::hardware::identity::V1_0::IWritableIdentityCredential
    // follow.
    ...
    Return<void> addAccessControlProfile(uint8_t id, const hidl_vec<uint8_t>& readerCertificate,
                                         bool userAuthenticationRequired, uint32_t timeout,
...
#endif  // ANDROID_HARDWARE_IDENTITY_V1_0_WRITABLEIDENTITYCREDENTIAL_H
