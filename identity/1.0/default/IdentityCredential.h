...
#ifndef ANDROID_HARDWARE_IDENTITY_V1_0_IDENTITYCREDENTIAL_H
#define ANDROID_HARDWARE_IDENTITY_V1_0_IDENTITYCREDENTIAL_H
...
using ::android::hardware::identity::V1_0::AccessControlProfileId;
...
struct IdentityCredential : public IIdentityCredential {
    explicit IdentityCredential(const hidl_vec<uint8_t>& credentialData, CipherSuite cipherSuite)
        : credentialData_(credentialData), cipherSuite_(cipherSuite) {}
  ...
  private:
    ...
    map<AccessControlProfileId, ResultCode> profileIdToAccessCheckResult_;
...
#endif  // ANDROID_HARDWARE_IDENTITY_V1_0_IDENTITYCREDENTIAL_H
