...
class IdentityCredential : public IIdentityCredential {
  public:
    IdentityCredential(const hidl_vec<uint8_t>& credentialData, CipherSuite cipherSuite)
        : credentialData_(credentialData), cipherSuite_(cipherSuite), authChallenge_(0) {}
