...
class IdentityCredentialUnitTests : public testing::TestWithParam<string> {
  public:
...
TEST_P(IdentityCredentialUnitTests, verifyAttestationWithEmptyChallenge) {
    Status result;
...
TEST_P(IdentityCredentialUnitTests, verifyAttestationSuccessWithChallenge) {
    Status result;
    sp<IWritableIdentityCredential> writableCredential;
    ASSERT_TRUE(test_utils::SetupWritableCredential(writableCredential, credentialStore_));
