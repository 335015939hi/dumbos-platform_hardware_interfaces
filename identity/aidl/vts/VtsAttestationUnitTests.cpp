...
TEST_P(VtsAttestationUnitTests, verifyAttestationWithEmptyChallengeEmptyId) {
    Status result;
...
TEST_P(VtsAttestationUnitTests, verifyAttestationWithEmptyChallengeNonemptyId) {
    Status result;
    sp<IWritableIdentityCredential> writableCredential;
...
TEST_P(VtsAttestationUnitTests, verifyAttestationWithNonemptyChallengeEmptyId) {
    Status result;
    sp<IWritableIdentityCredential> writableCredential;
    ASSERT_TRUE(SetupWritableCredential(writableCredential, credentialStore_));
...
TEST_P(VtsAttestationUnitTests, verifyAttestationWithNonemptyChallengeNonemptyId) {
    Status result;
    sp<IWritableIdentityCredential> writableCredential;
    ASSERT_TRUE(SetupWritableCredential(writableCredential, credentialStore_));
...
TEST_P(VtsAttestationUnitTests, verifyAttestationWithVeryShortChallengeAndId) {
    Status result;
    sp<IWritableIdentityCredential> writableCredential;
    ASSERT_TRUE(SetupWritableCredential(writableCredential, credentialStore_));
