...
class FakeSecureHardwareProvisioningProxy : public SecureHardwareProvisioningProxy {
  public:
    ...
    optional<vector<uint8_t>> finishGetCredentialData(bool testCredential,
...
class FakeSecureHardwarePresentationProxy : public SecureHardwarePresentationProxy {
  public:
    ...
    bool setHardwareAuthToken(uint64_t challenge, uint64_t secureUserId, uint64_t authenticatorId,
    ...
    bool validateAccessControlProfile(int id, const vector<uint8_t>& readerCertificate,
                                      bool userAuthenticationRequired, int timeoutMillis,
                                      uint64_t secureUserId, const vector<uint8_t>& mac) override;
