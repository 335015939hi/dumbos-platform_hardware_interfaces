...
ndk::ScopedAStatus IdentityCredential::startRetrieval(
    ...
    expectedDeviceNameSpacesSize_ = calcDeviceNameSpacesSize(accessControlProfileMask);
...
size_t IdentityCredential::calcDeviceNameSpacesSize(uint32_t accessControlProfileMask) {
    /*
