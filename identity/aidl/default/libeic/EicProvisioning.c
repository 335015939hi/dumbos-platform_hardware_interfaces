...
bool eicProvisioningCreateCredentialKey(EicProvisioning* ctx, const uint8_t* challenge,
    ...
    if (!eicOpsCreateCredentialKey(ctx->credentialPrivateKey, publicKey, challenge, challengeSize,
...
bool eicProvisioningStartPersonalization(EicProvisioning* ctx, int accessControlProfileCount,
    ...
    for (size_t n = 0; n < numEntryCounts; n++) {
        /*
          TODO: uncomment once IdentityCredentialTests.verifyStartPersonalizationLarge
          has been fixed to use a value less than 256 (currently using 3000)
