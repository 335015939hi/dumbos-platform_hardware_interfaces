...
bool eicCborCalcEntryAdditionalData(const uint8_t* accessControlProfileIds,
    ...
    eicCborAppendString(&cborBuilder, "Namespace", sizeof("Namespace") - 1);
    eicCborAppendString(&cborBuilder, nameSpace, nameSpaceLength);
    eicCborAppendString(&cborBuilder, "Name", sizeof("Name") - 1);
    eicCborAppendString(&cborBuilder, name, nameLength);
    eicCborAppendString(&cborBuilder, "AccessControlProfileIds", sizeof("AccessControlProfileIds") - 1);
