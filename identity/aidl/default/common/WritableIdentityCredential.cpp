...
ndk::ScopedAStatus WritableIdentityCredential::getAttestationCertificate(
        const vector<int8_t>& attestationApplicationId, const vector<int8_t>& attestationChallenge,
...
ndk::ScopedAStatus WritableIdentityCredential::getAttestationCertificate(
    ...
    optional<vector<uint8_t>> certChain =
            hwProxy_->createCredentialKey(byteStringToUnsigned(attestationChallenge),
                                          byteStringToUnsigned(attestationApplicationId));
#else
    optional<vector<uint8_t>> certChain =
...
ndk::ScopedAStatus WritableIdentityCredential::addAccessControlProfile(
    ...
    optional<vector<uint8_t>> mac = hwProxy_->addAccessControlProfile(
            id, byteStringToUnsigned(readerCertificate.encodedCertificate),
