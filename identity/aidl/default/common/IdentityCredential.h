...
class IdentityCredential : public BnIdentityCredential {
  public:
    ...
    ndk::ScopedAStatus setAvailableAuthenticationKeys(const int32_t in_keyCount,
                                                      const int32_t in_maxUsesPerKey) override;

    ndk::ScopedAStatus getAuthKeysNeedingCertification(vector<uint8_t>* out_x509Certificates,
                                                       int32_t* out_x509CertificatesSize) override;
