...
ndk::ScopedAStatus IdentityCredential::deleteCredential(
    ...
    if (!signature) {
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::FAILED), "Error signing data"));
    }
...
ndk::ScopedAStatus IdentityCredential::createEphemeralKeyPair(vector<int8_t>* outKeyPair) {
    ...
    if (!kp) {
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::FAILED), "Error creating ephemeral key pair"));
    }
    ...
    if (!publicKey) {
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::FAILED), "Error getting public part of ephemeral key pair"));
    }
...
ndk::ScopedAStatus IdentityCredential::createAuthChallenge(int64_t* outChallenge) {
    ...
    while (challenge == 0) {
        ...
        if (!bytes) {
            return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                    int(ResultCode::FAILED), "Error getting random data for challenge"));
        }
...
ndk::ScopedAStatus IdentityCredential::startRetrieval(
    ...
    if (sessionTranscript.size() > 0) {
        ...
        if (item == nullptr) {
            return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                    int(ResultCode::INVALID_DATA), "SessionTranscript contains invalid CBOR"));
        }
    ...
    if (numStartRetrievalCalls_ > 0) {
        if (sessionTranscript_ != sessionTranscript) {
            return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                    int(ResultCode::SESSION_TRANSCRIPT_MISMATCH),
    ...
    if (readerSignature.size() > 0) {
        ...
        if (!readerCertificateChain) {
            return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                    int(ResultCode::READER_SIGNATURE_CHECK_FAILED),
    ...
    if (sessionTranscript.size() > 0) {
        ...
        if (array == nullptr || array->size() != 2) {
            return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                    int(ResultCode::EPHEMERAL_PUBLIC_KEY_NOT_FOUND),
    ...
    if (itemsRequest.size() > 0) {
        ...
        if (item == nullptr) {
            return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                    int(ResultCode::INVALID_ITEMS_REQUEST_MESSAGE),
    ...
    for (const auto& profile : accessControlProfiles) {
        if (!secureAccessControlProfileCheckMac(profile, storageKey_)) {
            return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                    int(ResultCode::INVALID_DATA), "Error checking MAC for profile"));
        }
...
ndk::ScopedAStatus IdentityCredential::startRetrieveEntryValue(
    ...
    if (name.empty()) {
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::INVALID_DATA), "Name cannot be empty"));
    }
    if (nameSpace.empty()) {
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::INVALID_DATA), "Name space cannot be empty"));
    }

    if (requestCountsRemaining_.size() == 0) {
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::INVALID_DATA), "No more name spaces left to go through"));
    }
    ...
    if (itemsRequest_.size() > 0) {
        ...
        if (it == requestedNameSpacesAndNames_.end()) {
            return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                    int(ResultCode::NOT_IN_REQUEST_MESSAGE),
    ...
    for (auto id : accessControlProfileIds) {
        ...
        if (search == profileIdToAccessCheckResult_.end()) {
            return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                    int(ResultCode::INVALID_DATA), "Requested entry with unvalidated profile id"));
        }
...
ndk::ScopedAStatus IdentityCredential::retrieveEntryValue(const vector<int8_t>& encryptedContentS,
    ...
    if (!content) {
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::INVALID_DATA), "Error decrypting data"));
    }
    ...
    if (chunkSize > entryRemainingBytes_) {
        ...
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::INVALID_DATA), "Retrieved chunk is bigger than remaining space"));
    }
    ...
    if (entryRemainingBytes_ == 0) {
        ...
        if (entryValueItem == nullptr) {
            return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                    int(ResultCode::INVALID_DATA), "Retrieved data which is invalid CBOR"));
        }
...
ndk::ScopedAStatus IdentityCredential::finishRetrieval(const vector<int8_t>& signingKeyBlobS,
    ...
    if (signingKeyBlob.size() > 0 && sessionTranscript_.size() > 0 && readerPublicKey_.size() > 0) {
        ...
        if (!signingKey) {
            return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                    int(ResultCode::INVALID_DATA), "Error decrypting signingKeyBlob"));
        }
        ...
        if (!sharedSecret) {
            return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                    int(ResultCode::FAILED), "Error doing ECDH"));
        }
        ...
        if (!derivedKey) {
            return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                    int(ResultCode::FAILED), "Error deriving key from shared secret"));
        }
        ...
        if (!mac) {
            return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                    int(ResultCode::FAILED), "Error MACing data"));
        }
    }
...
ndk::ScopedAStatus IdentityCredential::generateSigningKeyPair(
    ...
    if (!signingKeyPKCS8) {
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::FAILED), "Error creating signingKey"));
    }
    ...
    if (!signingPublicKey) {
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::FAILED), "Error getting public part of signingKey"));
    }

    optional<vector<uint8_t>> signingKey = support::ecKeyPairGetPrivateKey(signingKeyPKCS8.value());
    if (!signingKey) {
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::FAILED), "Error getting private part of signingKey"));
    }
    ...
    if (!nonce) {
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::FAILED), "Error getting random"));
    }
    vector<uint8_t> docTypeAsBlob(docType_.begin(), docType_.end());
    ...
    if (!encryptedSigningKey) {
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::FAILED), "Error encrypting signingKey"));
    }
