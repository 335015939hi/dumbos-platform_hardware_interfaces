...
ndk::ScopedAStatus IdentityCredential::startRetrieval(
        ...
        const vector<uint8_t>& sessionTranscript, const vector<uint8_t>& readerSignature,
...
ndk::ScopedAStatus IdentityCredential::finishRetrieval(const vector<uint8_t>& signingKeyBlob,
                                                       vector<uint8_t>* outMac,
