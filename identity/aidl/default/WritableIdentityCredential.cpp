...
#include <aidl/android/hardware/identity/ResultCode.h>
...
ndk::ScopedAStatus WritableIdentityCredential::getAttestationCertificate(
    ...
    if (!attestationKeyPair) {
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::FAILED), "Error creating attestationKey"));
    }
    ...
    if (!attestationPubKey) {
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::FAILED), "Error getting public part of attestationKey"));
    }
    ...
    if (!attestationPrivKey) {
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::FAILED), "Error getting private part of attestationKey"));
    }
    ...
    if (!credentialPubKeyCertificate) {
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::FAILED), "Error creating certificate for credentialPubKey"));
    }
    ...
    if (!attestationKeyCertificate) {
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::FAILED), "Error creating certificate for attestationPubKey"));
    }
    ...
    if (!splitCertChain) {
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::FAILED), "Error splitting certificate chain"));
    }
...
ndk::ScopedAStatus WritableIdentityCredential::addAccessControlProfile(
    ...
    if (!mac) {
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::FAILED), "Error calculating MAC for profile"));
    }
...
ndk::ScopedAStatus WritableIdentityCredential::beginAddEntry(
    ...
    if (numAccessControlProfileRemaining_ != 0) {
        LOG(ERROR) << "numAccessControlProfileRemaining_ is " << numAccessControlProfileRemaining_
                   << " and expected zero";
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::INVALID_DATA), "numAccessControlProfileRemaining_ is not zero"));
    }

    if (remainingEntryCounts_.size() == 0) {
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::INVALID_DATA), "No more namespaces to add to"));
    }
...
ndk::ScopedAStatus WritableIdentityCredential::addEntryValue(const vector<int8_t>& contentS,
    ...
    if (contentSize > IdentityCredentialStore::kGcmChunkSize) {
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::INVALID_DATA), "Passed in chunk of is bigger than kGcmChunkSize"));
    }
    if (contentSize > entryRemainingBytes_) {
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::INVALID_DATA), "Passed in chunk is bigger than remaining space"));
    }
    ...
    if (entryRemainingBytes_ == 0) {
        ...
        if (item == nullptr) {
            return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                    int(ResultCode::INVALID_DATA), "Data is not valid CBOR"));
        }
        cppbor::Map entryMap;
...
ndk::ScopedAStatus WritableIdentityCredential::finishAddingEntries(
    ...
    if (!generateCredentialKeys(storageKey_, credentialPrivKey_, credentialKeys)) {
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::FAILED), "Error generating CredentialKeys"));
    }
    ...
    if (!generateCredentialData(
        ...
        return ndk::ScopedAStatus(AStatus_fromServiceSpecificErrorWithMessage(
                int(ResultCode::FAILED), "Error generating CredentialData"));
    }
