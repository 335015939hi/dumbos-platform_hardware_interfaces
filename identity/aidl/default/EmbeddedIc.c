...
bool eicProvisioningCreateCredentialKey(EicProvisioning* ctx,
...
bool eicProvisioningAddAccessControlProfile(EicProvisioning* ctx, int id, const uint8_t* readerCertificate,
...
bool eicProvisioningFinishAddingEntries(EicProvisioning* ctx, bool testCredential,
...
bool eicProvisioningFinishGetCredentialData(EicProvisioning* ctx,
                                         bool testCredential,
                                         const char* docType,
