...
// set it to the size of the certification chain on successfuly return.
//
...
// The data returned in the array contains the ECDSA signature of the ToBeSigned
// CBOR from RFC 8051 "4.4. Signing and Verification Process" where content is
// set to the ProofOfProvisioning CBOR.
//
