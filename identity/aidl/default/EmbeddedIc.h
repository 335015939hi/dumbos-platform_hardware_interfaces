...
bool eicPresentationCheckHardwareAuthToken(EicPresentation* ctx,
                                           uint64_t challenge,
...
bool eicPresentationCheckReaderSignature(const uint8_t* itemsRequest,
                                         size_t itemsRequestSize,
                                         const uint8_t* sessionTranscript,
                                         size_t sessionTranscriptSize,
                                         int coseSignAlg,
                                         const uint8_t* readerSignatureOfToBeSigned,
                                         size_t readerSignatureOfToBeSignedSize,
                                         const uint8_t* readerCert,
                                         size_t readerCertSize);

bool eicPresentationCheckAccessControlForProfile(EicPresentation* ctx,
                                                 int id,
