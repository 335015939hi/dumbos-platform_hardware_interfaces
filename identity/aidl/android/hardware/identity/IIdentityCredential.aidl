...
interface IIdentityCredential {
     ...
     * be deleted.
     *
     * Deprecated because there's no challenge so freshness can't be checked. Use
     * deleteCredentalWithChallenge() instead.
     *
     ...
     *
     * If implementing feature version 202101 or later, the certificate shall also have an X.509
     * extension at OID 1.3.6.1.4.1.11129.2.1.26 which shall contain OCTET STRING with the
    ...
    */
     ...
     * be deleted.
     *
     * This method was introduced in API level 3 / feature version 202101.
     *
