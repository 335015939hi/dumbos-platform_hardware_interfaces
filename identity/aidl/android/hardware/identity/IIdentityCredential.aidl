...
interface IIdentityCredential {
     ...
     * somewhere in the bytes of the CBOR. Both X and Y should be in uncompressed form.
     * If this is not satisfied, the call fails with STATUS_EPHEMERAL_PUBLIC_KEY_NOT_FOUND.
     *
