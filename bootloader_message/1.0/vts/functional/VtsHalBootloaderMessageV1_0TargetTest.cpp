...
using ::android::hardware::bootloader_message::V1_0::CommandResult;
...
using ::android::hardware::bootloader_message::V1_0::MinimalWipePackageSize;
...
TEST_P(BootloaderMessageHidlTest, read_and_write_bootloader_message_minsize) {
    // Write the BCB.
    Message message = {
...
TEST_P(BootloaderMessageHidlTest, read_write_wipe_package) {
