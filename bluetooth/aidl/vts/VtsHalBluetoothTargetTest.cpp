...
class BluetoothAidlTest : public ::testing::TestWithParam<std::string> {
  std::chrono::time_point<std::chrono::system_clock> time_before_initialize,
 ...
 public:
  void SetUp() override {
    ...
    acl_cb_count = 0;
    sco_cb_count = 0;
    time_before_initialize = std::chrono::system_clock::now();
    ...
    time_before_initialize += kWaitForInitTimeout;
    ASSERT_GE(time_before_initialize, time_after_initialize_complete);
  }
