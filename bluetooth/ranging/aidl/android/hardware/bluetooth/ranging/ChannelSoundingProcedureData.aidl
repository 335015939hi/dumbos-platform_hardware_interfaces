...
parcelable ChannelSoundingProcedureData {
    ...
    /**
     * Parameter for vendors to place vendor-specific initiator raw ranging data.
     */
    @nullable byte[] initiatorVendorSpecificCsSingleSidedata;
    /**
     * Parameter for vendors to place vendor-specific reflector raw ranging data.
     */
    @nullable byte[] reflectorVendorSpecificCsSingleSidedata;
    /**
