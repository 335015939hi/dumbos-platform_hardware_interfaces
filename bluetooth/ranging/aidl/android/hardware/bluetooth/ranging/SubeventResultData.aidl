...
parcelable SubeventResultData {
    /**
     * The subevent sequence received for a procedure, start from 0
     * This is not defined by the spec.
     */
     ...
     */
    byte[2] frequencyCompensation;
    /**
     * Reference power level
     * Range: -127 to 20
     * Unit: dBm
     */
    byte referencePowerLevel;
    /**
     ...
     * Using epoch time in ms (e.g., 1697673127175).
     */
    long timestampMs;
}
