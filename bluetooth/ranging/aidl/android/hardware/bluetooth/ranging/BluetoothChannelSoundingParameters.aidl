...
parcelable BluetoothChannelSoundingParameters {
    ...
    const int ALGORITHM_INDOOR = 1;
    const int ALGORITHM_LINE_OF_SIGHT = 2;
    const int ALGORITHM_NADM = 4;
    /**
     * A bitmask to describe the preferred use case. This is used by the HAL to choose the
     * corresponding ranging algorithm if it supports multiple algorithms
     *
     * bit 0 : indoor
     * bit 1 : line of sight
