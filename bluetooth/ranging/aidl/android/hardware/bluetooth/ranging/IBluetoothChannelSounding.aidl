...
import android.hardware.bluetooth.ranging.SecurityLevel;
...
interface IBluetoothChannelSounding {
     ...
     *
     * @return SecurityLevel that indicates max supported security level of CS for ranging
     *         algorithms.
     */
    SecurityLevel getMaxSupportedSecurityLevel();
