...
interface IBluetoothChannelSoundingSessionCallback {
    /**
     * Invoked when IBluetoothChannelSounding.openSession() when is successful.
     */
    void onOpened(Reason reason);
    /**
     * Invoked when IBluetoothChannelSounding.openSession() when is faild.
     */
    void onOpenFailed(Reason reason);

    // Not for HARDWARE_OFFOAD
    ...
    /**
     * Invoked when IBluetoothChannelSoundingSession.close() when is successful.
     */
    void onClose(Reason reason);
    /**
     * Invoked when IBluetoothChannelSoundingSession.close() when is faild.
     */
