...
parcelable BluetoothChannelSoundingParameters {
  ...
  boolean rttContainsSoundingSequence;
  boolean localSupportPhaseBasedRanging;
  boolean remoteSupportPhaseBase_ranging;
  android.hardware.bluetooth.ranging.DeviceAddress address;
  android.hardware.bluetooth.ranging.VendorSpecificData[] vendorSpecificData;
}
