...
parcelable ChannelSoundingSingleSideData {
  @nullable android.hardware.bluetooth.ranging.ProcedureTonePct procedureTonePct;
  @nullable List<android.hardware.bluetooth.ranging.ProcedureTonePct> runningTonePct;
