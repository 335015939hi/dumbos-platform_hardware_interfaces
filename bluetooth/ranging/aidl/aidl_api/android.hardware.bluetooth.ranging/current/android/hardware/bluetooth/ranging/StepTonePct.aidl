...
parcelable StepTonePct {
  ...
  const int TONE_EXTENSION_ANTENNA_1 = 0x0;
  const int TONE_EXTENSION_ANTENNA_2 = 0x1;
  const int TONE_EXTENSION_ANTENNA_3 = 0x2;
  const int TONE_EXTENSION_ANTENNA_4 = 0x3;
  const int TONE_EXTENSION_UNUSED = 0xFF;
}
