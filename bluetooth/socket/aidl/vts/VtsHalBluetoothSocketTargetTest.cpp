...
using ::aidl::android::hardware::bluetooth::socket::FailureReason;
using ::aidl::android::hardware::bluetooth::socket::IBluetoothSocket;
using ::aidl::android::hardware::bluetooth::socket::RequestReason;
...
class BluetoothSocketCallback : public BnBluetoothSocketCallback {
  ...
  ScopedAStatus onOpenFailed(int64_t in_socketId, FailureReason in_reason,
                             int32_t in_vendorStatusCode) override;
  ScopedAStatus onClosed(int64_t in_socketId) override;
  ScopedAStatus onCloseFailed(int64_t in_socketId, FailureReason in_reason,
                              int32_t in_vendorStatusCode) override;
  ScopedAStatus onCloseRequest(int64_t in_socketId, RequestReason in_reason,
                               int32_t in_vendorStatusCode) override;
  ScopedAStatus onRestarted(int32_t in_vendorStatusCode) override;
};
...
ScopedAStatus BluetoothSocketCallback::onOpenFailed(
    int64_t /*in_socketId*/, FailureReason /*in_reason*/,
    int32_t /*in_vendorStatusCode*/) {
  return ::ndk::ScopedAStatus::ok();
}
ScopedAStatus BluetoothSocketCallback::onClosed(int64_t /*in_socketId*/) {
  return ::ndk::ScopedAStatus::ok();
}
ScopedAStatus BluetoothSocketCallback::onCloseFailed(
    int64_t /*in_socketId*/, FailureReason /*in_reason*/,
    int32_t /*in_vendorStatusCode*/) {
  return ::ndk::ScopedAStatus::ok();
}
ScopedAStatus BluetoothSocketCallback::onCloseRequest(
    int64_t /*in_socketId*/, RequestReason /*in_reason*/,
    int32_t /*in_vendorStatusCode*/) {
  return ::ndk::ScopedAStatus::ok();
}
ScopedAStatus BluetoothSocketCallback::onRestarted(
    int32_t /*in_vendorStatusCode*/) {
  return ::ndk::ScopedAStatus::ok();
}
