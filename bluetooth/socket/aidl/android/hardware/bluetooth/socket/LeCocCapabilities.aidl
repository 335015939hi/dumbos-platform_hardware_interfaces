...
parcelable LeCocCapabilities {
    ...
    /**
     * Local initial credit for LE COC indicating the number of K-frames that the peer device can
     * send to the local L2CAP layer. The initial credit value shall be in the range 0 to 65535.
     */
    int credit;
}
