...
parcelable RfcommChannelInfo {
    /**
     * RFCOMM local channel ID.
     */
    int localCid;

    /**
     * RFCOMM remote channel ID.
     */
    int remoteCid;

    /**
     * Local Maximum Transmission Unit Size in bytes that the local RFCOMM layer can receive.
     */
    int localMtu;

    /**
     * Remote Maximum Transmission Unit Size in bytes that the remote RFCOMM layer can receive.
     */
    int remoteMtu;
    ...
    /**
     * Maximum payload size negotiated during DLCI establishment.
     */
    int maxFrameSize;
     ...
     *
     * This flag is used in the Command/Response (C/R) bit of RFCOMM frames.
     * - 1: Android stack is the initiator of the multiplexer control channel.
     * - 0: Android stack is the responder.
     */
    int muxInitiatorFlag;
}
