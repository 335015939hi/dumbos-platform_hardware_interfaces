...
UnicastCapability BluetoothLeAudioCodecsProvider::GetUnicastCapability(
  ...
  CodecType codec_type =
      GetAidlCodecType(codec_configuration_iter->second.getCodec());
  if (codec_type == CodecType::LC3) {
    return ComposeUnicastCapability(
        codec_type,
        GetAidlAudioLocation(
...
AudioLocation BluetoothLeAudioCodecsProvider::GetAidlAudioLocation(
...
CodecType BluetoothLeAudioCodecsProvider::GetAidlCodecType(
