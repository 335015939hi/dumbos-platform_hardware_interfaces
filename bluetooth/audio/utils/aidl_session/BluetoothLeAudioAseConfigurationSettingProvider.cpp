...
static const std::vector<
    ...
    kLeAudioSetConfigs = {{"/apex/com.android.btservices/etc/aidl/le_audio/"
                           "aidl_audio_set_scenarios.bfbs",
                           "/apex/com.android.btservices/etc/aidl/le_audio/"
                           "aidl_audio_set_scenarios.json"}};
static const std::vector<
    std::pair<const char* /*schema*/, const char* /*content*/>>
    kLeAudioSetScenarios = {{"/apex/com.android.btservices/etc/aidl/le_audio/"
                             "aidl_audio_set_scenarios.bfbs",
                             "/apex/com.android.btservices/etc/aidl/le_audio/"
