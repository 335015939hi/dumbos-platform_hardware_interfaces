...
class BluetoothAudioSessionReport {
 public:
  ...
  // invoke session_changed_cb_ to notify related output of bluetooth_audio
  ...
  // session_changed_cb_ to notify related outputs of bluetooth_audio
