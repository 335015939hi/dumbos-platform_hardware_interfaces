...
// The report function is used to report the Bluetooth stack has started this
// session without any failure, and will invoke session_changed_cb_ to notify
// those registered bluetooth_audio outputs
...
// The report function is used to report the Bluetooth stack has ended the
...
// The report function is used to report the Bluetooth stack has notified the
// result of startStream or suspendStream, and will invoke control_result_cb_ to
// notify registered bluetooth_audio outputs
...
// private and internal function to setup AudioConfiguration
