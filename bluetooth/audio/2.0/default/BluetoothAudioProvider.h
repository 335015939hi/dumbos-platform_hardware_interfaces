...
class BluetoothAudioProvider : public IBluetoothAudioProvider {
  public:
    ...
    Return<void> registerControlResultCback(std::function<void(SessionType&, BluetoothAudioStatus&)>&,
                                            std::function<void(SessionType&)>&);
  ...
  protected:
    ...
    std::function<void(SessionType&, BluetoothAudioStatus&)> ctrl_res_cb_;
    std::function<void(SessionType&)> session_ended_cb_;
