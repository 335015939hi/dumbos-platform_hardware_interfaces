...
const sp<IBluetoothAudioPort>
bt_audio_get_port_ctrl_path(const SessionType& sessionType);
const DataMQ::Descriptor*
bt_audio_get_data_fmq(const SessionType& sessionType);
const PcmDataConfiguration&
bt_audio_get_pcm_data_cfg(const SessionType& sessionType);
