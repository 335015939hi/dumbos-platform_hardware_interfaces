...
class BluetoothAudioProvidersFactory : public IBluetoothAudioProvidersFactory {
  ...
  private:
    ...
    static BluetoothAudioProvider mProviderCacheA2dpOffload;
    static BluetoothAudioProvider mProviderCacheHearingAidMedia;
    static BluetoothAudioProvider mProviderCacheHearingAidVoice;
};
