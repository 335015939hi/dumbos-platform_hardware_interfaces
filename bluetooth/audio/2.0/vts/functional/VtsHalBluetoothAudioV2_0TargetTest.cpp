...
static constexpr SampleRate sample_rates[2] = {SampleRate::RATE_UNKNOWN,
                                               SampleRate::RATE_44100};
static constexpr BitsPerSample bits_per_samples[2] = {
    BitsPerSample::BITS_UNKNOWN, BitsPerSample::BITS_16};
static constexpr ChannelMode channel_modes[2] = {ChannelMode::UNKNOWN,
                                                 ChannelMode::STEREO};
}  // namespace
...
class BluetoothAudioHidlTest : public ::testing::VtsHalHidlTargetTestBase {
 public:
  virtual void SetUp() override {
    providers_factory = ::testing::VtsHalHidlTargetTestBase::getService<
        IBluetoothAudioProvidersFactory>(
...
TEST_F(BluetoothAudioA2dpHidlTest, StartAndEndA2dpSession) {
  ...
  EXPECT_TRUE(
      audio_provider
          ->startSession(audio_port, codec_config,
...
class BluetoothAudioHearingAidHidlTest : public BluetoothAudioHidlTest {
 public:
  ...
  // A simple test implementation of IBluetoothAudioPort.
  class BluetoothAudioPort : public ::testing::VtsHalHidlTargetCallbackBase<
                                 BluetoothAudioHearingAidHidlTest>,
                             public IBluetoothAudioPort {
