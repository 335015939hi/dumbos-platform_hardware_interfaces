...
INSTANTIATE_TEST_SUITE_P(
    PerInstance, BluetoothAudioProvidersFactoryHidlTest,
    testing::ValuesIn(android::hardware::getAllHalInstanceNames(
        IBluetoothAudioProvidersFactory::descriptor)),
    android::hardware::PrintInstanceNameToString);

INSTANTIATE_TEST_SUITE_P(
    PerInstance, BluetoothAudioProviderA2dpSoftwareHidlTest,
    testing::ValuesIn(android::hardware::getAllHalInstanceNames(
        IBluetoothAudioProvidersFactory::descriptor)),
    android::hardware::PrintInstanceNameToString);

INSTANTIATE_TEST_SUITE_P(
    PerInstance, BluetoothAudioProviderA2dpHardwareHidlTest,
    testing::ValuesIn(android::hardware::getAllHalInstanceNames(
        IBluetoothAudioProvidersFactory::descriptor)),
    android::hardware::PrintInstanceNameToString);

INSTANTIATE_TEST_SUITE_P(
    PerInstance, BluetoothAudioProviderHearingAidSoftwareHidlTest,
    testing::ValuesIn(android::hardware::getAllHalInstanceNames(
        IBluetoothAudioProvidersFactory::descriptor)),
    android::hardware::PrintInstanceNameToString);