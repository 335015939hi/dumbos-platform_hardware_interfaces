...
using ::android::hardware::bluetooth::audio::V2_1::AudioConfiguration_2_1;
...
constexpr uint16_t kObserversCookieUndefined =
    (static_cast<uint16_t>(SessionType_2_1::UNKNOWN) << 8 & 0xff00);
inline SessionType_2_1 ObserversCookieGetSessionType_2_1(uint16_t cookie) {
  return static_cast<SessionType_2_1>(cookie >> 8 & 0x00ff);
}
inline uint16_t ObserversCookieGetInitValue(SessionType_2_1 session_type) {
  return (static_cast<uint16_t>(session_type) << 8 & 0xff00);
}
inline uint16_t ObserversCookieGetUpperBound(SessionType_2_1 session_type) {
  return (static_cast<uint16_t>(session_type) << 8 & 0xff00) +
...
class BluetoothAudioSession {
 private:
  ...
  AudioConfiguration_2_1 audio_config_;

  static AudioConfiguration_2_1 invalidSoftwareAudioConfiguration_2_1;
  static AudioConfiguration_2_1 invalidOffloadAudioConfiguration_2_1;
  ...
  bool UpdateAudioConfig(const AudioConfiguration_2_1& audio_config);
  // invoking the registered session_changed_cb_
  void ReportSessionStatus();

 public:
  BluetoothAudioSession(const SessionType_2_1& session_type);
  ...
  const AudioConfiguration_2_1& GetAudioConfig();
  ...
  static constexpr PcmParameters_2_1 kInvalidPcmParameters_2_1 = {
  ...
  static constexpr AudioConfiguration_2_1& kInvalidSoftwareAudioConfiguration_2_1 =
      invalidSoftwareAudioConfiguration_2_1;
  static constexpr AudioConfiguration_2_1& kInvalidOffloadAudioConfiguration_2_1 =
      invalidOffloadAudioConfiguration_2_1;
};
...
class BluetoothAudioSessionInstance {
 ...
 private:
  ...
  std::mutex mutex_;
  std::unordered_map<SessionType_2_1, std::shared_ptr<BluetoothAudioSession>>
      sessions_map_;
};
