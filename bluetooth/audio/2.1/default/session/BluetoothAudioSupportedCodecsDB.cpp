...
static const PcmParameters kDefaultSoftwarePcmCapabilities_2_1 = {
    .base.sampleRate = static_cast<SampleRate>(
        SampleRate::RATE_44100 | SampleRate::RATE_48000 |
        SampleRate::RATE_88200 | SampleRate::RATE_96000 |
        SampleRate::RATE_16000 | SampleRate::RATE_24000),
    .base.channelMode =
        static_cast<ChannelMode>(ChannelMode::MONO | ChannelMode::STEREO),
    .base.bitsPerSample = static_cast<BitsPerSample>(BitsPerSample::BITS_16 |
                                                     BitsPerSample::BITS_24 |
                                                     BitsPerSample::BITS_32)};
...
bool IsSoftwarePcmConfigurationValid_2_1(const PcmParameters& pcm_config) {
  if ((pcm_config.base.sampleRate != SampleRate::RATE_44100 &&
       pcm_config.base.sampleRate != SampleRate::RATE_48000 &&
       pcm_config.base.sampleRate != SampleRate::RATE_88200 &&
       pcm_config.base.sampleRate != SampleRate::RATE_96000 &&
       pcm_config.base.sampleRate != SampleRate::RATE_16000 &&
       pcm_config.base.sampleRate != SampleRate::RATE_24000) ||
      (pcm_config.base.bitsPerSample != BitsPerSample::BITS_16 &&
       pcm_config.base.bitsPerSample != BitsPerSample::BITS_24 &&
       pcm_config.base.bitsPerSample != BitsPerSample::BITS_32) ||
      (pcm_config.base.channelMode != ChannelMode::MONO &&
       pcm_config.base.channelMode != ChannelMode::STEREO)) {
    LOG(WARNING) << __func__
                 << ": Invalid PCM Configuration=" << toString(pcm_config);
    return false;
  } else if (pcm_config.base.sampleRate &
                 kDefaultSoftwarePcmCapabilities_2_1.base.sampleRate &&
             pcm_config.base.bitsPerSample &
                 kDefaultSoftwarePcmCapabilities_2_1.base.bitsPerSample &&
             pcm_config.base.channelMode &
                 kDefaultSoftwarePcmCapabilities_2_1.base.channelMode &&
             pcm_config.dataIntervalMs != 0) {
    return true;
  }
  LOG(WARNING) << __func__
               << ": Unsupported PCM Configuration=" << toString(pcm_config);
