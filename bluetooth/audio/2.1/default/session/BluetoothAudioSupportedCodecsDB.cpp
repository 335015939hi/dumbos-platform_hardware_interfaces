...
static const ::android::hardware::bluetooth::audio::V2_0::PcmParameters
    kDefaultSoftwarePcmCapabilities = {
        .sampleRate = static_cast<android::hardware::bluetooth::audio::V2_0::SampleRate>(
            android::hardware::bluetooth::audio::V2_0::SampleRate::RATE_44100 | android::hardware::bluetooth::audio::V2_0::SampleRate::RATE_48000 |
            android::hardware::bluetooth::audio::V2_0::SampleRate::RATE_88200 | android::hardware::bluetooth::audio::V2_0::SampleRate::RATE_96000 |
            android::hardware::bluetooth::audio::V2_0::SampleRate::RATE_16000 | SampleRate::RATE_24000),
        .channelMode =
...
static const SbcParameters kDefaultOffloadSbcCapability = {
    .sampleRate = android::hardware::bluetooth::audio::V2_0::SampleRate::RATE_44100,
...
static const AptxParameters kDefaultOffloadAptxCapability = {
    .sampleRate = static_cast<android::hardware::bluetooth::audio::V2_0::SampleRate>(android::hardware::bluetooth::audio::V2_0::SampleRate::RATE_44100 |
...
bool IsSoftwarePcmConfigurationValid(
    const ::android::hardware::bluetooth::audio::V2_0::PcmParameters&
        pcm_config) {
  if ((pcm_config.sampleRate != android::hardware::bluetooth::audio::V2_0::SampleRate::RATE_44100 &&
       pcm_config.sampleRate != android::hardware::bluetooth::audio::V2_0::SampleRate::RATE_48000 &&
       pcm_config.sampleRate != android::hardware::bluetooth::audio::V2_0::SampleRate::RATE_88200 &&
       pcm_config.sampleRate != android::hardware::bluetooth::audio::V2_0::SampleRate::RATE_96000 &&
       pcm_config.sampleRate != android::hardware::bluetooth::audio::V2_0::SampleRate::RATE_16000 &&
       pcm_config.sampleRate != android::hardware::bluetooth::audio::V2_0::SampleRate::RATE_24000) ||
