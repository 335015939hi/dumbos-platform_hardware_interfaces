...
Return<void> LeAudioAudioProvider::startSession_2_1(
  ...
  switch (audioConfig.pcmConfig().base.sampleRate) {
  ...
  switch (audioConfig.pcmConfig().base.channelMode) {
  ...
  switch (audioConfig.pcmConfig().base.bitsPerSample) {
  ...
  kDataMqSize *= audioConfig.pcmConfig().dataIntervalMs;
