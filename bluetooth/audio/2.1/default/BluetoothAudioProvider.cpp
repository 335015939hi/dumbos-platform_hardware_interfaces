...
Return<void> BluetoothAudioProvider::startSession(
  ...
  audioConfig_2_1.pcmConfig() = {
      .base.sampleRate = audioConfig.pcmConfig().sampleRate,
      .base.channelMode = audioConfig.pcmConfig().channelMode,
      .base.bitsPerSample = audioConfig.pcmConfig().bitsPerSample,
      .dataIntervalUs = 0};
