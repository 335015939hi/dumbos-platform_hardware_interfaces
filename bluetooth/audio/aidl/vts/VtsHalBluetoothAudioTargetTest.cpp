...
static constexpr CodecType a2dp_codec_types[] = {
    ...
    CodecType::LDAC,
    CodecType::LC3,
    CodecType::APTX_ADAPTIVE,
    CodecType::APTX_ADAPTIVE_LE,
    CodecType::APTX_ADAPTIVE_LEX,
};
 ...
 public:
  ...
  std::vector<AptxAdaptiveLeConfiguration> GetUnicastAptxAdaptiveLeSupportedList(bool decoding,
    ...
    for (auto& capability : temp_provider_capabilities_) {
      ...
      aptx_adaptive_le_capabilities.push_back(
          aptx_adaptive_le_capability.value());
    }
...
TEST_P(
    ...
    StartAndEndLeAudioOutputSessionWithInvalidAptxAdaptiveLeAudioConfiguration) {
  if (!IsOffloadOutputSupported()) {
    return;
  }
