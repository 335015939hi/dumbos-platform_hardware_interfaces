...
parcelable A2dpStreamConfiguration {
    ...
    /**
     * Optional Content Protection header,
     * shall precede audio content when enabled [A2DP - 3.2.1-2]
     * Only content protection of type SCMS-T is supported,
     * the content protection byte is defined by [Assigned Number - 6.3.2]
     */
    @nullable byte[1] contentProtectionHeader;
