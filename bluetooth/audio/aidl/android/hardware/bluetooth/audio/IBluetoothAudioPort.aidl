...
import android.hardware.bluetooth.audio.SourceMetadata;
...
interface IBluetoothAudioPort {
     ...
     *
     * @param out the audio presentation position result
     *
     ...
     *        any other reason
     */
    Status getPresentationPosition(out PresentationPosition position);
