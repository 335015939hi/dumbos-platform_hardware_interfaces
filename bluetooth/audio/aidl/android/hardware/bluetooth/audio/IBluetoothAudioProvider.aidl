...
interface IBluetoothAudioProvider {
     ...
     */
    void onSinkAseMetadataChanged(in AseState state,
    ...
    parcelable LeAudioBisConfiguration {
        ...
        /**
         * Codec configuration for BIS or group of BISes. This will also be used
         ...
         * specific configuration brodcasted to the broadcast audio receiving
         * devices. If this is populated, only `vendorCodecConfiguration` will
         * be used, otherwise `codecConfiguration` will be used. Vendor shall
         * put any parameters defined by the Assigned Numbers it decided to
         * reuse for this particular vendor codec configuration if it uses at
         * least one vendor specific parameter.
         */
