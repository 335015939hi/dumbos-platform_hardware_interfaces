...
interface IBluetoothAudioProvider {
     ...
     *       the direction configurations (both nulled) is considerd as an
     *       invalid behavior.
     *       If the returned configrations are not complete (either
     ...
     *       only the prefferred parameter fields are not specified. The
     ...
     *       The BT stack can pass assymetric sink and source configurations
