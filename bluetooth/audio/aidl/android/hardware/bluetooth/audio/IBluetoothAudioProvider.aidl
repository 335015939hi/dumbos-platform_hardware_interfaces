...
interface IBluetoothAudioProvider {
    ...
    parcelable LeAudioDataPathConfiguration {
        ...
        parcelable IsoDataPathConfiguration {
             ...
             * codec ID for  for vendor codecs, or according to Codec_ID
             * identifiers defined in the Assigned Numbers for the non-vendor
             * codecs).
             */
    ...
    parcelable LeAudioAseQosConfigurationRequirement {
        ...
        parcelable AseQosDirectionRequirement {
            ...
            Phy prefferedPhy;
            int prefferedRetransmissionNum;
            int maxTransportLatency;
            int presentationDelayMin;
            int presentationDelayMax;
            int prefferedPresentationDelayMin;
            int prefferedPresentationDelayMax;
    ...
    /**
     * A directional pair for QoS confguration. Either one or both directions
