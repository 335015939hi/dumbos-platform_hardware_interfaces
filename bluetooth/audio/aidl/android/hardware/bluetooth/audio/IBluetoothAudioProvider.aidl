...
interface IBluetoothAudioProvider {
     ...
     */
    void onSinkAseMetadataChanged(in AseState state, in @nullable MetadataLtv[] metadata);
    void onSourceAseMetadataChanged(in AseState state, in @nullable MetadataLtv[] metadata);
    ...
    parcelable LeAudioBroadcastSubgroupConfiguration {
         ...
         * can derive the common subgroup configration by intersecting the LTV
