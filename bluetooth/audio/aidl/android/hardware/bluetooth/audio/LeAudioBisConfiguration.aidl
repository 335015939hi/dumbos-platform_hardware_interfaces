...
parcelable LeAudioBisConfiguration {
     ...
     * specific configuration for the ongoing audio stream encodec by the vendor
     * module. The remote device will receive this information when being
     * configured for receiveing a brodcast audio stream. If this is populated,
     * only the `vendorCodecConfiguration` will be used, otherwise
     * `codecConfiguration` will be used. Vendor shall put  any parameters
     * defined by the Assigned Numbers it decided to reuse for this particular
     * vendor codec configuration if it uses at least one vendor specific
     * parameter.
     */
