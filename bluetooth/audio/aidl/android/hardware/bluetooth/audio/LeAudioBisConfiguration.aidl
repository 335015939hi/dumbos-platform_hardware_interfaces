...
parcelable LeAudioBisConfiguration {
    ...
    /**
     * Codec configuration for BIS or group of BISes. This shall contain all the LTVs but
     * allocation. Audio Channel Allocation will be added by the
     * Bluetooth stack unless DONT_USE_AUDIO_ALLOCATIONS flag is set in the configuration
     * returned by the offloader. This will also be used to verify the requirements on
     * the known LTV types.
     */
     ...
     * configuration. If this is populated, only `vendorCodecConfiguration` will be used,
     * otherwise `codecConfiguration` will be used. Vendor shall put any parameters
     * defined by the Assigned Numbers it decided to reuse for this particular vendor
     * codec configuration if it uses at least one vendor specific parameter.
     */
