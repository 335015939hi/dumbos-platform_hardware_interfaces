...
import android.hardware.bluetooth.audio.BluetoothDeviceAddress;
...
parcelable A2dpConfigurationHint {
    /**
     * Informations on the remote device,
     ...
     * - An identifier of a preferred codec, `UNKNOWN` points no preference.
