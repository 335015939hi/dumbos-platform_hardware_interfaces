...
import android.hardware.bluetooth.audio.Ltv;
...
parcelable CodecParameters {
    ...
    /**
     * Controller Vendor metadatas, inteserted in the VSC `Start A2DP Offload`.
     * This is only relevant for exchanges from the provider to the stack.
     */
    Ltv[] controllerDatas;
}
