...
import android.hardware.bluetooth.audio3.PresentationPosition;
import android.hardware.bluetooth.audio3.SourceMetadata;
...
interface IBluetoothAudioPort {
     ...
     *
     * @return the audio presentation position result
     */
