...
import android.hardware.bluetooth.audio3.AudioConfiguration;
import android.hardware.bluetooth.audio3.IBluetoothAudioPort;
...
interface IBluetoothAudioProvider {
     ...
     *    encoding.
     *
     * @param out status One of the following
     ...
     *        any other reason
     * @param out dataMQ The fast message queue for audio data from/to this
     ...
     */
    Status startSession(in IBluetoothAudioPort hostIf, in AudioConfiguration audioConfig,
            out android.hardware.common.fmq
                    .MQDescriptor<int, android.hardware.common.fmq.UnsynchronizedWrite> dataMQ);
     ...
     */
    void streamStarted(in Status status);
     ...
     * @param status SUCCESS or FAILURE
     */
    void streamSuspended(in Status status);
}
