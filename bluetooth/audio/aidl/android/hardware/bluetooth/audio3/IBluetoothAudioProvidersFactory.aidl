...
import android.hardware.bluetooth.audio3.AudioCapabilities;
import android.hardware.bluetooth.audio3.IBluetoothAudioProvider;
import android.hardware.bluetooth.audio3.Provider;
import android.hardware.bluetooth.audio3.SessionType;
...
interface IBluetoothAudioProvidersFactory {
     ...
     * @param out provider The provider of the specified session type
     */
    void openProvider(in SessionType sessionType, out Provider provider);
}
