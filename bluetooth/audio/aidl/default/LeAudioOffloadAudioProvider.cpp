...
ndk::ScopedAStatus LeAudioOffloadAudioProvider::getLeAudioAseConfiguration(
  ...
  // Corrcet preferred context - exact match with allocation
  // Any context - exact match with allocation
  // Corrcet preferred context - loose match with allocation
  // Any context - loose match with allocation

  // A loose match will attemp to return 2 settings with the
