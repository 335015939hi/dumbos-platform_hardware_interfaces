...
constexpr A2dpBits::Range kSamplingFrequency(kSamplingFrequency16000,
                                             kSamplingFrequency48000);
constexpr A2dpBits::Range kChannelMode(kChannelModeMono,
...
constexpr A2dpBits::Range kAllocationMethod(kAllocationMethodSnr,
                                            kAllocationMethodLoudness);
constexpr A2dpBits::Range kMinimumBitpool(kMinimumBitpoolFirstBit,
                                          kMinimumBitpoolLastBit);
constexpr A2dpBits::Range kMaximumBitpool(kMaximumBitpoolFirstBit,
                                          kMaximumBitpoolLastBit);
...
static uint8_t GetBitpool(const A2dpBits& configuration, int bitrate) {
  ...
  for (int i = 128; i; i >>= 1)
    if (bitrate > GetBitrate(configuration, bitpool + i)) bitpool += i;
