...
ndk::ScopedAStatus BluetoothAudioProvider::setBitRate(int bitRate) {
  ...
  LOG(INFO) << __func__ << " - bitRate " << bitRate;
  // TODO: Implement ReportBitRateChanged (b/267595522)
  // BluetoothAudioSessionReport::ReportBitRateChanged(session_type_, bitRate);
  return ndk::ScopedAStatus::ok();
}
