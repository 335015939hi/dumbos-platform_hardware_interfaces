...
import android.hardware.bluetooth.lmp_event.IBluetoothLmpEventCb;
...
interface IBluetoothLmpEvent {
     ...
     *
     * @param callback An instance of the |IBluetoothLmpEventCb| AIDL interface object.
     * @param address Bluetooth address to monitor.
     * @param lmpEventIds LMP events to monitor.
     */
    void registerForLmpEvents(in IBluetoothLmpEventCb callback, in byte[6] address, in LmpEventId[] lmpEventIds);
