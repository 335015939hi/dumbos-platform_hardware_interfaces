...
interface IBluetoothFinder {
     ...
     *
     * @param eids concatenation of 20 btyes EID to the Bluetooth
     * Bluetooth controller
     */
    void sendEIDs(in byte[] eids);
    ...
    /**
     * API to get the enable status of feature
     *
     * @return the value last set by setPoweredOffMode, false if
     * setPoweredOffMode never been invoked since boot.
     */
