...
Due to HAL access and sepolicy, this app is product-dependant. Please use the artifact built with corresponding target.
...
# run
adb shell 'am instrument --no-hidden-api-checks -w android.hardware.bluetooth.hci.hci_proxy/.Main'
```
