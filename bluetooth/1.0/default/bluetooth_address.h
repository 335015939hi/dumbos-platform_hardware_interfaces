...
#ifdef CANT_STORE_CONSTEXPR
// I wanted these to be static constants, but I kept getting a linking error:
// undefined reference to
// 'android::hardware::...::BluetoothAddress::PERSIST_BDADDR_PROPERTY
...
#define FACTORY_BDADDR_PROPERTY "ro.boot.btmacaddr"
#endif
...
class BluetoothAddress {
 public:
  ...
  static const size_t kBytes = 6;          // "X0:X1:X2:X3:X4:X5"
