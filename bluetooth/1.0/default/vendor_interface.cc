...
const bt_vendor_callbacks_t lib_callbacks = {
    sizeof(lib_callbacks), firmware_config_cb, sco_config_cb, low_power_mode_cb, sco_audiostate_cb,
    buffer_alloc_cb,       buffer_free_cb,     transmit_cb,   epilog_cb,         a2dp_offload_cb};
...
bool VendorInterface::Initialize(InitializeCompleteCallback initialize_complete_cb,
    ...
    return g_vendor_interface->Open(initialize_complete_cb, event_cb, acl_cb, sco_cb);
}
...
bool VendorInterface::Open(InitializeCompleteCallback initialize_complete_cb,
    ...
    lib_interface_ =
        reinterpret_cast<bt_vendor_interface_t*>(dlsym(lib_handle_, VENDOR_LIBRARY_SYMBOL_NAME));
    if (!lib_interface_) {
