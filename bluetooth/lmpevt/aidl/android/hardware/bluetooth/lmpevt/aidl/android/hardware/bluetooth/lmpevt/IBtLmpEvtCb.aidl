...
import android.hardware.bluetooth.lmpevt.Direction;
...
interface IBtLmpEvtCb {
     ...
     *
     * @param evtTime Time(in ms) of LMP event since BT controller powered on
     ...
     */
    void onEventGenerated(in long evtTime, in byte[6] address, in Direction direction,
