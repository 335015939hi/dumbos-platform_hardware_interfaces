...
class PowerStatsAidl : public testing::TestWithParam<std::string> {
  public:
    ...
    void testOk(const ndk::ScopedAStatus& ret);
...
void PowerStatsAidl::testOk(const ndk::ScopedAStatus& ret) {
...
TEST_P(PowerStatsAidl, ValidatePowerEntityNames) {
    ...
    testOk(powerstats->getPowerEntityInfo(&infos));
...
TEST_P(PowerStatsAidl, ValidatePowerEntityUniqueNames) {
    ...
    testOk(powerstats->getPowerEntityInfo(&entities));
...
TEST_P(PowerStatsAidl, TestGetStateResidency) {
    ...
    testOk(powerstats->getStateResidency({}, &results));
}
...
TEST_P(PowerStatsAidl, TestGetStateResidencySelectedResults) {
    ...
    testOk(powerstats->getStateResidency(selectedIds, &selectedResults));
...
TEST_P(PowerStatsAidl, TestReadEnergyMeter) {
    ...
    testOk(powerstats->readEnergyMeter({}, &data));
}
...
TEST_P(PowerStatsAidl, TestGetAllEnergyMeasurements) {
    ...
    testOk(powerstats->readEnergyMeter({}, &measurements));
...
TEST_P(PowerStatsAidl, TestGetSelectedEnergyMeasurements) {
    ...
    testOk(powerstats->readEnergyMeter(selectedIds, &selectedMeasurements));
...
TEST_P(PowerStatsAidl, TestGetEnergyConsumerInfo) {
    ...
    testOk(powerstats->getEnergyConsumerInfo(&consumers));
}
...
TEST_P(PowerStatsAidl, TestGetEnergyConsumed) {
    ...
    testOk(powerstats->getEnergyConsumed({}, &results));
}
...
TEST_P(PowerStatsAidl, TestGetSelectedEnergyConsumed) {
    ...
    testOk(powerstats->getEnergyConsumed(selectedIds, &selectedResults));
