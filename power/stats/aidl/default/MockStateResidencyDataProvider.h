...
class MockStateResidencyDataProvider : public PowerStats::IStateResidencyDataProvider {
  public:
    MockStateResidencyDataProvider(const std::string& name, std::vector<State> states)
    ...
    ~MockStateResidencyDataProvider() = default;
