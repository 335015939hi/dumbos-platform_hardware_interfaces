...
class ExampleStateResidencyDataProvider : public PowerStats::IStateResidencyDataProvider {
  public:
    ExampleStateResidencyDataProvider(const std::string& name, std::vector<State> states)
  ...
  private:
    class mockStateResidency {
      public:
        mockStateResidency() : mDistribution(1, 100) {}
    ...
    mockStateResidency mMockStateResidency;
