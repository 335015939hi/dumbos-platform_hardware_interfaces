...
interface IPower {
     ...
     * APIs.
     *
     * Support may be queried by calling supportHint(TOP_APP).
     *
     ...
     * ThreadHint.
     *
     * Only threads in the current top app will be permitted to provide this
     * information; other threads' requests will be filtered out by the
     * framework.
     *
