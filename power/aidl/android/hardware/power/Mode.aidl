...
enum Mode {
   ...
   /**
    * This mode indidates Sustained Performance mode is actived or not.
   ...
   /**
    * This mode indicates that an application has been launched. Can be used
    * for device specific optimizations during application launch.
    */
    LAUNCH,

   /**
    * This mode indicates that the device is about to enter a period of
    * expensive rendering, and the GPU should be configured accordingly.
    */
    EXPENSIVE_RENDERING,
    ...
    * for device specific optimizations towards low latency audio.
    */
    ...
    * Currently not used in Android framework but can be used
    * for device specific power optimizations during secure camera stream.
    */
    ...
    * Currently not used in Android framework but can be used
    * for device specific power optimizations during camera stream.
    */
