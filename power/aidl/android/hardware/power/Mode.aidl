...
enum Mode {
    ...
    /**
     * This mode indicates Ultra Low power mode is activated or not. Ultra Low
     * power mode is intended to save battery when user requested additional
     * saving from battery saver.
     */
    ULTRA_LOW_POWER,
