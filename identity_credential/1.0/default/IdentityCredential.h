...
struct IdentityCredential : public IIdentityCredential {
    explicit IdentityCredential(const hidl_vec<uint8_t>& credentialBlob)
        : credentialBlob_(credentialBlob) {}

    // Decrypts and parses CredentialBlob, return false on failure. Must be
