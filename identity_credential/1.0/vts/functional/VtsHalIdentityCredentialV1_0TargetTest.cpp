...
const vector<uint16_t> testEntriesEntryCounts = {static_cast<uint16_t>(testEntries.size() - 1), 1u};
...
TEST_F(IdentityCredentialStoreHidlTest, createAndRetrieveCredential) {
    ...
    // TODO: set startArguments.requestSignature
