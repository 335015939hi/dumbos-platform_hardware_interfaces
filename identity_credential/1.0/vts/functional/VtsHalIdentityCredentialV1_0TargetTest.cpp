...
const EntryData testEntry1 = {"PersonalData", "Last name", "Turing", false};

const EntryData testEntry2 = {"PersonalData", "Birth date", "19120623", false};

const EntryData testEntry3 = {"PersonalData", "First name", "Alan", false};

const EntryData testEntry4 = {"PersonalData", "Home address", "Maida Vale, London, England", false};

const std::vector<std::pair<EntryData, hidl_vec<uint8_t>>> testEntries{
    {testEntry1, {1}}, {testEntry2, {2}}, {testEntry3, {3}}, {testEntry4, {0, 1}}};
...
TEST_F(IdentityCredentialStoreHidlTest, ProvisionTestCredential) {
    ...
    credential->finishAddingEntryies([&](ResultCode hidl_error, hidl_vec<uint8_t> signedData) {
        ASSERT_EQ(ResultCode::OK, hidl_error);
