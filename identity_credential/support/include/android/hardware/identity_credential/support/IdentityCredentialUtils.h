...
// constexpr size_t kECKeySize = 32;      // 128 bit keys
...
// Creates an ephemeral EC key, returns the PKCS#8 encoded key-pair in |keyPair|.
...
// stores it in |publicKey| uncompressed point form|.
