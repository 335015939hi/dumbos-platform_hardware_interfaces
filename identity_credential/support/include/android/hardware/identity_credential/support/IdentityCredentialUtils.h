...
// TODO: move to separate files
struct SignedDataBuilderEntry {
    SignedDataBuilderEntry() {}
    SignedDataBuilderEntry(const std::string& nameSpace, const std::string& name,
                           const std::vector<uint8_t>& accessControlProfileIds,
                           const ::android::hardware::identity_credential::V1_0::EntryValue& value,
...
class SignedDataBuilder {
   ...
   private:
    ...
    std::vector<SignedDataBuilderEntry> entries_;
};
