...
import android.hardware.secure_element.ISecureElementHalCallback;
...
interface ISecureElement {
     ...
     * @return SecureElementStatus::SUCCESS on success and
     ...
     *                       client
     */
    void init(in ISecureElementHalCallback clientCallback);
     ...
     * @param out status SecureElementStatus::SUCCESS on success,
     ...
     *  // now return
     * @param out selectResponse On success, response to SELECT command is returned
     ...
     *                SecureElementStatus::IOERROR if there was an error
     *                communicating with the Secure Element.
     * @param out response On success, response to SELECT command is returned
     *                        empty vector on failure.
     */
     ...
     *
     * @param out SecureElementStatus::SUCCESS on success and SecureElementStatus::FAILED on error.
     */
    void reset();
