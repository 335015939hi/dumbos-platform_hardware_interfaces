...
#include "android/hardware/secure_element/translate-cpp.h"

namespace android::h2a {

static_assert(android::hardware::secure_element::SecureElementStatus::SUCCESS ==
              static_cast<android::hardware::secure_element::SecureElementStatus>(
                      ::android::hardware::secure_element::V1_0::SecureElementStatus::SUCCESS));
static_assert(android::hardware::secure_element::SecureElementStatus::FAILED ==
              static_cast<android::hardware::secure_element::SecureElementStatus>(
                      ::android::hardware::secure_element::V1_0::SecureElementStatus::FAILED));
static_assert(android::hardware::secure_element::SecureElementStatus::CHANNEL_NOT_AVAILABLE ==
              static_cast<android::hardware::secure_element::SecureElementStatus>(
                      ::android::hardware::secure_element::V1_0::SecureElementStatus::
                              CHANNEL_NOT_AVAILABLE));
static_assert(android::hardware::secure_element::SecureElementStatus::NO_SUCH_ELEMENT_ERROR ==
              static_cast<android::hardware::secure_element::SecureElementStatus>(
                      ::android::hardware::secure_element::V1_0::SecureElementStatus::
                              NO_SUCH_ELEMENT_ERROR));
static_assert(android::hardware::secure_element::SecureElementStatus::UNSUPPORTED_OPERATION ==
              static_cast<android::hardware::secure_element::SecureElementStatus>(
                      ::android::hardware::secure_element::V1_0::SecureElementStatus::
                              UNSUPPORTED_OPERATION));
static_assert(android::hardware::secure_element::SecureElementStatus::IOERROR ==
              static_cast<android::hardware::secure_element::SecureElementStatus>(
