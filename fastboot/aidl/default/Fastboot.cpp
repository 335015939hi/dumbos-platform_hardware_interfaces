...
using ::aidl::android::hardware::fastboot::Result;
using ::aidl::android::hardware::fastboot::Status;
...
ScopedAStatus Fastboot::doOemCommand(const std::string& in_oemCmd, Result* _aidl_return) {
    ...
    _aidl_return->status = Status::FAILURE_UNKNOWN;
    _aidl_return->message = "Command not supported in default implementation";
    return ScopedAStatus::fromServiceSpecificError(static_cast<int32_t>(Status::FAILURE_UNKNOWN));
}
...
ScopedAStatus Fastboot::doOemSpecificErase(Result* _aidl_return) {
    ...
    _aidl_return->message = "Command not supported in default implementation";
    return ScopedAStatus::fromServiceSpecificError(static_cast<int32_t>(Status::NOT_SUPPORTED));
}
