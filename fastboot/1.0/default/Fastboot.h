...
struct Fastboot : public IFastboot {
    ...
    Return<void> flashPartition(const hidl_string& partitionName,
                                const ::android::hardware::hidl_handle& image,
                                flashPartition_cb _hidl_cb) override;
    Return<void> erasePartition(const hidl_string& partitionName,
                                erasePartition_cb /* hidl_cb */) override;
