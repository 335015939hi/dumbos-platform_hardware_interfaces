...
interface IBootControl {
     ...
     * @throws service specific error -1 if slot is invalid.
     */
     ...
     *
     * @throws Service specific error -2 if command failed.
     */
     ...
     * @throws Service specific error -1 if slot is invalid, or -2 if
     * operation failed.
     */
     ...
     *
     * @throws service specific error -2 if operation failed.
     */
