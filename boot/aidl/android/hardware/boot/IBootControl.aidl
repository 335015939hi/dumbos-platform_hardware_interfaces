...
interface IBootControl {
     ...
     * @returns the slot number of that the current boot is booted
     */
    int getCurrentSlot();
     ...
     * @returns suffix for the input slot, or the empty string "" if slot
     ...
     * @throws service specific error if slot is invalid.
     */
     ...
     * @throws Service specific error if operation failed.
     */
