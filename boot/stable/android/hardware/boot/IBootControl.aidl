...
interface IBootControl {
    ...
    // Adding return type to method instead of out param boolean bootable since there is only one
    // return value.
    /**
    ...
    // Adding return type to method instead of out param boolean successful since there is only
    // one return value.
    /**
