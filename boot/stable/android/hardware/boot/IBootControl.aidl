...
// Interface inherits from android.hardware.boot@1.1::IBootControl but AIDL does not support
// interface inheritance.
@VintfStability
interface IBootControl {
    // Adding return type to method instead of out param int slot since there is only one return
    // value.
    /**
    ...
    // Adding return type to method instead of out param int numSlots since there is only one return
    // value.
    /**
    ...
    // Adding return type to method instead of out param MergeStatus status since there is only one
    // return value.
    /**
    ...
    // Adding return type to method instead of out param String slotSuffix since there is only one
    // return value.
    /**
    ...
    // Adding return type to method instead of out param BoolResult bootable since there is only one
    // return value.
    /**
    ...
    // Adding return type to method instead of out param BoolResult successful since there is only
    // one return value.
    /**
    ...
    // Adding return type to method instead of out param CommandResult error since there is only one
    // return value.
    /**
    ...
    // Adding return type to method instead of out param boolean success since there is only one
    // return value.
    /**
