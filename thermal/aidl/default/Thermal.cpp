...
ndk::ScopedAStatus Thermal::getCpuUsages(ThermalStatus* /* out_status */,
                                         std::vector<CpuUsage>* /* out_cpuUsages */) {
    LOG(VERBOSE) << __func__;
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Thermal::getCurrentCoolingDevices(
        bool in_filterType, CoolingType in_type, ThermalStatus* /* out_status */,
        std::vector<CoolingDevice>* /* out_devices */) {
...
ndk::ScopedAStatus Thermal::getTemperatures(ThermalStatus* /* out_status */,
                                            std::vector<Temperature>* /* out_temperatures */) {
    LOG(VERBOSE) << __func__;
    return ndk::ScopedAStatus::ok();
}
