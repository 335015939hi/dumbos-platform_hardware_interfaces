...
/**
 * Interface used to configure and control the lifecycle of tethering offload.
 */
@VintfStability
interface IOffload {
    /**
     * Status code for function.
     * Operation failed due to unspecific errors.
     */
    const int FAILURE_UNSPECIFIED = 1;
     ...
     *         - EX_SERVICE_SPECIFIC with status FAILURE_UNSPECIFIED and the error message set to a
     *           human-readable reason for other errors.
     */
     ...
     *           or IP prefix).
     *         - EX_ILLEGAL_STATE if IOffload is not initialized.
     *         - EX_SERVICE_SPECIFIC with status FAILURE_UNSPECIFIED and the error message set to a
     *           human-readable reason for other errors.
     *
     ...
     *
     * @throws :
     *         - EX_ILLEGAL_ARGUMENT if the upstream interface is invalid.
     *         - EX_SERVICE_SPECIFIC with status FAILURE_UNSPECIFIED and the error message set to a
     *           human-readable reason for other errors.
     */
     ...
     *
     * @throws :
     *         - EX_ILLEGAL_ARGUMENT if the callback interface is invalid.
     *         - EX_ILLEGAL_STATE if IOffload is already initialized.
     *         - EX_SERVICE_SPECIFIC with status FAILURE_UNSPECIFIED and the error message set to a
     *           human-readable reason for other errors.
     *
     ...
     */
    void initOffload(in ITetheringOffloadCallback cb);
