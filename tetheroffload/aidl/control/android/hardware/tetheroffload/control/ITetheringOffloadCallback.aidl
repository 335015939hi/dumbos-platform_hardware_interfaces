 ...
 */
<<<<<<< HEAD
// Interface inherits from android.hardware.tetheroffload.control@1.0::ITetheringOffloadCallback but AIDL does not support interface inheritance (methods have been flattened).
@VintfStability
interface ITetheringOffloadCallback {
    // Ignoring method onEvent from 1.0::ITetheringOffloadCallback since a newer alternative is available.
