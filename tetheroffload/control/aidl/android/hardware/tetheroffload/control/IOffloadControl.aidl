...
import android.hardware.tetheroffload.control.ForwardedStats;
 ...
 */
// Interface inherits from android.hardware.tetheroffload.control@1.0::IOffloadControl but AIDL does
// not support interface inheritance (methods have been flattened).
@VintfStability
interface IOffloadControl {
     ...
     *
     * This API does not replace any previously configured downstreams and must be explicitly removed
     ...
     *          being forwarded.
     */
    Status addDownstream(in String iface, in String prefix);
     ...
     *
     * @param out stats depicting the received and transmitted bytes
     */
    void getForwardedStats(in String upstream, out ForwardedStats stats);
     ...
     */
    Status initOffload(in ITetheringOffloadCallback cb);
     ...
     * @return Status of the call
     */
    Status removeDownstream(in String iface, in String prefix);
     ...
     * @return Status of the call
     */
    Status setDataWarningAndLimit(in String upstream, in long warningBytes, in long limitBytes);
     ...
     */
    Status setLocalPrefixes(in String[] prefixes);
     ...
     */
    Status setUpstreamParameters(in String iface, in String v4Addr, in String v4Gw, in String[] v6Gws);
