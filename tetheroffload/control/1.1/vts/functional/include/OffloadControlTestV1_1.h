...
class OffloadControlTestV1_1_HalNotStarted : public OffloadControlTestBase {
  public:
    ...
    void prepareControlHal() override {
        ...
        ASSERT_NE(nullptr, control_cb_1_1.get()) << "Could not get get offload callback";
    };
    ...
    void initOffload(const bool expected_result) override {
        ...
        const Return<void> ret = getControlV1_1()->initOffload_1_1(control_cb_1_1, init_cb);
    ...
    class TetheringOffloadCallbackV1_1
      ...
      public:
        Return<void> onEvent_1_1(android::hardware::tetheroffload::control::V1_1::OffloadCallbackEvent event) override {
