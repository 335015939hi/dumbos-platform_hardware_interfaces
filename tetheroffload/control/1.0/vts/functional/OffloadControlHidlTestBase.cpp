...
void OffloadControlHidlTestBase::SetUp() {
    setupConfigHal();
    prepareControlHal();
}

void OffloadControlHidlTestBase::TearDown() {
...
void OffloadControlHidlTestBase::setupConfigHal() {
...
void OffloadControlHidlTestBase::prepareControlHal() {
...
void OffloadControlHidlTestBase::initOffload(const bool expected_result) {
...
void OffloadControlHidlTestBase::setupControlHal() {
    prepareControlHal();
    initOffload(true);
}

void OffloadControlHidlTestBase::stopOffload(const ExpectBoolean value) {
