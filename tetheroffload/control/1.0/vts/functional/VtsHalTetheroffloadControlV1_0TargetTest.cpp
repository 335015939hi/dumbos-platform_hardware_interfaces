...
TEST_P(OffloadControlHidlTestNotInitedHalV1_0, AdditionalInitsWithoutStopReturnFalse) {
    initOffload(true);
    initOffload(false);
    initOffload(false);
    initOffload(false);
...
TEST_P(OffloadControlHidlTestNotInitedHalV1_0, MultipleStopsWithoutInitReturnFalse) {
...
TEST_P(OffloadControlHidlTestNotInitedHalV1_0, AdditionalStopsWithInitReturnFalse) {
    initOffload(true);
...
TEST_P(OffloadControlHidlTestNotInitedHalV1_0, SetLocalPrefixesWithoutInitReturnsFalse) {
...
TEST_P(OffloadControlHidlTestNotInitedHalV1_0, GetForwardedStatsWithoutInitReturnsZeroValues) {
...
TEST_P(OffloadControlHidlTestNotInitedHalV1_0, SetDataLimitWithoutInitReturnsFalse) {
    const hidl_string upstream(TEST_IFACE);
...
// returns false.
TEST_P(OffloadControlHidlTestNotInitedHalV1_0, SetUpstreamParametersWithoutInitReturnsFalse) {
...
TEST_P(OffloadControlHidlTestNotInitedHalV1_0, AddIPv4DownstreamWithoutInitReturnsFalse) {
    const hidl_string iface(TEST_IFACE);
...
// initOffload() returns false.
TEST_P(OffloadControlHidlTestNotInitedHalV1_0, AddIPv6DownstreamWithoutInitReturnsFalse) {
    const hidl_string iface(TEST_IFACE);
...
// initOffload() returns false.
TEST_P(OffloadControlHidlTestNotInitedHalV1_0, RemoveIPv4DownstreamWithoutInitReturnsFalse) {
    const hidl_string iface(TEST_IFACE);
    const hidl_string prefix("192.0.2.0/24");
...
// initOffload() returns false.
TEST_P(OffloadControlHidlTestNotInitedHalV1_0, RemoveIPv6DownstreamWithoutInitReturnsFalse) {
    const hidl_string iface(TEST_IFACE);
    const hidl_string prefix("2001:db8::/64");
    const Return<void> ret = control->removeDownstream(iface, prefix, ASSERT_FALSE_CALLBACK);
    EXPECT_TRUE(ret.isOk());
...
TEST_P(OffloadControlHidlTestInitedHalV1_0, SetLocalPrefixesIPv4AddressOk) {
...
TEST_P(OffloadControlHidlTestInitedHalV1_0, SetLocalPrefixesIPv6AddressOk) {
...
TEST_P(OffloadControlHidlTestInitedHalV1_0, SetLocalPrefixesIPv4v6PrefixesOk) {
...
TEST_P(OffloadControlHidlTestInitedHalV1_0, SetLocalPrefixesEmptyFails) {
...
TEST_P(OffloadControlHidlTestInitedHalV1_0, SetLocalPrefixesInvalidFails) {
...
TEST_P(OffloadControlHidlTestInitedHalV1_0, GetForwardedStatsInvalidUpstreamIface) {
...
TEST_P(OffloadControlHidlTestInitedHalV1_0, GetForwardedStatsDummyIface) {
    const hidl_string upstream(TEST_IFACE);
    const Return<void> ret = control->getForwardedStats(upstream, ASSERT_ZERO_BYTES_CALLBACK);
    EXPECT_TRUE(ret.isOk());
}
...
TEST_P(OffloadControlHidlTestInitedHalV1_0, SetDataLimitEmptyUpstreamIfaceFails) {
...
// TEST_IFACE is presumed to exist on the device and be up. No packets
// are ever actually caused to be forwarded.
TEST_P(OffloadControlHidlTestInitedHalV1_0, SetDataLimitNonZeroOk) {
    const hidl_string upstream(TEST_IFACE);
    const uint64_t limit = 5000ULL;
...
// TEST_IFACE is presumed to exist on the device and be up. No packets
// are ever actually caused to be forwarded.
TEST_P(OffloadControlHidlTestInitedHalV1_0, SetDataLimitZeroOk) {
    const hidl_string upstream(TEST_IFACE);
...
// TEST_IFACE is presumed to exist on the device and be up. No packets
// are ever actually caused to be forwarded.
TEST_P(OffloadControlHidlTestInitedHalV1_0, SetUpstreamParametersIPv6OnlyOk) {
    const hidl_string iface(TEST_IFACE);
...
// TEST_IFACE is presumed to exist on the device and be up. No packets
// are ever actually caused to be forwarded.
TEST_P(OffloadControlHidlTestInitedHalV1_0, SetUpstreamParametersAlternateIPv6OnlyOk) {
    const hidl_string iface(TEST_IFACE);
    const hidl_string v4Addr;
    const hidl_string v4Gw;
...
// TEST_IFACE is presumed to exist on the device and be up. No packets
// are ever actually caused to be forwarded.
TEST_P(OffloadControlHidlTestInitedHalV1_0, SetUpstreamParametersIPv4OnlyOk) {
    const hidl_string iface(TEST_IFACE);
...
// TEST_IFACE is presumed to exist on the device and be up. No packets
// are ever actually caused to be forwarded.
TEST_P(OffloadControlHidlTestInitedHalV1_0, SetUpstreamParametersIPv4v6Ok) {
    const hidl_string iface(TEST_IFACE);
    const hidl_string v4Addr("192.0.2.2");
    const hidl_string v4Gw("192.0.2.1");
    const vector<hidl_string> v6Gws{hidl_string("fe80::db8:1"), hidl_string("fe80::db8:2")};
...
TEST_P(OffloadControlHidlTestInitedHalV1_0, SetUpstreamParametersEmptyFails) {
...
TEST_P(OffloadControlHidlTestInitedHalV1_0, SetUpstreamParametersBogusIfaceFails) {
    const hidl_string v4Addr("192.0.2.2");
    const hidl_string v4Gw("192.0.2.1");
    const vector<hidl_string> v6Gws{hidl_string("fe80::db8:1")};
...
TEST_P(OffloadControlHidlTestInitedHalV1_0, SetUpstreamParametersInvalidIPv4AddrFails) {
    const hidl_string iface(TEST_IFACE);
    const hidl_string v4Gw("192.0.2.1");
    const vector<hidl_string> v6Gws{hidl_string("fe80::db8:1")};
...
TEST_P(OffloadControlHidlTestInitedHalV1_0, SetUpstreamParametersInvalidIPv4GatewayFails) {
    const hidl_string iface(TEST_IFACE);
    const hidl_string v4Addr("192.0.2.2");
    const vector<hidl_string> v6Gws{hidl_string("fe80::db8:1")};
    for (const auto& bogus : {"invalid", "192.0.2"}) {
...
TEST_P(OffloadControlHidlTestInitedHalV1_0, SetUpstreamParametersBadIPv6GatewaysFail) {
    const hidl_string iface(TEST_IFACE);
    const hidl_string v4Addr("192.0.2.2");
    const hidl_string v4Gw("192.0.2.1");
...
TEST_P(OffloadControlHidlTestInitedHalV1_0, AddDownstreamIPv4) {
...
TEST_P(OffloadControlHidlTestInitedHalV1_0, AddDownstreamIPv6) {
    const hidl_string iface("dummy0");
    const hidl_string prefix("2001:db8::/64");
    const Return<void> ret = control->addDownstream(iface, prefix, ASSERT_TRUE_CALLBACK);
    EXPECT_TRUE(ret.isOk());
...
TEST_P(OffloadControlHidlTestInitedHalV1_0, AddDownstreamEmptyFails) {
    const hidl_string iface("");
...
TEST_P(OffloadControlHidlTestInitedHalV1_0, AddDownstreamInvalidIfaceFails) {
    const hidl_string prefix("192.0.2.0/24");
    for (const auto& bogus : {"", "invalid"}) {
        SCOPED_TRACE(StringPrintf("iface='%s'", bogus));
        const hidl_string iface(bogus);
...
TEST_P(OffloadControlHidlTestInitedHalV1_0, AddDownstreamBogusPrefixFails) {
    const hidl_string iface("dummy0");
...
TEST_P(OffloadControlHidlTestInitedHalV1_0, RemoveDownstreamIPv4) {
    const hidl_string iface("dummy0");
    const hidl_string prefix("192.0.2.0/24");
...
TEST_P(OffloadControlHidlTestInitedHalV1_0, RemoveDownstreamIPv6) {
    const hidl_string iface("dummy0");
    const hidl_string prefix("2001:db8::/64");
    // First add the downstream, otherwise removeDownstream logic can reasonably
    // return false for downstreams not previously added.
...
TEST_P(OffloadControlHidlTestInitedHalV1_0, RemoveDownstreamEmptyFails) {
    const hidl_string iface("");
    const hidl_string prefix("");
    const Return<void> ret = control->removeDownstream(iface, prefix, ASSERT_FALSE_CALLBACK);
    EXPECT_TRUE(ret.isOk());
...
TEST_P(OffloadControlHidlTestInitedHalV1_0, RemoveDownstreamBogusIfaceFails) {
    const hidl_string prefix("192.0.2.0/24");
    for (const auto& bogus : {"", "invalid"}) {
        SCOPED_TRACE(StringPrintf("iface='%s'", bogus));
        const hidl_string iface(bogus);
...
TEST_P(OffloadControlHidlTestInitedHalV1_0, RemoveDownstreamBogusPrefixFails) {
    const hidl_string iface("dummy0");
    for (const auto& bogus : {"", "192.0.2/24", "2001:db8/64"}) {
        SCOPED_TRACE(StringPrintf("prefix='%s'", bogus));
        const hidl_string prefix(bogus);
...
INSTANTIATE_TEST_CASE_P(
        PerInstance, OffloadControlHidlTestNotInitedHalV1_0,
...
INSTANTIATE_TEST_CASE_P(
        PerInstance, OffloadControlHidlTestInitedHalV1_0,
        testing::Combine(testing::ValuesIn(android::hardware::getAllHalInstanceNames(
                                 IOffloadConfig::descriptor)),
                         testing::ValuesIn(android::hardware::getAllHalInstanceNames(
                                 IOffloadControl::descriptor))),
