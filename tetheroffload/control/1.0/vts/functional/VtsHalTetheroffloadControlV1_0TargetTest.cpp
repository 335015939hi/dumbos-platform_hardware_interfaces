...
#include <OffloadControlHidlTestV1_0.h>
...
TEST_P(OffloadControlHidlTestV1_0_NotInitedHal, AdditionalInitsWithoutStopReturnFalse) {
    initOffload(true);
    initOffload(false);
    initOffload(false);
    initOffload(false);
...
TEST_P(OffloadControlHidlTestV1_0_NotInitedHal, MultipleStopsWithoutInitReturnFalse) {
...
TEST_P(OffloadControlHidlTestV1_0_NotInitedHal, AdditionalStopsWithInitReturnFalse) {
    initOffload(true);
...
TEST_P(OffloadControlHidlTestV1_0_NotInitedHal, SetLocalPrefixesWithoutInitReturnsFalse) {
...
TEST_P(OffloadControlHidlTestV1_0_NotInitedHal, GetForwardedStatsWithoutInitReturnsZeroValues) {
...
TEST_P(OffloadControlHidlTestV1_0_NotInitedHal, SetDataLimitWithoutInitReturnsFalse) {
    const hidl_string upstream(TEST_IFACE);
...
// returns false.
TEST_P(OffloadControlHidlTestV1_0_NotInitedHal, SetUpstreamParametersWithoutInitReturnsFalse) {
...
TEST_P(OffloadControlHidlTestV1_0_NotInitedHal, AddIPv4DownstreamWithoutInitReturnsFalse) {
    const hidl_string iface(TEST_IFACE);
...
// initOffload() returns false.
TEST_P(OffloadControlHidlTestV1_0_NotInitedHal, AddIPv6DownstreamWithoutInitReturnsFalse) {
    const hidl_string iface(TEST_IFACE);
...
// initOffload() returns false.
TEST_P(OffloadControlHidlTestV1_0_NotInitedHal, RemoveIPv4DownstreamWithoutInitReturnsFalse) {
    const hidl_string iface(TEST_IFACE);
    const hidl_string prefix("192.0.2.0/24");
...
// initOffload() returns false.
TEST_P(OffloadControlHidlTestV1_0_NotInitedHal, RemoveIPv6DownstreamWithoutInitReturnsFalse) {
    const hidl_string iface(TEST_IFACE);
    const hidl_string prefix("2001:db8::/64");
    const Return<void> ret = control->removeDownstream(iface, prefix, ASSERT_FALSE_CALLBACK);
    EXPECT_TRUE(ret.isOk());
...
TEST_P(OffloadControlHidlTestV1_0_InitedHal, SetLocalPrefixesIPv4AddressOk) {
...
TEST_P(OffloadControlHidlTestV1_0_InitedHal, SetLocalPrefixesIPv6AddressOk) {
...
TEST_P(OffloadControlHidlTestV1_0_InitedHal, SetLocalPrefixesIPv4v6PrefixesOk) {
...
TEST_P(OffloadControlHidlTestV1_0_InitedHal, SetLocalPrefixesEmptyFails) {
...
TEST_P(OffloadControlHidlTestV1_0_InitedHal, SetLocalPrefixesInvalidFails) {
...
TEST_P(OffloadControlHidlTestV1_0_InitedHal, GetForwardedStatsInvalidUpstreamIface) {
...
TEST_P(OffloadControlHidlTestV1_0_InitedHal, GetForwardedStatsDummyIface) {
    const hidl_string upstream(TEST_IFACE);
    const Return<void> ret = control->getForwardedStats(upstream, ASSERT_ZERO_BYTES_CALLBACK);
    EXPECT_TRUE(ret.isOk());
}
...
TEST_P(OffloadControlHidlTestV1_0_InitedHal, SetDataLimitEmptyUpstreamIfaceFails) {
...
// TEST_IFACE is presumed to exist on the device and be up. No packets
// are ever actually caused to be forwarded.
TEST_P(OffloadControlHidlTestV1_0_InitedHal, SetDataLimitNonZeroOk) {
    const hidl_string upstream(TEST_IFACE);
    const uint64_t limit = 5000ULL;
...
// TEST_IFACE is presumed to exist on the device and be up. No packets
// are ever actually caused to be forwarded.
TEST_P(OffloadControlHidlTestV1_0_InitedHal, SetDataLimitZeroOk) {
    const hidl_string upstream(TEST_IFACE);
...
// TEST_IFACE is presumed to exist on the device and be up. No packets
// are ever actually caused to be forwarded.
TEST_P(OffloadControlHidlTestV1_0_InitedHal, SetUpstreamParametersIPv6OnlyOk) {
    const hidl_string iface(TEST_IFACE);
...
// TEST_IFACE is presumed to exist on the device and be up. No packets
// are ever actually caused to be forwarded.
TEST_P(OffloadControlHidlTestV1_0_InitedHal, SetUpstreamParametersAlternateIPv6OnlyOk) {
    const hidl_string iface(TEST_IFACE);
    const hidl_string v4Addr;
    const hidl_string v4Gw;
...
// TEST_IFACE is presumed to exist on the device and be up. No packets
// are ever actually caused to be forwarded.
TEST_P(OffloadControlHidlTestV1_0_InitedHal, SetUpstreamParametersIPv4OnlyOk) {
    const hidl_string iface(TEST_IFACE);
...
// TEST_IFACE is presumed to exist on the device and be up. No packets
// are ever actually caused to be forwarded.
TEST_P(OffloadControlHidlTestV1_0_InitedHal, SetUpstreamParametersIPv4v6Ok) {
    const hidl_string iface(TEST_IFACE);
    const hidl_string v4Addr("192.0.2.2");
    const hidl_string v4Gw("192.0.2.1");
    const vector<hidl_string> v6Gws{hidl_string("fe80::db8:1"), hidl_string("fe80::db8:2")};
...
TEST_P(OffloadControlHidlTestV1_0_InitedHal, SetUpstreamParametersEmptyFails) {
...
TEST_P(OffloadControlHidlTestV1_0_InitedHal, SetUpstreamParametersBogusIfaceFails) {
    const hidl_string v4Addr("192.0.2.2");
    const hidl_string v4Gw("192.0.2.1");
    const vector<hidl_string> v6Gws{hidl_string("fe80::db8:1")};
...
TEST_P(OffloadControlHidlTestV1_0_InitedHal, SetUpstreamParametersInvalidIPv4AddrFails) {
    const hidl_string iface(TEST_IFACE);
    const hidl_string v4Gw("192.0.2.1");
    const vector<hidl_string> v6Gws{hidl_string("fe80::db8:1")};
...
TEST_P(OffloadControlHidlTestV1_0_InitedHal, SetUpstreamParametersInvalidIPv4GatewayFails) {
    const hidl_string iface(TEST_IFACE);
    const hidl_string v4Addr("192.0.2.2");
    const vector<hidl_string> v6Gws{hidl_string("fe80::db8:1")};
    for (const auto& bogus : {"invalid", "192.0.2"}) {
...
TEST_P(OffloadControlHidlTestV1_0_InitedHal, SetUpstreamParametersBadIPv6GatewaysFail) {
    const hidl_string iface(TEST_IFACE);
    const hidl_string v4Addr("192.0.2.2");
    const hidl_string v4Gw("192.0.2.1");
...
TEST_P(OffloadControlHidlTestV1_0_InitedHal, AddDownstreamIPv4) {
...
TEST_P(OffloadControlHidlTestV1_0_InitedHal, AddDownstreamIPv6) {
    const hidl_string iface("dummy0");
    const hidl_string prefix("2001:db8::/64");
    const Return<void> ret = control->addDownstream(iface, prefix, ASSERT_TRUE_CALLBACK);
    EXPECT_TRUE(ret.isOk());
...
TEST_P(OffloadControlHidlTestV1_0_InitedHal, AddDownstreamEmptyFails) {
    const hidl_string iface("");
...
TEST_P(OffloadControlHidlTestV1_0_InitedHal, AddDownstreamInvalidIfaceFails) {
    const hidl_string prefix("192.0.2.0/24");
    for (const auto& bogus : {"", "invalid"}) {
        SCOPED_TRACE(StringPrintf("iface='%s'", bogus));
        const hidl_string iface(bogus);
...
TEST_P(OffloadControlHidlTestV1_0_InitedHal, AddDownstreamBogusPrefixFails) {
    const hidl_string iface("dummy0");
...
TEST_P(OffloadControlHidlTestV1_0_InitedHal, RemoveDownstreamIPv4) {
    const hidl_string iface("dummy0");
    const hidl_string prefix("192.0.2.0/24");
...
TEST_P(OffloadControlHidlTestV1_0_InitedHal, RemoveDownstreamIPv6) {
    const hidl_string iface("dummy0");
    const hidl_string prefix("2001:db8::/64");
    // First add the downstream, otherwise removeDownstream logic can reasonably
    // return false for downstreams not previously added.
...
TEST_P(OffloadControlHidlTestV1_0_InitedHal, RemoveDownstreamEmptyFails) {
    const hidl_string iface("");
    const hidl_string prefix("");
    const Return<void> ret = control->removeDownstream(iface, prefix, ASSERT_FALSE_CALLBACK);
    EXPECT_TRUE(ret.isOk());
...
TEST_P(OffloadControlHidlTestV1_0_InitedHal, RemoveDownstreamBogusIfaceFails) {
    const hidl_string prefix("192.0.2.0/24");
    for (const auto& bogus : {"", "invalid"}) {
        SCOPED_TRACE(StringPrintf("iface='%s'", bogus));
        const hidl_string iface(bogus);
...
TEST_P(OffloadControlHidlTestV1_0_InitedHal, RemoveDownstreamBogusPrefixFails) {
    const hidl_string iface("dummy0");
    for (const auto& bogus : {"", "192.0.2/24", "2001:db8/64"}) {
        SCOPED_TRACE(StringPrintf("prefix='%s'", bogus));
        const hidl_string prefix(bogus);
...
INSTANTIATE_TEST_CASE_P(
        PerInstance, OffloadControlHidlTestV1_0_NotInitedHal,
...
INSTANTIATE_TEST_CASE_P(
        PerInstance, OffloadControlHidlTestV1_0_InitedHal,
        testing::Combine(testing::ValuesIn(android::hardware::getAllHalInstanceNames(
                                 IOffloadConfig::descriptor)),
                         testing::ValuesIn(android::hardware::getAllHalInstanceNames(
                                 IOffloadControl::descriptor))),
