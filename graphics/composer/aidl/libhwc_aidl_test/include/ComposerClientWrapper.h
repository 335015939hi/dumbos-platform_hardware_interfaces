...
class ComposerClientWrapper {
  public:
    ...
    ScopedAStatus setActiveConfig(DisplayWrapper* displayWrapper, int32_t config);

    ScopedAStatus setPeakRefreshRateConfig(DisplayWrapper* displayWrapper);
  ...
  private:
    ...
    ScopedAStatus updateDisplayProperties(DisplayWrapper* displayWrapper, int32_t config);
