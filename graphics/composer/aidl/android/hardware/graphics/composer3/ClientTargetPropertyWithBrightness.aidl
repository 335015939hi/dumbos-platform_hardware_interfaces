...
parcelable ClientTargetPropertyWithBrightness {
     ...
     * may apply certain image quality adjustments that are sensitive to gamma shift when dimming
     * in linear space. To avoid this issue, those implementations must opt to dim in gamma space.
     */
