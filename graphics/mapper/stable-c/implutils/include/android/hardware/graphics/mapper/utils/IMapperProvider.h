...
struct IMapperV5Impl {
    ...
    virtual AIMapper_Error validateBufferSize(buffer_handle_t _Nonnull buffer,
    ...
    virtual int32_t getMetadata(buffer_handle_t _Nonnull buffer, AIMapper_MetadataType metadataType,
                                void* _Nonnull outData, size_t outDataSize) = 0;
    ...
    virtual AIMapper_Error setMetadata(buffer_handle_t _Nonnull buffer,
                                       AIMapper_MetadataType metadataType, void* _Nonnull metadata,
                                       size_t metadataSize) = 0;

    virtual AIMapper_Error setStandardMetadata(buffer_handle_t _Nonnull buffer,
                                               int64_t standardMetadataType,
                                               void* _Nonnull metadata, size_t metadataSize) = 0;

    virtual int32_t getFromBufferDescriptorInfo(AIMapper_BufferDescriptorInfo* _Nonnull description,
                                                const AIMapper_MetadataType* _Nonnull metadataType,
                                                void* _Nonnull outData, size_t outDataSize) = 0;
  ...
  private:
    ...
    void bindV5() {
        mMapper.v5 = {
                ...
                .validateBufferSize = [](buffer_handle_t _Nonnull buffer,
                                         AIMapper_BufferDescriptorInfo* _Nonnull description,
                                         uint32_t stride) -> AIMapper_Error {
                    return impl().validateBufferSize(buffer, description, stride);
                },
                ...
                .getMetadata = [](buffer_handle_t _Nonnull buffer,
                                  ...
                                  size_t outDataSize) -> int32_t {
                    return impl().getMetadata(buffer, metadataType, outData, outDataSize);
                },

                .getStandardMetadata = [](buffer_handle_t _Nonnull buffer,
                                          int64_t standardMetadataType, void* _Nonnull outData,
                                          size_t outDataSize) -> int32_t {
                    return impl().getStandardMetadata(buffer, standardMetadataType, outData,
                                                      outDataSize);
                },
                ...
                .setStandardMetadata = [](buffer_handle_t _Nonnull buffer,
                                          int64_t standardMetadataType, void* _Nonnull metadata,
                                          size_t metadataSize) -> AIMapper_Error {
                ...
                .getFromBufferDescriptorInfo =
                        [](AIMapper_BufferDescriptorInfo* _Nonnull description,
                           const AIMapper_MetadataType* _Nonnull metadataType,
                           void* _Nonnull outData, size_t outDataSize) -> int32_t {
                    return impl().getFromBufferDescriptorInfo(description, metadataType, outData,
                                                              outDataSize);
                },
