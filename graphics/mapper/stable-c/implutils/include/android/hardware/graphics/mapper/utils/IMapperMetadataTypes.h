...
class MetadataWriter {
  ...
  public:
    explicit MetadataWriter(void* _Nullable outData, size_t outDataSize)
        : mDest(reinterpret_cast<uint8_t*>(outData)), mSizeRemaining(outDataSize) {}
...
struct MetadataValue<T, std::enable_if_t<std::is_integral_v<T>>> {
    [[nodiscard]] static int32_t encode(T value, void* _Nullable outData, size_t outDataSize) {
        return MetadataWriter{outData, outDataSize}.write(value).desiredSize();
    }
...
struct MetadataValue<T, std::enable_if_t<std::is_enum_v<T>>> {
    [[nodiscard]] static int32_t encode(T value, void* _Nullable outData, size_t outDataSize) {
        return MetadataWriter{outData, outDataSize}
    ...
    [[nodiscard]] static std::optional<T> decode(const void* _Nonnull metadata,
        ...
        return static_cast<T>(
                MetadataReader{metadata, metadataSize}.readInt<std::underlying_type_t<T>>());
    }
};

template <>
struct MetadataValue<std::string_view> {
    [[nodiscard]] static int32_t encode(const std::string_view& value, void* _Nullable outData,
                                        size_t outDataSize) {
        return MetadataWriter{outData, outDataSize}.write(value).desiredSize();
    }

    [[nodiscard]] static std::string_view decode(const void* _Nonnull metadata,
                                                 size_t metadataSize) {
        return MetadataReader{metadata, metadataSize}.readString();
    }
};
...
struct MetadataValue<ExtendableType> {
    ...
    [[nodiscard]] static int32_t encode(const ExtendableType& value, void* _Nullable outData,
                                        size_t outDataSize) {
        return MetadataWriter{outData, outDataSize}.write(value).desiredSize();
    }
...
struct MetadataValue<std::vector<PlaneLayout>> {
    [[nodiscard]] static int32_t encode(const std::vector<PlaneLayout>& values,
        ...
        MetadataWriter writer{outData, outDataSize};
    ...
    [[nodiscard]] static std::vector<PlaneLayout> decode(const void* _Nonnull metadata,
                                                         size_t metadataSize) {
...
struct MetadataValue<std::vector<Rect>> {
    [[nodiscard]] static int32_t encode(const std::vector<Rect>& value, void* _Nullable outData,
                                        size_t outDataSize) {
        MetadataWriter writer{outData, outDataSize};
    ...
    [[nodiscard]] static std::vector<Rect> decode(const void* _Nonnull metadata,
                                                  size_t metadataSize) {
        MetadataReader reader{metadata, metadataSize};
...
template <>
struct MetadataValue<Smpte2086> {
    [[nodiscard]] static int32_t encode(const Smpte2086& value, void* _Nullable outData,
                                        size_t outDataSize) {
        return MetadataWriter{outData, outDataSize}
    ...
    [[nodiscard]] static std::optional<Smpte2086> decode(const void* _Nonnull metadata,
                                                         size_t metadataSize) {
        MetadataReader reader{metadata, metadataSize};
        Smpte2086 value;
...
template <>
struct MetadataValue<Cta861_3> {
    [[nodiscard]] static int32_t encode(const Cta861_3& value, void* _Nullable outData,
                                        size_t outDataSize) {
        return MetadataWriter{outData, outDataSize}
    ...
    [[nodiscard]] static std::optional<Cta861_3> decode(const void* _Nonnull metadata,
                                                        size_t metadataSize) {
        MetadataReader reader{metadata, metadataSize};
        Cta861_3 value;
...
template <>
struct MetadataValue<std::vector<uint8_t>> {
    [[nodiscard]] static int32_t encode(const std::vector<uint8_t>& value, void* _Nullable outData,
                                        size_t outDataSize) {
        return MetadataWriter{outData, outDataSize}.write(value).desiredSize();
    }

    [[nodiscard]] static std::vector<uint8_t> decode(const void* _Nonnull metadata,
                                                     size_t metadataSize) {
        return MetadataReader{metadata, metadataSize}.readBuffer();
    }
};

constexpr StandardMetadataType asStandardMetadataType(int64_t value) {
    if (value < 0 || value >= ndk::internal::enum_values<StandardMetadataType>.size()) {
        return StandardMetadataType::INVALID;
    }
    return static_cast<StandardMetadataType>(value);
}
...
DEFINE_TYPE(NAME, std::string_view);
...
DEFINE_TYPE(SMPTE2086, Smpte2086);
DEFINE_TYPE(CTA861_3, Cta861_3);
DEFINE_TYPE(SMPTE2094_10, std::vector<uint8_t>);
DEFINE_TYPE(SMPTE2094_40, std::vector<uint8_t>);
...
int32_t provideStandardMetadata(StandardMetadataType type, void* _Nullable outData,
                                size_t outDataSize, F&& f) {
            ...
            [&]<StandardMetadataType T>(StandardMetadata<T>) {
                retVal = f.template operator()<T>(
                        [&](const typename StandardMetadata<T>::value_type& value) -> int32_t {
                            return StandardMetadata<T>::value::encode(value, outData, outDataSize);
                        });
            },
