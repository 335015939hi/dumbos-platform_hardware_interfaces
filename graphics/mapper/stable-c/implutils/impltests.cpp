...
TEST(Metadata, setGetPlaneLayout) {
    ...
    EXPECT_EQ(0, PlaneLayoutValue::decode(buffer.data(), 0).size());
...
TEST(Metadata, safeCast) {
    EXPECT_EQ(StandardMetadataType::INVALID, asStandardMetadataType(-1));
    EXPECT_EQ(StandardMetadataType::INVALID, asStandardMetadataType(199));
    EXPECT_EQ(StandardMetadataType::INVALID,
              asStandardMetadataType(static_cast<int>(StandardMetadataType::SMPTE2094_10) + 1));
    EXPECT_EQ(StandardMetadataType::INVALID, asStandardMetadataType(0));
    EXPECT_EQ(StandardMetadataType::BUFFER_ID, asStandardMetadataType(1));
    EXPECT_EQ(StandardMetadataType::SMPTE2094_10,
              asStandardMetadataType(static_cast<int>(StandardMetadataType::SMPTE2094_10)));
}
