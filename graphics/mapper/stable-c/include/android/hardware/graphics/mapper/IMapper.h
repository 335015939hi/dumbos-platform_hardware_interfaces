...
typedef struct AIMapperV6 {
     ...
     */
    AIMapper_Error (*_Nonnull getMultiViewInfo)(
     ...
     *     - `UNSUPPORTED` if there's any error
     */
    AIMapper_Error (*_Nonnull getBaseView)(
            buffer_handle_t _Nonnull buffer,
     ...
     * It is callers responsibilty to free the buffer handle.
     *
    ...
    AIMapper_Error (*_Nonnull importViewBuffer)(
            buffer_handle_t _Nonnull multiViewHandle,
            uint32_t viewIndex,
