   ...
   protected:
    ...
    static bool toYCbCrLayout(const android_flex_layout& flex, YCbCrLayout* outLayout) {
        ...
        if (flex.planes[0].component != FLEX_COMPONENT_Y ||
           (flex.planes[1].component != FLEX_COMPONENT_Cb && flex.planes[2].component != FLEX_COMPONENT_Cb) ||
           (flex.planes[1].component != FLEX_COMPONENT_Cr && flex.planes[2].component != FLEX_COMPONENT_Cr)) {
            return false;
        }
