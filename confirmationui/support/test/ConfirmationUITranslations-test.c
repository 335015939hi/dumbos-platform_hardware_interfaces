...
extern int ConfirmationUITranslations_lang_id_match(const char** lang_ids, const char* lang_id);
...
int main(int argc, char* argv[]) {
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Double-press power to confirm");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Cancel");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "This confirmation provides an extra layer of security for the action you're about "
               "to take.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"), "Press power to confirm");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Press any volume button to cancel");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Cancel");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Dubbeldruk aan/af-skakelaar om te bevestig");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Kanselleer");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Hierdie bevestiging verskaf 'n ekstra laag sekuriteit vir die handeling wat jy op "
               "die punt is om uit te voer.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Druk aan/af-skakelaar om te bevestig");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Druk enige volumeknoppie om te kanselleer");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Kanselleer");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Android se Beskermde Bevestiging");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "ይህ ማረጋገጫ እርስዎ ለሚወስዱት እርምጃ ተጨማሪ ትርፍ ጥበቃን ይሰጣል።");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"), "ለማረጋገጥ ኃይልን ይጫኑ");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "ለመሰረዝ ማናቸውንም የድምፅ አዝራር ይጫኑ");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "ይቅር");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "በAndroid ጥበቃ የሚደረግለት ማረጋገጫ");

    /* Tests for language ar */
    ConfirmationUITranslations_select_lang_id("ar");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "اضغط على زر التشغيل مرتين لتأكيد الإجراء.");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "إلغاء");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "يتيح هذا التأكيد تفعيل طبقة أمان إضافية للإجراء الذي توشك على اتخاذه.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "اضغط على زر التشغيل لتأكيد الإجراء.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "اضغط على أي زر من أزرار مستوى الصوت لإلغاء الإجراء.");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "‏‮Cancel‬‏");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "‏‮This‬‏ ‏‮confirmation‬‏ ‏‮provides‬‏ ‏‮an‬‏ "
               "‏‮extra‬‏ ‏‮layer‬‏ ‏‮of‬‏ ‏‮security‬‏ "
               "‏‮for‬‏ ‏‮the‬‏ ‏‮action‬‏ ‏‮you‬‏'‏‮re‬‏ "
               "‏‮about‬‏ ‏‮to‬‏ ‏‮take‬‏.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "নিশ্চিত কৰিবলৈ পাৱাৰ বুটামটো দুবাৰ হেঁচক");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "বাতিল কৰক");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "এই প্ৰতিশ্ৰুতিয়ে আপুনি কৰিব বিচৰা কোনো কাৰ্যৰ বাবে অতিৰিক্ত সুৰক্ষা প্ৰদান কৰে।");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "নিশ্চিত কৰিবলৈ পাৱাৰ বুটাম হেঁচক");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "বাতিল কৰিবলৈ যিকোনো ভলিউম বুটাম হেঁচক");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "বাতিল কৰক");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Androidৰ সুৰক্ষা সম্পৰ্কীয় প্ৰতিশ্ৰুতি");

    /* Tests for language az */
    ConfirmationUITranslations_select_lang_id("az");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Təsdiqləmək üçün iki dəfə yandırıb-söndürmək düyməsinə basın");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Ləğv edin");
    ASSERT_STR(
            ConfirmationUITranslations_lookup("217688588483778177"),
            "Bu təsdiq etmək üzrə olduğunuz əməliyyat üçün əlavə təhlükəsizlik qatı təmin edir.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Təsdiq etmək üçün yandırıb-söndürmə düyməsinə basın");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Ləğv etmək üçün istənilən səs düyməsinə basın");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Двойчы націсніце кнопку сілкавання, каб пацвердзіць");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Скасаваць");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Гэта пацвярджэнне забяспечвае дадатковы ўзровень бяспекі для дзеянняў, якія вы "
               "збіраецеся выконваць.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Націсніце кнопку сілкавання, каб пацвердзіць");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Націсніце любую кнопку гучнасці, каб cкасаваць");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Скасаваць");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Пацвярджэнне Android Protected");

    /* Tests for language bg */
    ConfirmationUITranslations_select_lang_id("bg");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Натиснете два пъти бутона за захранване, за да потвърдите");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Отказ");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Това потвърждение осигурява допълнителна защита за действието, което сте напът да "
               "предприемете.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Натиснете бутона за захранване, за да потвърдите");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Натиснете някой от бутоните за силата на звука, за да анулирате");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Отказ");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Защитно потвърждение за Android");

    /* Tests for language bn */
    ConfirmationUITranslations_select_lang_id("bn");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "নিশ্চিত করতে পাওয়ার বোতাম দুবার টিপুন");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "বাতিল করুন");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "আপনি যে কাজটি করতে চলেছেন, এই কনফার্মেশনের ফলে সেটির জন্য অতিরিক্ত সুরক্ষার ব্যবস্থা করা "
               "হয়।");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "নিশ্চিত করতে পাওয়ার বোতাম টিপুন");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "বাতিল করতে ভলিউমের যেকোনও বোতাম টিপুন");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "বাতিল করুন");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Android প্রোটেক্টেড কনফার্মেশন");

    /* Tests for language bs */
    ConfirmationUITranslations_select_lang_id("bs");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Dva puta pritisnite dugme za napajanje da potvrdite");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Otkaži");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Ova potvrda pruža dodatni sloj zaštite za radnju koju namjeravate preduzeti.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Pritisnite dugme za napajanje za potvrdu");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Pritisnite bilo koje dugme za podešavanje jačine zvuka da otkažete");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Otkaži");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Potvrda zaštite na Androidu");

    /* Tests for language ca */
    ConfirmationUITranslations_select_lang_id("ca");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Prem dos cops el botó d'engegada per confirmar");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Cancel·la");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Aquesta confirmació proporciona una capa de seguretat addicional per a l'acció que "
               "estàs a punt de dur a terme.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Prem el botó d'engegada per confirmar");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Prem qualsevol botó de volum per cancel·lar");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Cancel·la");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Confirmació de protecció d'Android");

    /* Tests for language cs */
    ConfirmationUITranslations_select_lang_id("cs");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Potvrďte dvojitým stisknutím vypínače");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Zrušit");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Toto potvrzení tvoří dodatečnou úroveň zabezpečení akce, kterou se chystáte "
               "podniknout.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Potvrďte stisknutím vypínače");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Zrušte stisknutím tlačítka hlasitosti");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Zrušit");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Potvrzení ochrany Androidu");

    /* Tests for language da */
    ConfirmationUITranslations_select_lang_id("da");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Tryk to gange på afbryderknappen for at bekræfte");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Annuller");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Denne bekræftelse giver et ekstra beskyttelsesniveau for den handling, du er ved "
               "at foretage.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Tryk på afbryderknappen for at bekræfte");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Tryk på en af lydstyrkeknapperne for at annullere");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Annuller");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Beskyttet bekræftelse i Android");

    /* Tests for language de */
    ConfirmationUITranslations_select_lang_id("de");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Zum Bestätigen die Ein-/Aus-Taste zweimal drücken");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Abbrechen");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Durch die Bestätigung wird bei der Aktion, die du durchführen möchtest, eine "
               "zusätzliche Sicherheitsmaßnahme angewandt.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Drücke zum Bestätigen die Ein-/Aus-Taste");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Zum Abbrechen eine beliebige Lautstärketaste drücken");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Durch die Bestätigung wird bei der Aktion, die du durchführen möchtest, eine "
               "zusätzliche Sicherheitsmassnahme angewandt.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Drücke zum Bestätigen die Ein-/Aus-Taste");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Zum Abbrechen eine beliebige Lautstärketaste drücken");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Πατήστε δύο φορές το κουμπί λειτουργίας για επιβεβαίωση");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Ακύρωση");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Αυτή η επιβεβαίωση παρέχει ένα επιπλέον επίπεδο ασφάλειας για την ενέργεια που "
               "πρόκειται να εκτελέσετε.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Πατήστε το κουμπί λειτουργίας για επιβεβαίωση");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Πατήστε οποιοδήποτε κουμπί έντασης ήχου για ακύρωση");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Ακύρωση");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Επιβεβαίωση προστασίας Android");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Cancel");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "This confirmation provides an extra layer of security for the action that you're "
               "about to take.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"), "Press power to confirm");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Press any volume button to cancel");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "[Ðöûбļé-þŕéšš þöŵéŕ ţö çöñƒîŕm one two three four five six seven]");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "[Çåñçéļ one]");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "[Ţĥîš çöñƒîŕmåţîöñ þŕövîðéš åñ éxţŕå ļåýéŕ öƒ šéçûŕîţý ƒöŕ ţĥé åçţîöñ ýöû'ŕé åбöûţ "
               "ţö ţåķé. one two three four five six seven eight nine ten eleven twelve thirteen "
               "fourteen fifteen sixteen]");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "[Þŕéšš þöŵéŕ ţö çöñƒîŕm one two three four five]");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "[Þŕéšš åñý vöļûmé бûţţöñ ţö çåñçéļ one two three four five six seven]");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "[Çåñçéļ one]");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "[Åñðŕöîð Þŕöţéçţéð Çöñƒîŕmåţîöñ one two three four]");

    /* Tests for language en-XC */
    ConfirmationUITranslations_select_lang_id("en-XC");
    ASSERT_STR(
            ConfirmationUITranslations_lookup("1424834532030812203"),
            "‎‏‎‎‎‎‎‏‎‏‏‏‎‎‎‎‏‏‏‎‏‏‎‎‏‎‎‏"
            "‏‏‏‎‏‏‎‎‏‏‏‏‎‎‎‏‏‎‎‎‎‎‎‏‏‏‎‏"
            "‏‏‎‏‎‏‎‎‏‏‎‎‎‏‎‏‏‎‏‎‎‎‎‎‎‏‎‎"
            "‎‎‎‎‏‎‏‎‏‏‎Double-press power to confirm‎‏‎‎‏‎");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"),
               "‎‏‎‎‎‎‎‏‎‏‏‏‎‎‎‎‏‏‏‎‏‏‎‎‏‎‎"
               "‏‏‏‏‎‏‏‏‎‎‎‏‏‏‎‏‏‎‏‏‎‏‎‏‏‎‏"
               "‏‎‏‏‎‎‎‎‎‏‏‎‏‏‏‎‎‎‏‏‏‏‏‎‎‎‎"
               "‏‎‎‎‎‏‏‎‎‎‏‏‏‎Cancel‎‏‎‎‏‎");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               ...
               "‏‏‏‎‏‎‏‏‎‎‎‎‎‏‎‏‎‏‏‎‎‎‏‎‏‎‎"
               "‏‏‏‏‎‎‎‏‎‏‏‎‎‎‎‏‏‏‎‏‏‎‏‎‏‎‏"
               "‏‎‏‎‎‎‎‎‎‏‎This confirmation provides an extra layer of "
               "security for the action you're about to take.‎‏‎‎‏‎");
    ASSERT_STR(
            ConfirmationUITranslations_lookup("2181224373757710937"),
            "‎‏‎‎‎‎‎‏‎‏‏‏‎‎‎‎‏‏‏‎‏‏‎‎‏‎‎‏"
            "‏‏‏‎‏‏‏‏‏‎‎‏‎‎‎‏‎‏‎‏‎‎‎‏‎‎‎‎"
            "‎‎‎‎‏‎‏‏‏‎‎‏‎‏‎‏‎‎‎‎‎‎‏‎‎‏‎‎"
            "‏‎‎‏‎‏‏‎‎‏‎Press power to confirm‎‏‎‎‏‎");
    ASSERT_STR(
            ConfirmationUITranslations_lookup("2213954494039981979"),
            "‎‏‎‎‎‎‎‏‎‏‏‏‎‎‎‎‏‏‏‎‏‏‎‎‏‎‎‏"
            "‏‏‏‎‏‏‏‏‏‎‏‎‏‏‏‎‎‏‏‎‎‎‏‎‏‏‏‏"
            "‏‎‎‎‎‏‏‏‎‏‏‏‏‎‎‎‏‎‎‎‎‏‏‏‏‏‏‏"
            "‏‏‏‎‎‏‏‎‏‏‎Press any volume button to cancel‎‏‎‎‏‎");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"),
               "‎‏‎‎‎‎‎‏‎‏‏‏‎‎‎‎‏‏‏‎‏‏‎‎‏‎‎"
               "‏‏‏‏‏‎‏‏‎‏‏‏‏‎‎‎‎‎‎‎‎‏‎‏‏‎‏"
               "‎‏‏‏‏‎‏‎‎‏‏‏‎‎‏‏‎‎‏‏‏‏‏‎‎‏‎"
               "‏‎‎‏‎‏‏‏‏‏‏‏‎‏‎Cancel‎‏‎‎‏‎");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Pulsa dos veces el botón de encendido para confirmar");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Cancelar");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Esta confirmación proporciona una capa de seguridad adicional a la acción que vas "
               "a realizar.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Pulsa el botón de encendido para confirmar");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Pulsa cualquier botón de volumen para cancelar");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Cancelar");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Confirmación protegida por Android");

    /* Tests for language es-419 */
    ConfirmationUITranslations_select_lang_id("es-419");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Presiona dos veces el botón de encendido para confirmar");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Cancelar");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Esta confirmación proporciona un nivel de seguridad adicional para la acción que "
               "estás por realizar.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Presiona el botón de encendido para confirmar");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Presiona cualquier botón de volumen para cancelar");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Cancelar");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Kinnitamiseks topeltvajutage toitenuppu");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Tühista");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "See kinnitus annab veel ühe turvakihi toimingu puhul, mille nüüd teete.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Kinnitamiseks vajutage toitenuppu");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Tühistamiseks vajutage mis tahes helitugevuse nuppu");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Tühista");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Androidi kaitstud kinnitus");

    /* Tests for language eu */
    ConfirmationUITranslations_select_lang_id("eu");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Berresteko, sakatu birritan pizteko botoia");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Utzi");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Berrespen honek segurtasun handiagoa ematen dizu hurrengo ekintza gauzatzeko.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Berresteko, sakatu etengailua");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Bertan behera uzteko, sakatu bolumen-tekla bat");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Utzi");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Android-en babesa izatearen berrespena");

    /* Tests for language fa */
    ConfirmationUITranslations_select_lang_id("fa");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "برای تأیید، دکمه روشن/خاموش را دوبار فشار دهید");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "لغو");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "این تأیید یک لایه امنیتی اضافی برای کنشی که می‌خواهید "
               "انجام "
               "دهید "
               "فراهم "
               "می‌کند.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "برای تأیید، دکمه روشن/خاموش را فشار دهید");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "برای لغو، یکی از دکمه‌های میزان صدا را فشار "
               "دهید");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "لغو");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "تأیید محافظت‌شده Android");

    /* Tests for language fi */
    ConfirmationUITranslations_select_lang_id("fi");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Vahvista painamalla virtapainiketta kahdesti");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Peruuta");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Tämä vahvistus tarkoittaa, että seuraava toimintosi on entistä paremmin suojattu.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Vahvista painamalla virtapainiketta");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Peruuta painamalla äänenvoimakkuuspainiketta");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Peruuta");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Vahvistus Android-suojauksesta");

    /* Tests for language fil */
    ConfirmationUITranslations_select_lang_id("fil");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Pindutin nang dalawang beses ang power para kumpirmahin");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Kanselahin");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Ang pagkumpirmang ito ay nagbibigay ng karagdagang layer ng seguridad para sa "
               "pagkilos na gagawin mo.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Pindutin ang power para kumpirmahin");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Pindutin ang anumang button ng volume para kanselahin");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Kanselahin");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Pagkumpirmang Pinoprotektahan ng Android");

    /* Tests for language fr */
    ConfirmationUITranslations_select_lang_id("fr");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Appuyez deux fois sur le bouton Marche/Arrêt pour confirmer l'opération");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Annuler");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Cette confirmation ajoute un niveau de sécurité supplémentaire à l'action que vous "
               "êtes sur le point d'effectuer.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Appuyez sur le bouton Marche/Arrêt pour confirmer l'opération");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Appuyez sur l'un des boutons de volume pour annuler l'opération");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Appuyez deux fois sur l'interrupteur pour confirmer");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Annuler");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Cette confirmation fournit une couche supplémentaire de sécurité pour l'action que "
               "vous êtes sur le point d'effectuer.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Appuyez sur l'interrupteur pour confirmer");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Appuyez sur un bouton de volume pour annuler l'action");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Annuler");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Confirmation protégée Android");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Preme o botón de acendido dúas veces para confirmar");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Cancelar");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Esta confirmación proporciona unha capa adicional de seguranza para a acción que "
               "estás a piques de levar a cabo.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Preme o botón de acendido para confirmar");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Preme calquera botón de volume para cancelar");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Cancelar");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Android Protected Confirmation");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "કન્ફર્મ કરવા માટે પાવર પર બે વાર ટૅપ કરો");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "રદ કરો");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "તમે જે ક્રિયા કરવાના છો તેના માટે આ કન્ફર્મેશન એક અતિરિક્ત સુરક્ષાનું સ્તર પ્રદાન કરે છે.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "કન્ફર્મ કરવા માટે પાવર બટન દબાવો");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "રદ કરવા માટે કોઈપણ વૉલ્યૂમનું બટન દબાવો");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "יש ללחוץ פעמיים על לחצן ההפעלה כדי לאשר");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "ביטול");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "אישור זה מספק שכבת אבטחה נוספת לפעולה שאתה עומד לבצע.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "יש ללחוץ על לחצן ההפעלה כדי לאשר");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "יש ללחוץ על לחצן כלשהו של עוצמת הקול כדי לבטל");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "पुष्टि करने के लिए पावर बटन दो बार दबाएं");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "रद्द करें");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "यह पुष्टि मिलने पर आप जो काम करने वाले हैं, उसके लिए सुरक्षा और बढ़ जाती है.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "पुष्टि करने के लिए पावर बटन दबाएं");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "रद्द करने के लिए कोई भी वॉल्यूम बटन दबाएं");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Dvaput pritisnite tipku za uključivanje/isključivanje da biste potvrdili");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Otkaži");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Ta potvrda pruža dodatan sloj zaštite za radnju koju ćete izvršiti.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Pritisnite tipku za uključivanje/isključivanje da biste potvrdili");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Pritisnite bilo koju tipku za glasnoću da biste otkazali");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Otkaži");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Potvrda zaštite na Androidu");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "A megerősítéshez nyomja meg duplán a bekapcsológombot");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Mégse");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Ez a megerősítés extra réteg biztonságot nyújt a végrehajtani kívánt művelet "
               "számára.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Nyomja meg a bekapcsológombot a megerősítéshez");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Nyomja meg valamelyik hangerőgombot az elvetéshez");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Mégse");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Android – védett megerősítés");

    /* Tests for language hy */
    ConfirmationUITranslations_select_lang_id("hy");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Հաստատելու համար կրկնակի սեղմեք սնուցման կոճակը");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Չեղարկել");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Այս հաստատումն ապահովում է պաշտպանության լրացուցիչ մակարդակ՝ նախքան գործողություն "
               "կատարելը");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Հաստատելու համար սեղմեք սնուցման կոճակը");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Չեղարկելու համար սեղմեք ձայնի կագավորման որևէ կոճակ");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Չեղարկել");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Android Protected-ի հաստատում");

    /* Tests for language id */
    ConfirmationUITranslations_select_lang_id("id");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Tekan dua kali tombol power untuk mengonfirmasi");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Batal");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Konfirmasi ini memberikan lapisan keamanan tambahan untuk tindakan yang akan Anda "
               "ambil.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Tekan tombol power untuk mengonfirmasi");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Tekan tombol volume apa saja untuk membatalkan");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Ýttu tvisvar á aflrofann til að staðfesta");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Hætta við");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Þessi staðfesting veitir aukið öryggi fyrir aðgerðina sem þú ert að fara að "
               "framkvæma.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Ýttu á aflrofann til að staðfesta");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Ýttu á hvaða hljóðstyrkshnapp sem er til að hætta við");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Hætta við");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Varin staðfesting Android");

    /* Tests for language it */
    ConfirmationUITranslations_select_lang_id("it");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Premi due volte il tasto di accensione per confermare");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Annulla");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Questa conferma garantisce un ulteriore livello di sicurezza per l'azione che stai "
               "per compiere.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Premi il tasto di accensione per confermare");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Premi qualsiasi pulsante del volume per annullare");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Annulla");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Conferma Android Protected");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "この確認により、これから行う操作のセキュリティが強化されます。");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "確認するには、電源を押します");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "キャンセルするには、いずれかの音量ボタンを押します");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "დასადასტურებლად ორმაგად დააჭირეთ ჩართვის ღილაკს");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "გაუქმება");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "დადასტურება უსაფრთხოების დამატებით შრეს უზრუნველყოფს იმ ქმედების "
               "განსახორციელებლად, რომელსაც აპირებთ.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "დასადასტურებლად დააჭირეთ ჩართვის ღილაკს");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "გასაუქმებლად დააჭირეთ ხმის რეგულირების ნებისმიერ ღილაკს");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "გაუქმება");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Android-ის დაცული დადასტურება");

    /* Tests for language kk */
    ConfirmationUITranslations_select_lang_id("kk");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Растау үшін қуат түймесін екі рет басыңыз");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Бас тарту");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Бұл растау функциясы орындағалы тұрған әрекеттің қауіпсіздігін қосымша күшейтеді.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Растау үшін қуат түймесін басыңыз");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Бас тарту үшін кез келген дыбыс деңгейі түймесін басыңыз");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Бас тарту");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Android қорғалған растау");

    /* Tests for language km */
    ConfirmationUITranslations_select_lang_id("km");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "ចុច​ប៊ូតុង​ថាមពល​ពីរដង​ដើម្បី​បញ្"
               "ជ"
               "ា"
               "ក"
               "់");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "ការបញ្ជាក់នេះ​ផ្ដល់ស្រទាប់​សុវត្ថិភាព​បន្ថែម​សម្រាប់​សកម្មភាព​ដែលអ្នកហៀប​នឹងធ"
               "្"
               "វ"
               "ើ"
               "។");
    ASSERT_STR(
            ConfirmationUITranslations_lookup("2181224373757710937"),
            "ចុច​ប៊ូតុង​ថាមពល​ដើម្បី​បញ្ជ"
            "ា"
            "ក"
            "់");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "ចុចប៊ូតុង​កម្រិតសំឡេង​ណាមួយ​ដើម្បីបោ"
               "ះ"
               "ប"
               "ង"
               "់");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "확인하려면 전원 버튼을 두 번 누르세요.");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "취소");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "이 확인 단계를 사용하면 실행하려는 작업의 보안을 한층 강화할 수 있습니다.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "확인하려면 전원 버튼을 누르세요.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "취소하려면 볼륨 버튼 중 하나를 누르세요.");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Ырастоо үчүн \"Кубат\" баскычын эки жолу басыңыз");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Жокко чыгаруу");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Бул ырастоо сиз аткара турган аракеттин коопсуздугун коргоонун дагы бир катмарын "
               "камсыздайт.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Ырастоо үчүн \"Кубат\" баскычын басыңыз");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Жокко чыгаруу үчүн үн көлөмүнүн баскычтарынын бирин басыңыз");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Жокко чыгаруу");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Android Protected ырастоосу");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "ກົດປຸ່ມປິດເປີດເຄື່ອງສອງຄັ້ງເພື່ອຢືນຢັນ");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "ຍົກເລີກ");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "ການຢືນຢັນນີ້ຈະເພີ່ມຄວາມປອດໄພເພີ່ມເຕີມອີກໜຶ່ງຊັ້ນໃຫ້ກັບຄຳສັ່ງທີ່ທ່ານກຳລັງຈະໃຊ້.");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "ການຢືນຢັນ Android ທີ່ໄດ້ຮັບການປົກປ້ອງ");

    /* Tests for language lt */
    ConfirmationUITranslations_select_lang_id("lt");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Dukart paspauskite maitinimo mygtuką, kad patvirtintumėte");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Atšaukti");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Naudojant šį patvirtinimą, veiksmui, kurį ketinate atlikti, taikomas papildomas "
               "saugos lygmuo.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Paspauskite maitinimo mygtuką, kad patvirtintumėte");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Paspauskite bet kurį garsumo mygtuką, kad atšauktumėte");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Atšaukti");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "„Android Protected“ patvirtinimas");

    /* Tests for language lv */
    ConfirmationUITranslations_select_lang_id("lv");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Lai apstiprinātu, divreiz nospiediet barošanas pogu");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Atcelt");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Šis apstiprinājums sniedz papildu aizsardzību darbībai, kuru veiksiet.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Lai apstiprinātu, nospiediet barošanas pogu");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Lai atceltu, nospiediet jebkuru skaļuma pogu");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Atcelt");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Android aizsargātā informācija");

    /* Tests for language mk */
    ConfirmationUITranslations_select_lang_id("mk");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Притиснете на копчето за напојување двапати за да потврдите");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Откажи");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Оваа потврда обезбедува дополнителен слој на безбедност за дејството што ќе го "
               "преземете.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Притиснете на копчето за напојување за да потврдите");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Притиснете на кое било копче за јачина на звук за да откажете");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Откажи");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Потврда за заштита на Android");

    /* Tests for language ml */
    ConfirmationUITranslations_select_lang_id("ml");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "സ്ഥിരീകരിക്കാൻ പവർ രണ്ടുതവണ അമർത്തുക");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "റദ്ദാക്കുക");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "നിങ്ങൾ സ്വീകരിക്കാൻ പോകുന്ന നടപടിക്കായി, ഈ സ്ഥിരീകരണം ഒരു അധിക സുരക്ഷാ പാളി നൽകുന്നു.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"), "സ്ഥിരീകരിക്കാൻ പവർ അമർത്തുക");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "റദ്ദാക്കാൻ എതെങ്കിലും വോളിയം ബട്ടൺ അമർത്തുക");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "റദ്ദാക്കുക");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Android സംരക്ഷിത സ്ഥിരീകരണം");

    /* Tests for language mn */
    ConfirmationUITranslations_select_lang_id("mn");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Баталгаажуулахын тулд унтраах/асаахыг хоёр удаа дарах");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Болих");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Энэ баталгаажуулалт нь таны авах гэж буй арга хэмжээнд хамгаалалтын нэмэлт "
               "давхаргыг олгодог.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Баталгаажуулахын тулд унтраах/асаахыг дарах");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Болихын тулд дууны түвшний товчлуурын аль нэгийг нь дарах");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Болих");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Андройдоор хамгаалсан баталгаажуулалт");

    /* Tests for language mo */
    ConfirmationUITranslations_select_lang_id("mo");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Apăsați de două ori butonul de pornire pentru a confirma");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Anulați");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Această confirmare oferă un nivel suplimentar de securitate pentru acțiunea pe "
               "care urmează să o faceți.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Apăsați butonul de pornire pentru a confirma");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Apăsați orice buton de volum pentru a anula");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Anulați");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Confirmare protecție pentru Android");

    /* Tests for language mr */
    ConfirmationUITranslations_select_lang_id("mr");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "खात्री करण्‍यासाठी पॉवर बटण "
               "दोनदा "
               "दाबा");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "रद्द करा");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "हे निश्चित झाल्‍यावर, तुम्‍ही जे काम करणार आहात, "
               "त्‍यासाठी "
               "सुरक्षा "
               "आणखी "
               "वाढते.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "निश्चित करण्‍यासाठी पॉवर दाबा");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "रद्द करण्‍यासाठी कोणतेही "
               "व्‍हॉल्‍यूम "
               "बटण "
               "दाबा");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "रद्द करा");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Android कडून सुरक्षा निश्चित करणे");

    /* Tests for language ms */
    ConfirmationUITranslations_select_lang_id("ms");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Tekan dua kali butang kuasa untuk mengesahkan");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Batal");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Pengesahan ini memberikan lapisan keselamatan tambahan untuk tindakan yang akan "
               "anda ambil.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Tekan kuasa untuk mengesahkan");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Tekan sebarang butang kelantangan untuk membatalkan tindakan");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Batal");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Pengesahan Dilindungi Android");

    /* Tests for language my */
    ConfirmationUITranslations_select_lang_id("my");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "အတည်ပြုရန် ပါဝါခလုတ်ကို နှစ်ချက်နှိပ်ပါ");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "မလုပ်တော့");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "ဤအတည်ပြုချက်က သင်ပြုလုပ်တော့မည့် လုပ်ဆောင်ချက်အတွက် အပိုဆောင်းလုံခြုံရေးကို ပေးထားသည်။");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"), "အတည်ပြုရန် ပါဝါခလုတ်နှိပ်ပါ");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "ပယ်ဖျက်ရန် အသံအတိုးအကျယ်ခလုတ် တစ်ခုခုကိုနှိပ်ပါ");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Dobbelttrykk på av/på-knappen for å bekrefte");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Avbryt");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Denne bekreftelsen gir et ekstra sikkerhetslag for handlingen du er i ferd med å "
               "utføre.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Trykk på av/på-knappen for å bekrefte");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Trykk på en volumknapp for å avbryte");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Avbryt");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Android-beskyttet bekreftelse");

    /* Tests for language ne */
    ConfirmationUITranslations_select_lang_id("ne");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "पुष्टि गर्न पावर बटनमा दुई पटक थिच्नुहोस्");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "रद्द गर्नुहोस्");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "यो पुष्टिले तपाईंले गर्न ऑंट्नुभएको कारबाहीका लागि सुरक्षाको अतिरिक्त तह प्रदान गर्छ।");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "पुष्टि गर्न पावर बटनमा थिच्नुहोस्");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "रद्द गर्नका लागि कुनै भोल्युम बटन थिच्नुहोस्");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "रद्द गर्नुहोस्");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Android द्वारा संरक्षण गरिएको पुष्टि");

    /* Tests for language nl */
    ConfirmationUITranslations_select_lang_id("nl");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Druk twee keer op de aan/uit-knop om te bevestigen");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Annuleren");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Deze bevestiging biedt een extra beveiligingslaag voor de actie die je wilt "
               "uitvoeren.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Druk op de aan/uit-knop om te bevestigen");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Druk op een volumeknop om te annuleren");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Annuleren");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Bevestiging van Android-beveiliging");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"),
               "କ୍ୟାନ୍ସଲ୍‍ କରନ୍ତୁ");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "ଏହି ସୁନିଶ୍ଚିତତା, ଆପଣ କରିବାକୁ ଯାଉଥିବା କାର୍ଯ୍ୟ ପାଇଁ ଅତିରିକ୍ତ ସୁରକ୍ଷା ପରତ ପ୍ରଦାନ କରିଥାଏ।");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "ସୁନିଶ୍ଚିତ କରିବା ପାଇଁ ପାୱର୍‌ "
               "ବଟନ୍‌କୁ "
               "ଦାବନ୍ତୁ");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "କ୍ୟାନ୍ସଲ୍ କରିବା ପାଇଁ ଯେକୌଣସି ଭଲ୍ୟୁମ୍ "
               "ବଟନ୍‌କୁ "
               "ଦାବନ୍ତୁ");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"),
               "କ୍ୟାନ୍ସଲ୍‍ କରନ୍ତୁ");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Android ଦ୍ୱାରା ସୁରକ୍ଷିତ ହୋଇଥିବାର ସୁନିଶ୍ଚିତତା");

    /* Tests for language pa */
    ConfirmationUITranslations_select_lang_id("pa");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "ਪੁਸ਼ਟੀ ਕਰਨ ਲਈ ਪਾਵਰ ਬਟਨ ਨੂੰ ਦੋ ਬਾਰ ਦੱਬੋ");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "ਰੱਦ ਕਰੋ");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "ਇਹ ਪੁਸ਼ਟੀਕਰਨ ਤੁਹਾਡੇ ਵੱਲੋਂ ਕਾਰਵਾਈ ਨੂੰ ਕੀਤੇ ਜਾਣ ਲਈ ਸੁਰੱਖਿਆ ਦੇ ਇੱਕ ਵਾਧੂ ਪੱਧਰ ਮੁਹੱਈਆ ਕਰਦੀ ਹੈ।");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "ਪੁਸ਼ਟੀ ਕਰਨ ਲਈ ਪਾਵਰ ਬਟਨ ਦਬਾਓ");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "ਰੱਦ ਕਰਨ ਲਈ ਕਿਸੇ ਵੀ ਵੌਲਿਊਮ ਬਟਨ ਨੂੰ ਦਬਾਓ");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "ਰੱਦ ਕਰੋ");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Android ਵੱਲੋਂ ਸੁਰੱਖਿਆ ਦੀ ਪੁਸ਼ਟੀ");

    /* Tests for language pl */
    ConfirmationUITranslations_select_lang_id("pl");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Kliknij dwukrotnie przycisk zasilania, by potwierdzić");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Anuluj");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "To potwierdzenie stanowi dodatkowe zabezpieczenie czynności, którą zamierzasz "
               "wykonać.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Naciśnij przycisk zasilania, aby potwierdzić");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Naciśnij dowolny przycisk głośności, aby anulować");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Pressione o botão liga/desliga duas vezes para confirmar");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Cancelar");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Essa confirmação oferece uma camada adicional de segurança para a ação que você "
               "está prestes a realizar.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Pressione o botão liga/desliga para confirmar");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Pressione um dos botões de volume para cancelar");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Cancelar");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Prima duas vezes ligar/desligar para confirmar.");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Cancelar");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Esta confirmação oferece um nível extra de segurança para a ação que está prestes "
               "a realizar.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Prima ligar/desligar para confirmar.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Prima qualquer botão de volume para cancelar.");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Cancelar");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Confirmação protegida do Android");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Дополнительный уровень защиты для действия, которое вы собираетесь выполнить.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Для подтверждения нажмите кнопку питания.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Для отмены нажмите на любую кнопку регулировки громкости.");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Отмена");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Подтверждение Android Protected");

    /* Tests for language si */
    ConfirmationUITranslations_select_lang_id("si");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "තහවුරු කිරීමට බල බොත්තම දෙවරක් ඔබන්න");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "අවලංගු කරන්න");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "මෙම තහවුරු කිරිම ඔබ ගැනීමට යන ක්‍රියාමාර්ගය සඳහා ආරක්ෂාව "
               "පිළිබඳ "
               "අමතර "
               "ස්තරයක් "
               "සපයයි.");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "අවලංගු කිරීමට ඕනෑම හඬ පරිමා බොත්තමක් ඔබන්න");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Potvrďte dvojitým stlačením vypínača");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Zrušiť");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Toto potvrdenie zaistí dodatočnú úroveň zabezpečenia akcie, ktorú sa chystáte "
               "vykonať.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Potvrďte stlačením vypínača");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Zrušte stlačením ľubovoľného tlačidla hlasitosti");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Zrušiť");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Chránené potvrdenie Androidu");

    /* Tests for language sl */
    ConfirmationUITranslations_select_lang_id("sl");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Dvakrat pritisnite za potrditev");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Prekliči");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Ta potrditev zagotavlja dodatno plast zaščite za dejanje, ki ga boste izvedli.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Za potrditev pritisnite gumb za vklop");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Za preklic pritisnite poljuben gumb za glasnost");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Prekliči");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Zaščitena potrditev v Androidu");

    /* Tests for language sq */
    ConfirmationUITranslations_select_lang_id("sq");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Shtyp dy herë butonin e energjisë për të konfirmuar");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Anulo");
    ASSERT_STR(
            ConfirmationUITranslations_lookup("217688588483778177"),
            "Konfirmim ofron një shtresë sigurie shtesë për veprimin që je gati për të ndërmarrë.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Shtyp butonin e energjisë për të konfirmuar");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Shtyp çdo buton volumi për ta anuluar");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Двапут притисните дугме за напајање да бисте потврдили");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Откажи");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Ова потврда пружа додатни слој безбедности за радњу коју се спремате да извршите.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Притисните дугме за напајање да бисте потврдили");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Притисните било које дугме за јачину звука да бисте отказали");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Откажи");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Потврда заштите на Android-у");

    /* Tests for language sr-Latn */
    ConfirmationUITranslations_select_lang_id("sr-Latn");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Dvaput pritisnite dugme za napajanje da biste potvrdili");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Otkaži");
    ASSERT_STR(
            ConfirmationUITranslations_lookup("217688588483778177"),
            "Ova potvrda pruža dodatni sloj bezbednosti za radnju koju se spremate da izvršite.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Pritisnite dugme za napajanje da biste potvrdili");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Pritisnite bilo koje dugme za jačinu zvuka da biste otkazali");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Otkaži");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Potvrda zaštite na Android-u");

    /* Tests for language sv */
    ConfirmationUITranslations_select_lang_id("sv");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Bekräfta genom att trycka två gånger på avstängningsknappen");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Avbryt");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Bekräftelsen ger extra skydd för åtgärden du ska vidta.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Bekräfta genom att trycka på strömbrytaren");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Avbryt genom att trycka på valfri volymknapp");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Avbryt");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Bekräftelseskydd för Android");

    /* Tests for language sw */
    ConfirmationUITranslations_select_lang_id("sw");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Bonyeza kitufe cha kuwasha mara mbili ili uthibitishe");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Ghairi");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Uthibitishaji huu hutoa ulinzi zaidi wa usalama kwa hatua unayotaka kuchukua.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Bonyeza kitufe cha kuwasha ili uthibitishe");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Bonyeza kitufe chochote cha sauti ili ughairi");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Ghairi");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Uthibitishaji Unaolindwa wa Android");

    /* Tests for language ta */
    ConfirmationUITranslations_select_lang_id("ta");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "உறுதிப்படுத்த, பவர் பட்டனை இருமுறை அழுத்தவும்");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "ரத்துசெய்");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "நீங்கள் மேற்கொள்ளவிருக்கும் செயலுக்கு, கூடுதல் பாதுகாப்பை இந்த உறுதிப்படுத்தல் வழங்கும்.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "உறுதிப்படுத்த, பவரை அழுத்தவும்");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "ரத்துசெய்ய, ஏதேனும் ஒலியளவு பட்டனை அழுத்தவும்");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "ரத்துசெய்");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Android பாதுகாப்பு தொடர்பான உறுதிப்படுத்தல்");

    /* Tests for language te */
    ConfirmationUITranslations_select_lang_id("te");
    ASSERT_STR(
            ConfirmationUITranslations_lookup("1424834532030812203"),
            "నిర్ధారించడానికి పవర్ బటన్‌ని "
            "రెండు "
            "సార్లు "
            "నొక్కండి");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "రద్దు చేయండి");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "ఈ నిర్ధారణ మీరు తీసుకోబోయే చర్య కోసం అదనపు భద్రతా "
               "లేయర్‌ను "
               "అందిస్తుంది.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "నిర్ధారించడానికి పవర్‌ను "
               "నొక్కండి");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "రద్దు చేయడానికి ఏదైనా వాల్యూమ్ "
               "బటన్‌ను "
               "నొక్కండి");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "การยืนยันนี้จะช่วยเพิ่มความปลอดภัยอีกขั้นสำหรับสิ่งที่คุณกำลังจะดำเนินการ");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Onaylamak için güç düğmesine iki kez basın");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "İptal");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Bu onay, yapmak üzere olduğunuz işlem için ek güvenlik katmanı sağlar.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Onaylamak için güç düğmesine basın");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "İptal etmek için herhangi bir ses düğmesine basın");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Двічі натисніть кнопку живлення, щоб підтвердити");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Скасувати");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Це підтвердження є додатковим рівнем захисту, коли ви збираєтеся виконати дію.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Натисніть кнопку живлення, щоб підтвердити");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Натисніть будь-яку клавішу гучності, щоб скасувати");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Скасувати");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Підтвердження Android Protected");

    /* Tests for language ur */
    ConfirmationUITranslations_select_lang_id("ur");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "تصدیق کرنے کے لئے پاور بٹن دوبار دبائیں");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "منسوخ کریں");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "آپ جو کارروائی کرنے والے ہیں اس کے لئے یہ تصدیق ایک اضافی پرت فراہم کرتی ہے۔");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "تصدیق کرنے کے لئے پاور بٹن دبائیں");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "منسوخ کرنے کے لئے کوئی بھی والیوم بٹن دبائیں");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "منسوخ کریں");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Android کی تحفظ یافتہ تصدیق");

    /* Tests for language uz */
    ConfirmationUITranslations_select_lang_id("uz");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Tasdiqlash uchun quvvat tugmasini ikki marta bosing");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Bekor qilish");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Tasdiqlangandan keyin bajarilayotgan amal uchun qo‘shimcha xavfsizlik qatlami "
               "taqdim etiladi.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Tasdiqlash uchun quvvat tugmasini bosing");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Bekor qilish uchun istalgan tovush tugmasini bosing");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Bekor qilish");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Android Protected nomli tasdiq");

    /* Tests for language vi */
    ConfirmationUITranslations_select_lang_id("vi");
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Nhấn hai lần vào nút nguồn để xác nhận");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Hủy");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Xác nhận này cung cấp thêm một lớp bảo mật cho hành động bạn sắp thực hiện.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Nhấn vào nút nguồn để xác nhận");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Nhấn vào nút âm lượng bất kỳ để hủy");
    ...
    ASSERT_STR(ConfirmationUITranslations_lookup("1424834532030812203"),
               "Cindezela kabili ukuze uqinisekise");
    ASSERT_STR(ConfirmationUITranslations_lookup("1796282799666106567"), "Khansela");
    ASSERT_STR(ConfirmationUITranslations_lookup("217688588483778177"),
               "Lokhu kuqinisekiswa kunikeza isendlalelo esingeziwe sokuvikelwa sesenzo "
               "osuzosithatha.");
    ASSERT_STR(ConfirmationUITranslations_lookup("2181224373757710937"),
               "Cindezela amandla ukuze uqinisekise");
    ASSERT_STR(ConfirmationUITranslations_lookup("2213954494039981979"),
               "Cindezela noma iyiphi inkinobho yevolumu ukuze ukhansele");
    ASSERT_STR(ConfirmationUITranslations_lookup("3999296476990449149"), "Khansela");
    ASSERT_STR(ConfirmationUITranslations_lookup("6973195374358399966"),
               "Ukuqinisekiswa okuvikelwe i-Android");

    /* Check language tag fallback mechanism works
       (chop off components until a match has been found) */
    const char* lang_ids[] = {"de", "da", "da-GL", "es-419", "es-AR", NULL};
