...
interface IConfirmationUI {
     ...
     */
    void promptUserConfirmation(in IConfirmationResultCallback resultCB,
            in @utf8InCpp String promptText, in byte[] extraData,
            in @utf8InCpp String locale, in UIOption[] uiOptions);
}
