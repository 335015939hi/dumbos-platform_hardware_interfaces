...
interface IConfirmationUI {
  ...
  void promptUserConfirmation(in android.hardware.confirmationui.IConfirmationResultCallback resultCB, in @utf8InCpp String promptText, in byte[] extraData, in @utf8InCpp String locale, in android.hardware.confirmationui.UIOption[] uiOptions);
  const int OK = 0;
