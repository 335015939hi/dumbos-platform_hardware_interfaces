...
class ResilientDevice final : public nn::IDevice,
  ...
  public:
    using Factory = std::function<std::shared_ptr<const nn::IDevice>(bool)>;

    static std::shared_ptr<const nn::IDevice> create(Factory makeDevice);
    ...
    std::shared_ptr<const nn::IDevice> getDevice() const;
    std::shared_ptr<const nn::IDevice> recover(const nn::IDevice* failingDevice,
                                               bool blocking) const;
    ...
    nn::GeneralResult<std::shared_ptr<const nn::IPreparedModel>> prepareModel(
            const nn::Model& model, nn::ExecutionPreference preference, nn::Priority priority,
            nn::OptionalTimePoint deadline, const std::vector<nn::SharedHandle>& modelCache,
            const std::vector<nn::SharedHandle>& dataCache,
            const nn::CacheToken& token) const override;

    nn::GeneralResult<std::shared_ptr<const nn::IPreparedModel>> prepareModelFromCache(
            nn::OptionalTimePoint deadline, const std::vector<nn::SharedHandle>& modelCache,
            const std::vector<nn::SharedHandle>& dataCache,
            const nn::CacheToken& token) const override;

    nn::GeneralResult<std::shared_ptr<const nn::IBuffer>> allocate(
  ...
  private:
    nn::GeneralResult<std::shared_ptr<const nn::IPreparedModel>> prepareModelInternal(
    ...
    nn::GeneralResult<std::shared_ptr<const nn::IPreparedModel>> prepareModelFromCacheInternal(
            bool blocking, nn::OptionalTimePoint deadline,
            const std::vector<nn::SharedHandle>& modelCache,
            const std::vector<nn::SharedHandle>& dataCache, const nn::CacheToken& token) const;
    nn::GeneralResult<std::shared_ptr<const nn::IBuffer>> allocateInternal(
    ...
    mutable std::shared_ptr<const nn::IDevice> mDevice GUARDED_BY(mMutex);
};
