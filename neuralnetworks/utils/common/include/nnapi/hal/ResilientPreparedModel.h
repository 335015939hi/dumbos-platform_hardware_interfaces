...
class ResilientPreparedModel final : public nn::IPreparedModel {
  ...
  public:
    using Factory = std::function<std::shared_ptr<const nn::IPreparedModel>(bool)>;

    static std::shared_ptr<const nn::IPreparedModel> create(Factory makePreparedModel);
    ...
    std::shared_ptr<const nn::IPreparedModel> getPreparedModel() const;
    std::shared_ptr<const nn::IPreparedModel> recover(
    ...
    nn::GeneralResult<std::unique_ptr<const nn::IPreparedModel>> configureExecutionBurst(
  ...
  private:
    ...
    mutable std::shared_ptr<const nn::IPreparedModel> mPreparedModel GUARDED_BY(mMutex);
};
