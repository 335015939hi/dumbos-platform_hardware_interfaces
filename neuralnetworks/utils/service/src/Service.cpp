...
using getDeviceFn = std::add_pointer_t<std::shared_ptr<const nn::IDevice>(const std::string&)>;

void getDevicesForVersion(const std::string& descriptor, getDeviceFn getDevice,
                          std::vector<std::shared_ptr<const nn::IDevice>>* devices,
...
std::vector<std::shared_ptr<const nn::IDevice>> getDevicesForVersions() {
    std::vector<std::shared_ptr<const nn::IDevice>> devices;
    std::unordered_set<std::string> registeredDevices;
...
std::vector<std::shared_ptr<const IDevice>> getDevices() {
    return hardware::neuralnetworks::service::getDevicesForVersions();
}
