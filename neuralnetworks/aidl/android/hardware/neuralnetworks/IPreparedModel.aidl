...
interface IPreparedModel {
     ...
     *
     * This method will be called when a user requests a reusable execution with consistent request
     * and execution config. For single-time execution,
     * {@link IPreparedModel::executeSynchronouslyWithConfig} or
     * {@link IPreparedModel::executeFencedWithConfig} will be called, so that the overhead of
     ...
     *
     * This method will be called when a user requests a single-time synchronous execution.
     * For reusable execution with consistent request and execution config,
     * {@link IPreparedModel::createReusableExecution} will be called.
     *
     * @param request The input and output information on which the prepared model is to be
     *                executed.
     * @param config Specifies the execution configuration parameters.
     ...
     *
     * This method will be called when a user requests a single-time fenced execution.
     * For reusable execution with consistent request and execution config,
     * {@link IPreparedModel::createReusableExecution} will be called.
     *
     * @param request The input and output information on which the prepared model is to be
