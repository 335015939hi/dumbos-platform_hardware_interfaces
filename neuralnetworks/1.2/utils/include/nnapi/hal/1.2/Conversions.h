...
GeneralResult<std::vector<Extension>> convert(const hardware::hidl_vec<hal::V1_2::Extension>& extensions);
GeneralResult<std::vector<SharedHandle>> convert(const hardware::hidl_vec<hardware::hidl_handle>& handles);
