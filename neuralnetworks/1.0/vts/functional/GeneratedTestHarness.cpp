...
using PreparedModelCallback_1_0 =
    ::android::hardware::neuralnetworks::V1_0::implementation::PreparedModelCallback;
using PreparedModelCallback_1_1 =
    ::android::hardware::neuralnetworks::V1_1::implementation::PreparedModelCallback;
using PreparedModelCallback_1_2 = PreparedModelCallback_1_1;
...
template <class T_PreparedModel>
void EvaluatePreparedModel(sp<T_PreparedModel>& preparedModel, std::function<bool(int)> is_ignored,
...
void Execute(const sp<V1_0::IDevice>& device, std::function<V1_0::Model(void)> create_model,
    ...
    sp<PreparedModelCallback_1_0> preparedModelCallback = new PreparedModelCallback_1_0();
    ...
    sp<V1_0::IPreparedModel> preparedModel = preparedModelCallback->getPreparedModel();
...
void Execute(const sp<V1_1::IDevice>& device, std::function<V1_1::Model(void)> create_model,
    ...
    // launch prepare model
    sp<PreparedModelCallback_1_1> preparedModelCallback = new PreparedModelCallback_1_1();
    ASSERT_NE(nullptr, preparedModelCallback.get());
    ...
    preparedModelCallback->wait();
    ErrorStatus prepareReturnStatus = preparedModelCallback->getStatus();
    sp<V1_1::IPreparedModel> preparedModel = preparedModelCallback->getPreparedModel();
...
void Execute(const sp<V1_2::IDevice>& device, std::function<V1_2::Model(void)> create_model,
    ...
    // launch prepare model
    sp<PreparedModelCallback_1_2> preparedModelCallback = new PreparedModelCallback_1_2();
    ASSERT_NE(nullptr, preparedModelCallback.get());
