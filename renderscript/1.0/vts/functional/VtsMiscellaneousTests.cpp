...
/*
 * Create a Element and verify the return value is valid.
 *
 * Calls: elementCreate
 */
...
/*
 * Create a Element, a Type and an Allocation of that type, and verify the
...
/*
 * Create a Element, a Type of the Element, and verify the native metadata can
