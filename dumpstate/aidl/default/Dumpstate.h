...
#include <aidl/android/hardware/dumpstate/DumpstateStatus.h>
...
class Dumpstate : public BnDumpstateDevice {
  private:
    ...
    ::aidl::android::hardware::dumpstate::DumpstateStatus dumpstateBoardImpl(const int fd,
                                                                             const bool full);
  ...
  public:
    ::ndk::ScopedAStatus dumpstateBoard(
            ...
            ::aidl::android::hardware::dumpstate::DumpstateStatus* _aidl_return) override;
