...
interface IOemLock {
     ...
     *
     * @return is STATUS_OK if get name successfully.
     * @param out name of the implementation, the length of param should be one.
     */
     ...
     *
     * @return STATUS_OK if the flag was successfully read.
     * @param out allowed is the current state of the flag, the length of param should be one.
     */
    void isOemUnlockAllowedByCarrier(out boolean[] allowed);
     ...
     * @param out allowed is the current state of the flag, the length of param should be one.
     */
    void isOemUnlockAllowedByDevice(out boolean[] allowed);
     ...
     *        required.
     * @return is OK if the flag was successfully updated,
