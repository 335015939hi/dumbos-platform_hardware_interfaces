#ifndef HIDL_GENERATED_android_hardware_boot_control_V1_0_BootControl_H_
#define HIDL_GENERATED_android_hardware_boot_control_V1_0_BootControl_H_
...
struct BootControl : public IBootControl {
    ...
    Return<int32_t> isSlotBootable(uint32_t slot)  override;
    Return<int32_t> isSlotMarkedSuccessful(uint32_t slot)  override;
...
#endif  // HIDL_GENERATED_android_hardware_boot_control_V1_0_BootControl_H_
