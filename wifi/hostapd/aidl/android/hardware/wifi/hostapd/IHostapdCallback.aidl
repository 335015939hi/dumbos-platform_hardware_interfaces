...
interface IHostapdCallback {
     ...
     */
    oneway void onApInstanceInfoChanged(in String ifaceName, in String apIfaceInstance,
            in int freqMhz, in Bandwidth bandwidth, in Generation generation,
            in byte[] apIfaceInstanceMacAddress);
     ...
     * disconnected.
     */
    oneway void onConnectedClientsChanged(in String ifaceName, in String apIfaceInstance,
            in byte[] clientAddress, in boolean isConnected);
