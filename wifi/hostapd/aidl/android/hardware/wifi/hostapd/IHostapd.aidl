...
import android.hardware.wifi.hostapd.HostapdStatus;
...
interface IHostapd {
     ...
     */
    HostapdStatus addAccessPoint(in IfaceParams ifaceParams, in NetworkParams nwParams);
     ...
     */
    HostapdStatus forceClientDisconnect(
     ...
     *     |HostapdStatusCode.FAILURE_UNKNOWN|
     */
    HostapdStatus registerCallback(in IHostapdCallback callback);
     ...
     *         |HostapdStatusCode.FAILURE_IFACE_UNKNOWN|
     */
    HostapdStatus removeAccessPoint(in String ifaceName);
     ...
     *         |HostapdStatusCode.FAILURE_UNKNOWN|
     */
    HostapdStatus setDebugParams(in DebugLevel level);
