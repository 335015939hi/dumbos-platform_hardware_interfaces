...
void startHostapdAndWaitForHidlService(const std::string& instance_name) {
    initilializeDriverAndFirmware(instance_name);
    ...
    ASSERT_TRUE(notification_listener->waitForHidlService(200, instance_name));
}
