...
bool findIfaceToSupportIfaceType(sp<ISupplicant> supplicant,
                                 IfaceType type,
...
sp<ISupplicantStaIface> getSupplicantStaIface() {
  ...
  if (!findIfaceToSupportIfaceType(supplicant, IfaceType::STA, &info)) {
    return nullptr;
  }
  bool operation_failed = false;
...
sp<ISupplicantP2pIface> getSupplicantP2pIface() {
  ...
  ISupplicant::IfaceInfo info;
  if (!findIfaceToSupportIfaceType(supplicant, IfaceType::P2P, &info)) {
    return nullptr;
  }
  bool operation_failed = false;
