...
<<<<<<< TARGET BRANCH (14c7a4 [automerger skipped] Merge "wifi: Added capability check in )
        // Stop Wi-Fi
...
=======
    ...
    virtual void TearDown() override {
        ...
        // Start Framework
        std::system("/system/bin/start");
>>>>>>> SOURCE BRANCH (ec2350 Merge "wifi: wait for the framework to be ready before check)
    }
