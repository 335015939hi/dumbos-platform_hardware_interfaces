...
interface ISupplicantP2pIfaceCallback {
  ...
  oneway void onGroupRemoved(in String groupIfname, in boolean isGo);
  oneway void onGroupStarted(in String groupIfname, in boolean isGo, in byte[] ssid, in int frequency, in byte[] psk, in String passphrase, in byte[] goDeviceAddress, in boolean isPersistent);
