...
class SupplicantStaNetworkHidlTest
   ...
   public:
    virtual void SetUp() override {
        ...
        wifi_v1_1_instance_name_ = std::get<1>(GetParam());
        supplicant_v1_0_instance_name_ = std::get<2>(GetParam());
        supplicant_v1_1_instance_name_ = std::get<3>(GetParam());
        isP2pOn_ =
            testing::deviceSupportsFeature("android.hardware.wifi.direct");
        startSupplicantAndWaitForHidlService(wifi_v1_0_instance_name_,
                                             supplicant_v1_0_instance_name_);
        supplicant_ =
            getSupplicant_1_1(supplicant_v1_0_instance_name_, isP2pOn_);
   ...
   protected:
    ...
    std::string wifi_v1_1_instance_name_;
    std::string supplicant_v1_0_instance_name_;
...
INSTANTIATE_TEST_CASE_P(
    ...
    testing::Combine(
        ...
        testing::ValuesIn(android::hardware::getAllHalInstanceNames(
            android::hardware::wifi::V1_1::IWifi::descriptor)),
        testing::ValuesIn(android::hardware::getAllHalInstanceNames(
        ...
        testing::ValuesIn(android::hardware::getAllHalInstanceNames(
            android::hardware::wifi::supplicant::V1_1::ISupplicant::
                descriptor))),
    [](const testing::TestParamInfo<SupplicantStaNetworkHidlTest::ParamType>
           &info) {
        return "Wifi_" + android::hardware::Sanitize(std::get<0>(info.param)) +
               "_Supplicant_" +
               android::hardware::Sanitize(std::get<2>(info.param));
    });