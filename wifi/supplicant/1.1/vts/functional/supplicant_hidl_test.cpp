...
<<<<<<< TARGET BRANCH (110dc0 Merge "Revert "wifi: remove wifi instance name string check")
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(SupplicantHidlTest);
=======
>>>>>>> SOURCE BRANCH (f9a770 Merge "supplicant(vts): Stop adding empty instance for vendo)
