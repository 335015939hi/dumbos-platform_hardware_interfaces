...
$(GEN): PRIVATE_DEPS += $(LOCAL_PATH)/IWifiRttResponder.hal
$(GEN): $(LOCAL_PATH)/IWifiRttResponder.hal
...
#
# Build IWifiRttResponder.hal
#
GEN := $(intermediates)/android/hardware/wifi/1.0/IWifiRttResponder.java
$(GEN): $(HIDL)
$(GEN): PRIVATE_HIDL := $(HIDL)
$(GEN): PRIVATE_DEPS := $(LOCAL_PATH)/IWifiRttResponder.hal
$(GEN): PRIVATE_DEPS += $(LOCAL_PATH)/IWifiIface.hal
...
$(GEN): PRIVATE_CUSTOM_TOOL = \
        $(PRIVATE_HIDL) -o $(PRIVATE_OUTPUT_DIR) \
        -Ljava -randroid.hardware:hardware/interfaces \
        android.hardware.wifi@1.0::IWifiRttResponder
