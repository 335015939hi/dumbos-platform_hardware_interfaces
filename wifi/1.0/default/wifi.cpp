...
Return<void> Wifi::start(start_cb hidl_status_cb) {
  return hidl_return_util::validateAndCall0(this,
                                            WifiStatusCode::ERROR_UNKNOWN,
                                            &Wifi::startInternal,
                                            hidl_status_cb);
}
...
Return<void> Wifi::getChipIds(getChipIds_cb hidl_status_cb) {
  return hidl_return_util::validateAndCall1(this,
                                            WifiStatusCode::ERROR_UNKNOWN,
...
std::pair<WifiStatus, sp<IWifiChip>> Wifi::getChipInternal(ChipId chip_id) {
  if (!chip_.get()) {
    return std::make_pair(createWifiStatus(WifiStatusCode::ERROR_NOT_STARTED),
                          nullptr);
  }
  if (chip_id != kChipId) {
  ...
  return std::make_pair(createWifiStatus(WifiStatusCode::SUCCESS), chip_);
}
}  // namespace implementation
}  // namespace V1_0
}  // namespace wifi
