...
Return<void> WifiStaIface::enableRoaming(bool enable,
                                         enableRoaming_cb hidl_status_cb) {
  return validateAndCall(this,
                         WifiStatusCode::ERROR_WIFI_IFACE_INVALID,
                         &WifiStaIface::enableRoamingInternal,
                         hidl_status_cb,
                         enable);
}
...
WifiStatus WifiStaIface::enableRoamingInternal(bool enable) {
  legacy_hal::wifi_error legacy_status =
