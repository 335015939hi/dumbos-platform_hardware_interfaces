...
WifiStatus WifiStaIface::installApfPacketFilterInternal(
    uint32_t /* cmdId */, const hidl_vec<uint8_t>& /* program */) {
  // TODO implement
  return createWifiStatus(WifiStatusCode::SUCCESS);
}
...
WifiStaIface::getValidFrequenciesForBackgroundScanInternal(
  ...
  // TODO implement
  return std::make_pair(createWifiStatus(WifiStatusCode::SUCCESS),
                        std::vector<WifiChannelInMhz>());
}

WifiStatus WifiStaIface::startBackgroundScanInternal(
    uint32_t /* cmdId */, const StaBackgroundScanParameters& /* params */) {
  // TODO implement
  return createWifiStatus(WifiStatusCode::SUCCESS);
}

WifiStatus WifiStaIface::stopBackgroundScanInternal(uint32_t /* cmdId */) {
  // TODO implement
  return createWifiStatus(WifiStatusCode::SUCCESS);
}
...
WifiStaIface::getDebugTxPacketFatesInternal() {
  // TODO implement
  return std::make_pair(createWifiStatus(WifiStatusCode::SUCCESS),
                        std::vector<WifiDebugTxPacketFateReport>());
}
...
WifiStaIface::getDebugRxPacketFatesInternal() {
  // TODO implement
  return std::make_pair(createWifiStatus(WifiStatusCode::SUCCESS),
                        std::vector<WifiDebugRxPacketFateReport>());
}
