...
Return<void> WifiChip::getId(getId_cb hidl_status_cb) {
  if (!is_valid_) {
    HIDL_RETURN1(WifiStatusCode::ERROR_WIFI_CHIP_INVALID, UINT32_MAX);
  }
  HIDL_RETURN1(WifiStatusCode::SUCCESS, chip_id_);
}
...
Return<void> WifiChip::registerEventCallback(
  ...
  if (!is_valid_) {
    HIDL_RETURN0(WifiStatusCode::ERROR_WIFI_CHIP_INVALID);
  }
...
Return<void> WifiChip::getCapabilities(getCapabilities_cb hidl_status_cb) {
  if (!is_valid_) {
    HIDL_RETURN1(WifiStatusCode::ERROR_WIFI_CHIP_INVALID, 0);
  }
...
Return<void> WifiChip::getAvailableModes(getAvailableModes_cb hidl_status_cb) {
  if (!is_valid_) {
    HIDL_RETURN1(WifiStatusCode::ERROR_WIFI_CHIP_INVALID, hidl_vec<ChipMode>());
  }
  // TODO: add implementation
  HIDL_RETURN1(WifiStatusCode::SUCCESS, hidl_vec<ChipMode>());
}
...
Return<void> WifiChip::requestChipDebugInfo(
  ...
  if (!is_valid_) {
    HIDL_RETURN1(WifiStatusCode::ERROR_WIFI_CHIP_INVALID,
  ...
  if (legacy_status != legacy_hal::WIFI_SUCCESS) {
    ...
    HIDL_RETURN1_FROM_LEGACY_ERROR(
  ...
  HIDL_RETURN1(WifiStatusCode::SUCCESS, result);
}

Return<void> WifiChip::requestDriverDebugDump(
    requestDriverDebugDump_cb hidl_status_cb) {
  if (!is_valid_) {
    HIDL_RETURN1(WifiStatusCode::ERROR_WIFI_CHIP_INVALID, hidl_vec<uint8_t>());
  }
  ...
  if (legacy_status != legacy_hal::WIFI_SUCCESS) {
    LOG(ERROR) << "Failed to get driver debug dump: "
               << legacyErrorToString(legacy_status);
    HIDL_RETURN1_FROM_LEGACY_ERROR(legacy_status, hidl_vec<uint8_t>());
  }

  hidl_vec<uint8_t> hidl_data;
  hidl_data.setToExternal(reinterpret_cast<uint8_t*>(driver_dump.data()),
                          driver_dump.size());
  HIDL_RETURN1(WifiStatusCode::SUCCESS, hidl_data);
}
...
Return<void> WifiChip::createApIface(createApIface_cb hidl_status_cb) {
  if (!is_valid_) {
    HIDL_RETURN1(WifiStatusCode::ERROR_WIFI_CHIP_INVALID, nullptr);
  }

  // TODO(b/31997422): Disallow this based on the chip combination.
  std::string ifname = legacy_hal_.lock()->getApIfaceName();
  ap_iface_ = new WifiApIface(ifname, legacy_hal_);
  HIDL_RETURN1(WifiStatusCode::SUCCESS, ap_iface_)
}
...
Return<void> WifiChip::getApIfaceNames(getApIfaceNames_cb hidl_status_cb) {
  ...
  HIDL_RETURN1(WifiStatusCode::SUCCESS, createHidlVecOfIfaceNames(ifname));
}
...
Return<void> WifiChip::getApIface(const hidl_string& ifname,
  ...
  if (ap_iface_.get() &&
    ...
    HIDL_RETURN1(WifiStatusCode::ERROR_INVALID_ARGS, nullptr);
  }
}
...
Return<void> WifiChip::createNanIface(createNanIface_cb hidl_status_cb) {
  ...
  HIDL_RETURN1(WifiStatusCode::SUCCESS, nan_iface_);
}
...
Return<void> WifiChip::createP2pIface(createP2pIface_cb hidl_status_cb) {
  ...
  HIDL_RETURN1(WifiStatusCode::SUCCESS, p2p_iface_);
}
...
Return<void> WifiChip::createStaIface(createStaIface_cb hidl_status_cb) {
  ...
  HIDL_RETURN1(WifiStatusCode::SUCCESS, sta_iface_);
}
...
Return<void> WifiChip::createRttController(
  ...
  HIDL_RETURN1(WifiStatusCode::SUCCESS, rtt);
}
...
Return<void> WifiChip::getDebugRingBuffersStatus(
  ...
  // TODO: add implementation
  HIDL_RETURN1(WifiStatusCode::SUCCESS, hidl_vec<WifiDebugRingBufferStatus>());
}
...
Return<void> WifiChip::getDebugHostWakeReasonStats(
  ...
  // TODO: add implementation
  HIDL_RETURN1(WifiStatusCode::SUCCESS, WifiDebugHostWakeReasonStats());
}
