...
const IWifiChip::ChipIfaceCombinationLimit kStaChipIfaceCombinationLimit1 = {
    {IfaceType::STA}, 1
};
const IWifiChip::ChipIfaceCombinationLimit kStaChipIfaceCombinationLimit2 = {
    {IfaceType::P2P, IfaceType::NAN}, 1
};
const IWifiChip::ChipIfaceCombination kStaChipIfaceCombination = {
    {kStaChipIfaceCombinationLimit1, kStaChipIfaceCombinationLimit2}
};
const IWifiChip::ChipMode kStaChipMode = {
  kStaChipModeId, {kStaChipIfaceCombination}
};
...
const IWifiChip::ChipMode kApChipMode = {
  kApChipModeId, {kApChipIfaceCombination}
};
...
WifiStatus WifiChip::configureChipInternal(uint32_t mode_id) {
  ...
  // the legacy HAL and then start if after firmware mode change.
  if (current_mode_id_ != kInvalidModeId) {
    invalidateAndRemoveAllIfaces();
    wifi_error legacy_status = legacy_hal_.lock()->stop([]() {});
  ...
  wifi_error legacy_status = legacy_hal_.lock()->start();
  if (legacy_status != WIFI_SUCCESS) {
