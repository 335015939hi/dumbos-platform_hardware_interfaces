...
std::pair<WifiStatus, ChipId> WifiChip::getIdInternal() {
  return std::make_pair(createWifiStatus(WifiStatusCode::SUCCESS), chip_id_);
}
...
WifiChip::requestChipDebugInfoInternal() {
  ...
  return std::make_pair(createWifiStatus(WifiStatusCode::SUCCESS), result);
}
...
WifiChip::requestDriverDebugDumpInternal() {
  ...
  if (legacy_status != WIFI_SUCCESS) {
    LOG(ERROR) << "Failed to get driver debug dump: "
               << legacyErrorToString(legacy_status);
    return std::make_pair(createWifiStatusFromLegacyError(legacy_status),
                          std::vector<uint8_t>());
  }
  return std::make_pair(createWifiStatus(WifiStatusCode::SUCCESS), driver_dump);
}
...
std::pair<WifiStatus, sp<IWifiApIface>> WifiChip::createApIfaceInternal() {
  ...
  return std::make_pair(createWifiStatus(WifiStatusCode::SUCCESS), ap_iface_);
}
...
WifiChip::getApIfaceNamesInternal() {
  if (!ap_iface_.get()) {
    return std::make_pair(createWifiStatus(WifiStatusCode::SUCCESS),
                          std::vector<hidl_string>{});
  }
  return std::make_pair(
      createWifiStatus(WifiStatusCode::SUCCESS),
      std::vector<hidl_string>{legacy_hal_.lock()->getApIfaceName()});
}
...
std::pair<WifiStatus, sp<IWifiApIface>> WifiChip::getApIfaceInternal(
  ...
  if (!ap_iface_.get() ||
    ...
    return std::make_pair(createWifiStatus(WifiStatusCode::ERROR_INVALID_ARGS),
                          nullptr);
  }
  return std::make_pair(createWifiStatus(WifiStatusCode::SUCCESS), ap_iface_);
}
...
std::pair<WifiStatus, sp<IWifiNanIface>> WifiChip::createNanIfaceInternal() {
  ...
  return std::make_pair(createWifiStatus(WifiStatusCode::SUCCESS), nan_iface_);
}
...
WifiChip::getNanIfaceNamesInternal() {
  ...
  return std::make_pair(
      createWifiStatus(WifiStatusCode::SUCCESS),
      std::vector<hidl_string>{legacy_hal_.lock()->getNanIfaceName()});
}
...
std::pair<WifiStatus, sp<IWifiP2pIface>> WifiChip::createP2pIfaceInternal() {
  ...
  return std::make_pair(createWifiStatus(WifiStatusCode::SUCCESS), p2p_iface_);
}
...
WifiChip::getP2pIfaceNamesInternal() {
  ...
  return std::make_pair(
      createWifiStatus(WifiStatusCode::SUCCESS),
      std::vector<hidl_string>{legacy_hal_.lock()->getP2pIfaceName()});
}
...
std::pair<WifiStatus, sp<IWifiStaIface>> WifiChip::createStaIfaceInternal() {
  ...
  return std::make_pair(createWifiStatus(WifiStatusCode::SUCCESS), sta_iface_);
}
...
WifiChip::getStaIfaceNamesInternal() {
  ...
  return std::make_pair(
      createWifiStatus(WifiStatusCode::SUCCESS),
      std::vector<hidl_string>{legacy_hal_.lock()->getStaIfaceName()});
}
