...
Return<void> WifiRttController::getBoundIface(getBoundIface_cb hidl_status_cb) {
  if (!is_valid_) {
    HIDL_RETURN1_WITH_CB(WifiStatusCode::ERROR_WIFI_RTT_CONTROLLER_INVALID,
                         nullptr);
  }
  HIDL_RETURN1_WITH_CB(WifiStatusCode::SUCCESS, bound_iface_);
}
...
Return<void> WifiRttController::registerEventCallback(
  ...
  if (!is_valid_) {
    HIDL_RETURN0_WITH_CB(WifiStatusCode::ERROR_WIFI_RTT_CONTROLLER_INVALID);
  }
...
Return<void> WifiRttController::getCapabilities(
  ...
  // TODO: add implementation
  HIDL_RETURN1_WITH_CB(WifiStatusCode::SUCCESS, RttCapabilities());
}
...
Return<void> WifiRttController::getDebugInfo(getDebugInfo_cb hidl_status_cb) {
  ...
  // TODO: add implementation
  HIDL_RETURN1_WITH_CB(WifiStatusCode::SUCCESS, RttDebugInfo());
}
...
Return<void> WifiRttController::getResponderInfo(
  ...
  // TODO: add implementation
  HIDL_RETURN1_WITH_CB(WifiStatusCode::SUCCESS, RttResponder());
}
