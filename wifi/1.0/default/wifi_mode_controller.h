...
class WifiModeController {
 public:
  ...
  // The Wifi HAL starts up with root permissions to be able to access the
  // firmware image paths. This method takes up ownership of the firmware image
  // paths and then drops root permissions of the HAL process.
  bool initializeAndDropPriviliges();
