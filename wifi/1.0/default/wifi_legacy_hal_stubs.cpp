...
wifi_error wifi_get_supported_channels_stub(wifi_handle handle,
                                            int* size,
                                            wifi_channel* list) {
  return WIFI_ERROR_UNINITIALIZED;
}
...
wifi_error wifi_get_ifaces_stub(wifi_handle handle,
                                int* num_ifaces,
                                wifi_interface_handle** ifaces) {
  return WIFI_ERROR_UNINITIALIZED;
}

wifi_error wifi_get_iface_name_stub(wifi_interface_handle iface,
                                    char* name,
                                    size_t size) {
  return WIFI_ERROR_UNINITIALIZED;
}
...
wifi_error wifi_set_epno_list_stub(int id,
                                   wifi_interface_info* iface,
...
wifi_error wifi_enable_tdls_stub(wifi_interface_handle iface,
                                 mac_addr addr,
...
wifi_error wifi_get_tdls_status_stub(wifi_interface_handle iface,
                                     mac_addr addr,
