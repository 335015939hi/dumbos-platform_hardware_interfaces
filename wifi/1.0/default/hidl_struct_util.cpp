...
bool convertHidlNanEnableRequestToLegacy(
  ...
  if (hidl_request.operateInBand.size() != 2) {
    LOG(ERROR) << "convertHidlNanEnableRequestToLegacy: operateInBand.size() != 2";
    return false;
  }
  ...
  if (hidl_request.debugConfigs.discoveryChannelMhzVal.size() != 2) {
    LOG(ERROR) << "convertHidlNanEnableRequestToLegacy: discoveryChannelMhzVal.size() != 2";
    return false;
  }
  ...
  if (hidl_request.debugConfigs.useBeaconsInBandVal.size() != 2) {
    LOG(ERROR) << "convertHidlNanEnableRequestToLegacy: useBeaconsInBandVal.size() != 2";
    return false;
  }
  ...
  if (hidl_request.debugConfigs.useSdfInBandVal.size() != 2) {
    LOG(ERROR) << "convertHidlNanEnableRequestToLegacy: useSdfInBandVal.size() != 2";
    return false;
  }
...
bool convertHidlNanConfigRequestToLegacy(
  ...
  legacy_request->ranging_auto_response_cfg = hidl_request.acceptRangingRequests ?
       legacy_hal::NAN_RANGING_AUTO_RESPONSE_ENABLE : legacy_hal::NAN_RANGING_AUTO_RESPONSE_DISABLE;
  if (hidl_request.bandSpecificConfig.size() != 2) {
    LOG(ERROR) << "convertHidlNanConfigRequestToLegacy: bandSpecificConfig.size() != 2";
    return false;
  }
  /* TODO : missing
  legacy_request->config_2dot4g_rssi_close = 1;
...
bool convertHidlNanDataPathInitiatorRequestToLegacy(
  ...
  if (!legacy_request) {
    LOG(ERROR) << "convertHidlNanDataPathInitiatorRequestToLegacy: legacy_request too large";
    return false;
  }
