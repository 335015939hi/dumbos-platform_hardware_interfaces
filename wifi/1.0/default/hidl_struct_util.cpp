...
bool convertHidlNanEnableRequestToLegacy(
  ...
  legacy_request->sid_beacon_val = hidl_request.configParams.serviceIdBeaconSpec;
...
bool convertHidlNanPublishRequestToLegacy(
  ...
  legacy_request->recv_indication_cfg = hidl_request.baseConfigs.recvIndicationCfg;
...
bool convertHidlNanTransmitFollowupRequestToLegacy(
  ...
  memcpy(legacy_request->service_specific_info,
        ...
        legacy_request->service_specific_info_len);
  legacy_request->recv_indication_cfg = hidl_request.disableFollowupResultIndication ? 1 : 0;
