...
bool convertHidlNanPublishRequestToLegacy(
  ...
  *legacy_request = {};
  ...
  if (hidl_request.baseConfigs.securityConfigOfNdp == NanDataPathSecurityConfig::PMK) {
  ...
  if (hidl_request.baseConfigs.securityConfigOfNdp == NanDataPathSecurityConfig::PASSPHRASE) {
  ...
  legacy_request->sdea_params.security_cfg = (hidl_request.baseConfigs.securityConfigOfNdp
        != NanDataPathSecurityConfig::OPEN) ? legacy_hal::NAN_DP_CONFIG_SECURITY
...
bool convertHidlNanDataPathInitiatorRequestToLegacy(
  ...
  *legacy_request = {};
  ...
  legacy_request->ndp_cfg.security_cfg = (hidl_request.securityConfig
        != NanDataPathSecurityConfig::OPEN) ? legacy_hal::NAN_DP_CONFIG_SECURITY
            : legacy_hal::NAN_DP_CONFIG_NO_SECURITY;
  ...
  if (hidl_request.securityConfig == NanDataPathSecurityConfig::PMK) {
    legacy_request->key_info.key_type = legacy_hal::NAN_SECURITY_KEY_INPUT_PMK;
  ...
  if (hidl_request.securityConfig == NanDataPathSecurityConfig::PASSPHRASE) {
    legacy_request->key_info.key_type = legacy_hal::NAN_SECURITY_KEY_INPUT_PASSPHRASE;
    legacy_request->key_info.body.passphrase_info.passphrase_len =
