...
#define HIDL_RETURN0_DESC(status_code, status_description)                 \
  ({                                                                       \
...
#define HIDL_RETURN0_NODESC(status_code) HIDL_RETURN0_DESC(status_code, "");

#define HIDL_RETURN0(...)                                                  \
  GET_MACRO_OVERLOAD0(__VA_ARGS__, HIDL_RETURN0_DESC, HIDL_RETURN0_NODESC) \
  (__VA_ARGS__)

// HIDL method with no return values and status description from legacy error
// code.
#define HIDL_RETURN0_DESC_FROM_LEGACY_ERROR(legacy_status_code,              \
                                            status_description)              \
  ({                                                                         \
...
// code.
#define HIDL_RETURN0_NODESC_FROM_LEGACY_ERROR(legacy_status_code) \
  HIDL_RETURN0_DESC_FROM_LEGACY_ERROR(legacy_status_code, "");

#define HIDL_RETURN0_FROM_LEGACY_ERROR(...)                  \
  GET_MACRO_OVERLOAD0(__VA_ARGS__,                           \
                      HIDL_RETURN0_DESC_FROM_LEGACY_ERROR,   \
                      HIDL_RETURN0_NODESC_FROM_LEGACY_ERROR) \
  (__VA_ARGS__)
...
#define HIDL_RETURN1_DESC(status_code, status_description, ret_value)      \
  ({                                                                       \
    WifiStatus status = createWifiStatus(status_code, status_description); \
...
#define HIDL_RETURN1_NODESC(status_code, ret_value) \
  HIDL_RETURN1_DESC(status_code, "", ret_value);

#define HIDL_RETURN1(...)                                                  \
  GET_MACRO_OVERLOAD1(__VA_ARGS__, HIDL_RETURN1_DESC, HIDL_RETURN1_NODESC) \
  (__VA_ARGS__)

// HIDL method with 1 return value and status description from legacy error
// code.
#define HIDL_RETURN1_DESC_FROM_LEGACY_ERROR(                                 \
...
// code.
#define HIDL_RETURN1_NODESC_FROM_LEGACY_ERROR(legacy_status_code, ret_value) \
  HIDL_RETURN1_DESC_FROM_LEGACY_ERROR(legacy_status_code, "", ret_value);

#define HIDL_RETURN1_FROM_LEGACY_ERROR(...)                  \
  GET_MACRO_OVERLOAD1(__VA_ARGS__,                           \
                      HIDL_RETURN1_DESC_FROM_LEGACY_ERROR,   \
                      HIDL_RETURN1_NODESC_FROM_LEGACY_ERROR) \
  (__VA_ARGS__)
