...
void ValidateAndCall0(ObjT* obj,
                      const WifiStatusCode& status_code_if_invalid,
                      WorkFuncT&& work,
...
void ValidateAndCall1(const WifiStatus& result_if_invalid,
                      ObjT* obj,
                      WorkFuncT&& work,
...
template <typename ObjT,
          ...
          typename ReturnT2,
          typename... Args>
void ValidateAndCall2(
    const WifiStatus& result_if_invalid,
    ObjT* obj,
    WorkFuncT&& work,
