...
TEST_F(WifiNanIfaceHidlTest, getCapabilitiesRequest) {
  ...
  EXPECT_GT(capabilities.maxServiceNameLen, (unsigned int) 0);
  EXPECT_GT(capabilities.maxMatchFilterLen, (unsigned int) 0);
  EXPECT_GT(capabilities.maxTotalMatchFilterLen, (unsigned int) 0);
  EXPECT_GT(capabilities.maxServiceSpecificInfoLen, (unsigned int) 0);
  EXPECT_GT(capabilities.maxExtendedServiceSpecificInfoLen, (unsigned int) 0);
