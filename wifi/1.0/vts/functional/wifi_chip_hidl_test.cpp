...
/*
 * CreateApIface
 * Configures the chip in AP mode and ensures that atleast 1 iface creation
 * succeeds.
 */
...
/*
 * CreateNanIface
 * Configures the chip in NAN mode and ensures that atleast 1 iface creation
 * succeeds.
 */
...
/*
 * CreateP2pIface
 * Configures the chip in P2P mode and ensures that atleast 1 iface creation
 * succeeds.
 */
...
/*
 * CreateStaIface
 * Configures the chip in STA mode and ensures that atleast 1 iface creation
 * succeeds.
 */
