...
import android.hardware.gnss.gnss_assistance.BeiduoAlmanac;
...
parcelable GnssAssistance {
     ...
     * TODO: BeidouAssistance is the same as GpsAssistance, can we reuse GpsAssistance?
     */
    @VintfStability
    parcelable BeidouAssistance {

        /** The Beidou almanac. */
        BeiduoAlmanac almanac;
        ...
        /**
         * GNSS corrections specific to Beidou satellites.
         */
        @VintfStability
        parcelable BeidouSatelliteCorrections {
            /** Satellite PRN */
            int prn;

            /** Beidou Signal corrections */
            DgnssSignalCorrection[] signalCorrections;
        }

        /** The array of Beidou satellite corrections. */
        BeidouSatelliteCorrections[] satelliteCorrections;
    }
