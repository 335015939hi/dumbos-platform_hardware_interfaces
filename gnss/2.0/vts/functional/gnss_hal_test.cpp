...
<<<<<<< TARGET BRANCH (b45948 [automerger skipped] Disable tests for TSTS issue am: 8cdbb7)
                                                     kFirstGnssLocationTimeoutSeconds));
=======
                                                 kFirstGnssLocationTimeoutSeconds));


>>>>>>> SOURCE BRANCH (40b07e Merge "Make GetLocationLowPower test warning instead of fail)
