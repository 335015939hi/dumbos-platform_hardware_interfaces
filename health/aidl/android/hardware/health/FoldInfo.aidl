...
parcelable FoldInfo {
    /**
     * number of foldable hinges on device
     */
    int foldCount;
    /**
     ...
     */
    int getNumTimesFolded(long fold);
    /**
     * returns the expected lifespan of a given hinge in units of number of folds
     */
    int getExpectedFoldLifespan(long fold);
    /**
     * version string
     */
    String version;
