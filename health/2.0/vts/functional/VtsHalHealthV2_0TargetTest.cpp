...
// Error if GTEST_SKIP is not implemented
#ifndef GTEST_SKIP
#error GTEST_SKIP is not defined
#endif
...
// has succeed once.
static constexpr auto gBatteryTestTimeout = 3s;  // FIXME
...
// FIXME check connected vs status.
