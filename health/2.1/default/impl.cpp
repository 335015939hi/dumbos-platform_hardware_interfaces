...
// The passthrough implementation is only allowed in recovery mode.
...
extern "C" IHealth* HIDL_FETCH_IHealth(const char* instance) {
    ...
    // instance.
    static sp<Health> default_instance = new Health(instance);
    static BinderHealthLoop loop{default_instance.get()};
    // Start the background thread once.
    static std::thread background{&BinderHealthLoop::StartLoop, &loop};
