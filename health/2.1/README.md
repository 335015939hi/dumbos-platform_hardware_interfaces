...
## `device/<manufacturer>/<device>/health/impl.cpp` {#impl_cpp}
...
## `device/<manufacturer>/<device>/health/MyHealth.h` {#myhealth_h}
...
* `healthd_board_init()` / `@1.0::IHealth.init()` should be called before
  ...
  `HIDL_FETCH_IHealth` in [`impl.cpp`](#impl_cpp).
...
/vendor/lib(64)?/hw/android\.hardware\.health@2\.1-impl-<device> u:object_r:same_process_hal_file:s0
