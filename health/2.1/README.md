...
* If you have implemented `healthd_board_init()` and/or
  ...
  see [the section above](#Upgrading-with-a-customized-libhealthd-or-from-Health-HAL-1.0)
...
* If you have implemented `get_storage_info()` and/or `get_disk_stats()`
  ...
  `MyHealth::getHealthInfo` or `MyHealth::getHealthInfo_2_1`.

# Update necessary SELinux permissions

```
# device/<manufacturer>/<device>/sepolicy/vendor/file_contexts
/vendor/bin/hw/android\.hardware\.health@2\.1-service\.<device> u:object_r:hal_health_default_exec:s0
