...
<<<<<<< TARGET BRANCH (35f07a [automerger skipped] Skip slot 2 for other radio modules in )
...
>>>>>>> SOURCE BRANCH (0638fc Merge "VTS: fix some logic errors for tuner HAL vts [1/1]" i)
        if (!result) {
