...
interface IEArc {
     ...
     */
    const int RESULT_UNKNOWN_FAILURE = 1;
     ...
     * framework.
     * @return {@code RESULT_SUCCESS} if the setting could be changed to the value passed.
     *         {@code RESULT_FAILURE_NOT_SUPPORTED} if the setting is not supported.
     *         {@code RESULT_FAILURE_INVALID_ARGS} if the setting value is invalid.
     *         {@code RESULT_FAILURE_UNKNOWN} if there was an unknown failure.
     */
    int setEArcEnabled(in boolean enabled);
