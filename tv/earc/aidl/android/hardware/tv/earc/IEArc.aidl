...
import android.hardware.tv.earc.IEArcConnectionStatus;
...
interface IEArc {
    ...
    /**
     * Getter for the current eARC connection state of a port.
     *
     * @param portId The port ID for which the connection state is to be reported.
     * @return The connection status of the port.
     */
    IEArcConnectionStatus getConnectionState(in int portId);
