...
struct HdmiCecMock : public IHdmiCec, public hidl_death_recipient {
  ...
  private:
    ...
    hidl_vec<CecLogicalAddress> logical_addresses;
    int32_t cec_version = 0;
    uint32_t cec_vendor_id = 0;
    // Port configuration
    int total_ports = 4;
    // CEC Option value
    int option_wakeup = 0;
    int option_enable_cec = 0;
    int option_system_cec_control = 0;
    int option_language = 0;
};
}  // namespace implementation
}  // namespace V1_0
}  // namespace cec
