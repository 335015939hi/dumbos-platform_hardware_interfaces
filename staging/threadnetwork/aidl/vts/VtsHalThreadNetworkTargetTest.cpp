<<<<<<< TARGET BRANCH (320ef2 Merge "audio: Reduce the interval between BT proxy registrat)
=======
/*
...
>>>>>>> SOURCE BRANCH (1dc848 Bypass Thread HAL SendSpinelFrame test on TV devices)
