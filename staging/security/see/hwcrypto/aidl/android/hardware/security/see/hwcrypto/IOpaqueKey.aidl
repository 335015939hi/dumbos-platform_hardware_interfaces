...
interface IOpaqueKey {
     ...
     *                     this operation. Notice that because by default a buffer is unprotected if
     *                     a protection ID has not been set, it is illegal to call this function
     *                     using a protectionId equal to
     *                     <code>ProtectionId::UNPROTECTED_BUFFER</code>.
     *
     * @protectionId:
