...
interface IHwCryptoKey {
    ...
    parcelable DiceCurrentBoundKeyResult {
         ...
         * opaque from this service perspective (it will be send to an Authentication Manager
         ...
         * with the caveat that it could be encrypted if the client do not have enough permissions
    ...
    /*
     * deriveCurrentDicePolicyBoundKey() - Derives a versioned key tied to the caller current DICE
