...
interface IHwCryptoKey {
     ...
     *
     * SHARED_HMAC_KEY:
     *      This is the shared HMAC key that will be now computed by HwCryptoKey after participating
     *      in the ISharedSecret protocol that can be shared with authenticators and KeyMint. See
