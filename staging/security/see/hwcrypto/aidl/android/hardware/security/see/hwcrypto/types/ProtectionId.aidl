...
enum ProtectionId {
    /*
     * ProtectionID used to represent an unprotected memory buffer.
     */
    UNPROTECTED_BUFFER,
    /*
     * ProtectionID used for Widevine video buffers. These buffers should not be readable by
     * non-trusted entities.
     */
    SECURE_VIDEO_BUFFER,
}
