...
interface IHwCryptoDeviceKeyAccess {
    parcelable DerivedKeyParameters {
        ...
        /*
         * Indicates the desired key size. It is only used when deriving a clear key, on which case
         * the function call will fail if a <code>keySize</code> is not provided.
         */
