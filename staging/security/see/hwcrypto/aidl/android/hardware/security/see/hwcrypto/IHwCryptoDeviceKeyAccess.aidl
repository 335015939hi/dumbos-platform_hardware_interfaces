...
interface IHwCryptoDeviceKeyAccess {
    parcelable DerivedKeyParameters {
         ...
         * used, this function will return the most recent policy as part of the result, but if the
         * policy is current, a NULL will be returned as the policy  on the return value.
