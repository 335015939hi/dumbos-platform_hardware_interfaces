 ...
 * and is valid until a <code>CryptoOperation::Finish</code> is issued using the token. Additionaly
 * the token is used to map a memory buffer using the parameters of
