...
interface IHwCryptoDeviceKeyAccess {
  ...
  union DerivedKeyPolicy {
    ...
    android.hardware.security.see.hwcrypto.IHwCryptoDeviceKeyAccess.ClearKeyPolicy clearKey;
  }
  parcelable DerivedKeyParameters {
    boolean batchKey = false;
    android.hardware.security.see.hwcrypto.IHwCryptoDeviceKeyAccess.DerivedKeyPolicy keyPolicy;
