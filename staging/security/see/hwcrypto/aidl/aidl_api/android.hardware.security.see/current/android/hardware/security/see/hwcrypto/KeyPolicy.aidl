...
parcelable KeyPolicy {
  android.hardware.security.see.hwcrypto.types.KeyUse usage = android.hardware.security.see.hwcrypto.types.KeyUse.UNSPECIFIED;
  ...
  android.hardware.security.see.hwcrypto.types.EvictReason[] evictPolicy;
  ...
  android.hardware.security.see.hwcrypto.types.KeyDomain owner;
  android.hardware.security.see.hwcrypto.types.KeyDomain[] authorizedDomains;
}
