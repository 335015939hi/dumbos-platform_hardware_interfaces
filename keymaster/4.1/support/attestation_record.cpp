...
typedef struct km_key_description {
    ...
    ASN1_ENUMERATED* certification_level;
} KM_KEY_DESCRIPTION;
...
ASN1_SEQUENCE(KM_KEY_DESCRIPTION) = {
        ...
        ASN1_SIMPLE(KM_KEY_DESCRIPTION, certification_level, ASN1_ENUMERATED),
...
ErrorCode parse_attestation_record(const uint8_t* asn1_key_desc, size_t asn1_key_desc_len,
    ...
    *certification_level =
            static_cast<CertificationLevel>(ASN1_ENUMERATED_get(record->certification_level));
