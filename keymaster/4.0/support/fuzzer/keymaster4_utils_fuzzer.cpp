...
void KeyMaster4UtilsFuzzer::invokeKeyMasterUtils() {
    ...
    size_t size = mFdp->ConsumeIntegralInRange<size_t>(0, kMaxVectorSize);
    ...
    HardwareAuthToken authToken = support::hidlVec2AuthToken(toHidlVec(dataVector));
    hidl_vec<uint8_t> hidlVector = support::authToken2HidlVec(authToken);
}
