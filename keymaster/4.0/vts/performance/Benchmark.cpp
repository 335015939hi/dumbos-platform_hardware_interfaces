...
class KeymasterWrapper {
  ...
  public:
    ...
    optional<string> Encrypt(const string& message, AuthorizationSet& in_params,
                             AuthorizationSet* out_params = new AuthorizationSet) {
        return ProcessMessage(KeyPurpose::ENCRYPT, message, in_params, out_params);
    }

    optional<string> Decrypt(const string& message, AuthorizationSet& in_params,
                             AuthorizationSet* out_params = new AuthorizationSet) {
        return ProcessMessage(KeyPurpose::DECRYPT, message, in_params, out_params);
    }

    optional<string> Sign(const string& message, AuthorizationSet& in_params,
                          AuthorizationSet* out_params = new AuthorizationSet) {
        return ProcessMessage(KeyPurpose::SIGN, message, in_params, out_params);
    }

    optional<string> Verify(const string& message, const string& signature,
                            AuthorizationSet& in_params,
                            AuthorizationSet* out_params = new AuthorizationSet) {
        return ProcessMessage(KeyPurpose::VERIFY, message, in_params, out_params, signature);
    }

    optional<string> ProcessMessage(KeyPurpose operation, const string& message,
...
#define BENCHMARK_KM_SIGNATURE_ALL_RSA_KEYS(transform) \
    BENCHMARK_KM_SIGNATURE_ALL_MSGS(transform, 512)    \
    BENCHMARK_KM_SIGNATURE_ALL_MSGS(transform, 768)    \
    BENCHMARK_KM_SIGNATURE_ALL_MSGS(transform, 1024)   \
    BENCHMARK_KM_SIGNATURE_ALL_MSGS(transform, 2048)   \
    BENCHMARK_KM_SIGNATURE_ALL_MSGS(transform, 3072)   \
    BENCHMARK_KM_SIGNATURE_ALL_MSGS(transform, 4096)

BENCHMARK_KM_SIGNATURE_ALL_RSA_KEYS(MD5withRSA/PKCS1);
BENCHMARK_KM_SIGNATURE_ALL_RSA_KEYS(SHA1withRSA/PKCS1);
BENCHMARK_KM_SIGNATURE_ALL_RSA_KEYS(SHA224withRSA/PKCS1);

// 512 bit keys are too small for this transform
BENCHMARK_KM_SIGNATURE_ALL_MSGS(SHA384withRSA/PKCS1, 768);
BENCHMARK_KM_SIGNATURE_ALL_MSGS(SHA384withRSA/PKCS1, 1024);
BENCHMARK_KM_SIGNATURE_ALL_MSGS(SHA384withRSA/PKCS1, 2048);
BENCHMARK_KM_SIGNATURE_ALL_MSGS(SHA384withRSA/PKCS1, 3072);
BENCHMARK_KM_SIGNATURE_ALL_MSGS(SHA384withRSA/PKCS1, 4096);

// 512 bit keys are too small for this transform
BENCHMARK_KM_SIGNATURE_ALL_MSGS(SHA512withRSA/PKCS1, 768);
BENCHMARK_KM_SIGNATURE_ALL_MSGS(SHA512withRSA/PKCS1, 1024);
BENCHMARK_KM_SIGNATURE_ALL_MSGS(SHA512withRSA/PKCS1, 2048);
BENCHMARK_KM_SIGNATURE_ALL_MSGS(SHA512withRSA/PKCS1, 3072);
BENCHMARK_KM_SIGNATURE_ALL_MSGS(SHA512withRSA/PKCS1, 4096);
...
// 512 and 768 bit keys are too small for this transform
BENCHMARK_KM_SIGNATURE_ALL_MSGS(SHA384withRSA/PSS, 1024);
BENCHMARK_KM_SIGNATURE_ALL_MSGS(SHA384withRSA/PSS, 2048);
BENCHMARK_KM_SIGNATURE_ALL_MSGS(SHA384withRSA/PSS, 3072);
BENCHMARK_KM_SIGNATURE_ALL_MSGS(SHA384withRSA/PSS, 4096);

// 512, 768, 1024 bit keys are too small for this transform
BENCHMARK_KM_SIGNATURE_ALL_MSGS(SHA512withRSA/PSS, 2048);
BENCHMARK_KM_SIGNATURE_ALL_MSGS(SHA512withRSA/PSS, 3072);
BENCHMARK_KM_SIGNATURE_ALL_MSGS(SHA512withRSA/PSS, 4096);
// clang-format on
...
#define BENCHMARK_KM_CIPHER_ALL_AES_KEYS(transform) \
    ...
    BENCHMARK_KM_CIPHER_ALL_MSGS(transform, 192)    \
...
#define BENCHMARK_KM_CIPHER_ALL_RSA_KEYS(transform, msgSize) \
    BENCHMARK_KM_CIPHER(transform, 1024, msgSize)            \
...
// RSA/ECB/OAEPPadding
BENCHMARK_KM_CIPHER_ALL_RSA_KEYS(RSAwithMD5/ECB/OAEPPadding, SMALL_MESSAGE_SIZE);
BENCHMARK_KM_CIPHER_ALL_RSA_KEYS(RSAwithSHA1/ECB/OAEPPadding, SMALL_MESSAGE_SIZE);
BENCHMARK_KM_CIPHER_ALL_RSA_KEYS(RSAwithSHA224/ECB/OAEPPadding, SMALL_MESSAGE_SIZE);

BENCHMARK_KM_CIPHER(RSAwithSHA256/ECB/OAEPPadding, 2048, SMALL_MESSAGE_SIZE);
BENCHMARK_KM_CIPHER(RSAwithSHA256/ECB/OAEPPadding, 3072, SMALL_MESSAGE_SIZE);
BENCHMARK_KM_CIPHER(RSAwithSHA256/ECB/OAEPPadding, 4096, SMALL_MESSAGE_SIZE);

BENCHMARK_KM_CIPHER(RSAwithSHA384/ECB/OAEPPadding, 2048, SMALL_MESSAGE_SIZE);
BENCHMARK_KM_CIPHER(RSAwithSHA384/ECB/OAEPPadding, 3072, SMALL_MESSAGE_SIZE);
BENCHMARK_KM_CIPHER(RSAwithSHA384/ECB/OAEPPadding, 4096, SMALL_MESSAGE_SIZE);

BENCHMARK_KM_CIPHER(RSAwithSHA512/ECB/OAEPPadding, 2048, SMALL_MESSAGE_SIZE);
BENCHMARK_KM_CIPHER(RSAwithSHA512/ECB/OAEPPadding, 3072, SMALL_MESSAGE_SIZE);
BENCHMARK_KM_CIPHER(RSAwithSHA512/ECB/OAEPPadding, 4096, SMALL_MESSAGE_SIZE);

BENCHMARK_KM_CIPHER_ALL_RSA_KEYS(RSAwithMD5/ECB/OAEPPadding, MEDIUM_MESSAGE_SIZE);
BENCHMARK_KM_CIPHER_ALL_RSA_KEYS(RSAwithSHA1/ECB/OAEPPadding, MEDIUM_MESSAGE_SIZE);
BENCHMARK_KM_CIPHER_ALL_RSA_KEYS(RSAwithSHA224/ECB/OAEPPadding, MEDIUM_MESSAGE_SIZE);
BENCHMARK_KM_CIPHER_ALL_RSA_KEYS(RSAwithSHA256/ECB/OAEPPadding, MEDIUM_MESSAGE_SIZE);
BENCHMARK_KM_CIPHER_ALL_RSA_KEYS(RSAwithSHA384/ECB/OAEPPadding, MEDIUM_MESSAGE_SIZE);
BENCHMARK_KM_CIPHER_ALL_RSA_KEYS(RSAwithSHA512/ECB/OAEPPadding, MEDIUM_MESSAGE_SIZE);

BENCHMARK_KM_CIPHER_ALL_RSA_KEYS(RSAwithSHA1/ECB/OAEPPadding, LARGE_MESSAGE_SIZE);
// clang-format on
