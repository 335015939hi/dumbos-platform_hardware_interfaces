...
BENCHMARK_KM_SIGNATURE_ALL_RSA_KEYS(SHA384withRSA / PKCS1)
BENCHMARK_KM_SIGNATURE_ALL_RSA_KEYS(SHA512withRSA / PKCS1);
...
BENCHMARK_KM_CIPHER_ALL_RSA_KEYS(RSAwithSHA256 / ECB / OAEPPadding, SMALL_MESSAGE_SIZE);
BENCHMARK_KM_CIPHER_ALL_RSA_KEYS(RSAwithSHA384 / ECB / OAEPPadding, SMALL_MESSAGE_SIZE);
BENCHMARK_KM_CIPHER_ALL_RSA_KEYS(RSAwithSHA512 / ECB / OAEPPadding, SMALL_MESSAGE_SIZE);
