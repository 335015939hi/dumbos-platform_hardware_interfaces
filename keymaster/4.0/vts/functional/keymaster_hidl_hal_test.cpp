...
bool verify_attestation_record(const string& challenge, const string& app_id,
    ...
    string empty_unique_id("0000000000000000");
    EXPECT_EQ(0, memcmp(att_unique_id.data(), empty_unique_id.data(), att_unique_id.size()));
    ...
    std::string empty_boot_key("00000000000000000000000000000000");
