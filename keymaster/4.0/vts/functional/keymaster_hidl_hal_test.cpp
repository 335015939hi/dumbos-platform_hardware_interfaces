...
void get_unique_id(const hidl_vec<uint8_t>& attestation_cert, HidlBuf& unique_id) {
...
TEST_P(AttestationTest, EcAttestationUniqueIdTimeRotation) {
    ASSERT_EQ(ErrorCode::OK,
              GenerateKey(AuthorizationSetBuilder()
                                  ...
                                  .EcdsaSigningKey(EcCurve::P_256)
                                  .Digest(Digest::SHA_2_256)
                                  .Authorization(TAG_CREATION_DATETIME, 1576484079000)
                                  .Authorization(TAG_INCLUDE_UNIQUE_ID)));
    ...
    get_unique_id(cert_chain[0], unique_id_first);
    DeleteKey(false);
    ...
    ASSERT_EQ(ErrorCode::OK,
              GenerateKey(AuthorizationSetBuilder()
                                  ...
                                  .EcdsaSigningKey(EcCurve::P_256)
                                  .Digest(Digest::SHA_2_256)
                                  .Authorization(TAG_CREATION_DATETIME, 1579076079000)
                                  .Authorization(TAG_INCLUDE_UNIQUE_ID)));
    ...
    get_unique_id(cert_chain[0], unique_id_second);
...
TEST_P(AttestationTest, EcAttestationUniqueIdMatch) {
    ...
    ASSERT_EQ(ErrorCode::OK,
              GenerateKey(AuthorizationSetBuilder()
                                  ...
                                  .EcdsaSigningKey(EcCurve::P_256)
                                  .Digest(Digest::SHA_2_256)
                                  .Authorization(TAG_CREATION_DATETIME, 1576484099000)
                                  .Authorization(TAG_INCLUDE_UNIQUE_ID)));
...
TEST_P(AttestationTest, EcAttestationUniqueIdFactoryReset) {
    ...
    get_unique_id(cert_chain[0], unique_id_reset);
