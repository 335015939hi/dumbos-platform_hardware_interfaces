...
bool verify_attestation_record(const string& challenge, const string& app_id,
    ...
    const uint8_t empty_unique_id[17] = "0000000000000000";
    EXPECT_EQ(att_unique_id.data(), empty_unique_id);
    ...
    // encoding.
    if (expected_hw_enforced.Contains(TAG_NO_AUTH_REQUIRED)) {
    ...
    EXPECT_EQ(verified_boot_hash.data(), (unsigned char*)property_value);
    ...
    const uint8_t empty_boot_key[33] = "00000000000000000000000000000000";
    ...
    if (!strcmp(property_value, "green")) {
        ...
        EXPECT_NE(verified_boot_key.data(), empty_boot_key);
        ...
        EXPECT_EQ(verified_boot_key.data(), empty_boot_key);
