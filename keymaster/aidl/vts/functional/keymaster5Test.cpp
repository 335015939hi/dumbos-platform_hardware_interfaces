...
TEST_P(SigningOperationsTest, RsaGetKeyCharacteristicsRequiresCorrectAppIdAppData) {
    ...
    ASSERT_EQ(ErrorCode::OK, GenerateKey(AuthorizationSetBuilder()
                                         ...
                                         &key_blob, &key_characteristics));
    CheckGetCharacteristics(key_blob, "clientid", 8, "appdata", 7, &key_characteristics);
}
...
TEST_P(VerificationOperationsTest, HmacSigningKeyCannotVerify) {
    ...
    EXPECT_EQ(ErrorCode::INCOMPATIBLE_PURPOSE,
              Begin(KeyPurpose::VERIFY, signing_key,
                    AuthorizationSetBuilder().Digest(Digest::SHA_2_256), &out_params, &op_handle_));
...
TEST_P(AddEntropyTest, AddEntropy) {
    EXPECT_EQ(ErrorCode::OK, keymaster().addRngEntropy("foo", 3));
}
