...
bool verify_attestation_record(const string& challenge, const string& app_id,
    ...
    EXPECT_GE(att_keymaster_version, 5U);
...
class NewKeyGenerationTest : public KeymasterAidlTestBase {
  protected:
...
typedef KeymasterAidlTestBase SigningOperationsTest;
...
typedef KeymasterAidlTestBase VerificationOperationsTest;
...
typedef KeymasterAidlTestBase ExportKeyTest;
...
class ImportKeyTest : public KeymasterAidlTestBase {
  public:
    template <TagType tag_type, Tag tag, typename ValueT>
...
class ImportWrappedKeyTest : public KeymasterAidlTestBase {};
...
typedef KeymasterAidlTestBase EncryptionOperationsTest;
...
typedef KeymasterAidlTestBase MaxOperationsTest;
...
typedef KeymasterAidlTestBase AddEntropyTest;
...
typedef KeymasterAidlTestBase AttestationTest;
#endif
...
typedef KeymasterAidlTestBase KeyDeletionTest;
...
using UpgradeKeyTest = KeymasterAidlTestBase;
...
using ClearOperationsTest = KeymasterAidlTestBase;
...
typedef KeymasterAidlTestBase TransportLimitTest;
