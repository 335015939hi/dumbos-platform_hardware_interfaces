...
#include <android/hardware/keymaster/5.0/IKeymasterDevice.h>
#include <android/hardware/keymaster/5.0/IKeymasterOperation.h>
#include <android/hardware/keymaster/5.0/types.h>
#include <gtest/gtest.h>

#include <keymasterV5_0/authorization_set.h>
...
class KeymasterAidlTestUtil : public ::testing::TestWithParam<std::string> {
  public:
    void SetUp() override;
    ...
    ErrorCode ExportKey(KeyFormat format, const vector<uint8_t>& key_blob,
                        const vector<uint8_t>& client_id, const vector<uint8_t>& app_data,
                        vector<uint8_t>* key_material);
    ErrorCode ExportKey(KeyFormat format, vector<uint8_t>* key_material);
    ...
    void CheckGetCharacteristics(const vector<uint8_t>& key_blob, const vector<uint8_t>& client_id,
                                 ...
                                 KeyCharacteristics* key_characteristics);
    ErrorCode GetCharacteristics(const vector<uint8_t>& key_blob, const vector<uint8_t>& client_id,
                                 const vector<uint8_t>& app_data,
                                 KeyCharacteristics* key_characteristics);
    ...
    ErrorCode AttestKey(const vector<uint8_t>& key_blob, const AuthorizationSet& attest_params,
                        vector<vector<uint8_t>>* cert_chain);
    ErrorCode AttestKey(const AuthorizationSet& attest_params, vector<vector<uint8_t>>* cert_chain);
