...
import android.hardware.keymaster.TagType;

// TODO(seleneh) : note aidl currently does not support double nested enum definations such as
// ROOT_OF_TRUST = (9 << 28) | 704.  So we are forced to write definations as XXX = (2 << 28) | 1
// for now.  Will need to flip this back later when aidl support is added.
...
enum Tag {
     ...
     * Must be hardware-enforced.
     */
    BLOB_USAGE_REQUIREMENTS = (1 << 28) | 301,
     ...
     */
    ROLLBACK_RESISTANCE = (7 << 28) | 303,

    // Reserved for future use.
    HARDWARE_TYPE = (1 << 28) | 304,
     ...
     */
    ACTIVE_DATETIME = (6 << 28) | 400, /* Start of validity. */
     ...
     * Need not be hardware-enforced.
     */
    ORIGINATION_EXPIRE_DATETIME = (6 << 28) | 401,
     ...
     * Need not be hardware-enforced.
     */
    USAGE_EXPIRE_DATETIME = (6 << 28) | 402,
     ...
     * Must be hardware-enforced.
     */
    MIN_SECONDS_BETWEEN_OPS = (3 << 28) | 403,
     ...
     * Must be hardware-enforced.
     */
    USER_SECURE_ID = (4 << 28) | 502, /* Secure ID of authorized user or authenticator(s).
     ...
     * Must be hardware-enforced.
     */
    NO_AUTH_REQUIRED = (7 << 28) | 503, /* If key is usable without authentication. */
     ...
     * Must be hardware-enforced.
     */
    TRUSTED_USER_PRESENCE_REQUIRED = (7 << 28) | 507,
     ...
     * Must be hardware-enforced.
     */
    TRUSTED_CONFIRMATION_REQUIRED = (7 << 28) | 508,
     ...
     */
    UNLOCKED_DEVICE_REQUIRED = (7 << 28) | 509,
     ...
     * Must never appear in KeyCharacteristics.
     */
    ATTESTATION_CHALLENGE = (9 << 28) | 708, /* Used to provide challenge in attestation */
     ...
     * Cannot be hardware-enforced.
     */
    ATTESTATION_APPLICATION_ID = (9 << 28) | 709,
     ...
     * Must never appear in KeyCharacteristics.
     */
    ATTESTATION_ID_DEVICE = (9 << 28) | 711,
     ...
     * Must never appear in KeyCharacteristics.
     */
    ATTESTATION_ID_PRODUCT = (9 << 28) | 712,
     ...
     * Must never appear in KeyCharacteristics.
     */
    ATTESTATION_ID_SERIAL = (9 << 28) | 713,
     ...
     * Must never appear in KeyCharacteristics.
     */
    ATTESTATION_ID_IMEI = (9 << 28) | 714, /* Used to provide the device's IMEI to be included
                                                  * in attestation */
     ...
     * Must never appear in KeyCharacteristics.
     */
    ATTESTATION_ID_MEID = (9 << 28) | 715, /* Used to provide the device's MEID to be included
                                                  * in attestation */
     ...
     * Must never appear in KeyCharacteristics.
     */
    ATTESTATION_ID_MANUFACTURER = (9 << 28) | 716,
     ...
     */
    DEVICE_UNIQUE_ATTESTATION = (7 << 28) | 720,
     ...
     */
    IDENTITY_CREDENTIAL_KEY = (7 << 28) | 721,
     ...
     * Must never appear in KeyCharacteristics.
     */
    RESET_SINCE_ID_ROTATION = (7 << 28) | 1004,
