...
import android.hardware.identity.KeymasterCapability;
import android.hardware.identity.KeyParameter;
import android.hardware.identity.VerificationToken;
...
interface IKeymasterOperation {
     ...
     */
    void update(in KeyParameter[] inParams, in byte[] input, in KeymasterCapability inCapability,
                in VerificationToken inVerificationToken, out int inputConsumed,
                out KeyParameter[] outParams, byte[] output);
    ...
    void finish(in KeyParameter[] inParams, in byte[] input, in byte[] inSignature,
                in KeymasterCapability inCapability, in VerificationToken inVerificationToken,
                out KeyParameter[] outParams, byte[] output);
