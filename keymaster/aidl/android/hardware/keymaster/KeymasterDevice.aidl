...
import android.hardware.identity.IKeymasterOperation;
import android.hardware.identity.KeyCharacteristics;
import android.hardware.identity.KeyFormat;
import android.hardware.identity.KeymasterCapability;
import android.hardware.identity.KeymasterOperation;
...
@VintfStability interface IKeymasterDevice {
     ...
     */
    void getHardwareInfo(out SecurityLevel securityLevel, out string keymasterName,
     ...
     */
    byte[][] attestKey(in byte[] keyToAttest, in KeyParameter[] attestParams);
