...
interface IKeymasterDevice {
  ...
  android.hardware.keymaster.KeyCharacteristics getKeyCharacteristics(in byte[] inKeyBlob, in byte[] inClientId, in byte[] inAppData);
  byte[] exportKey(in android.hardware.keymaster.KeyFormat inKeyFormat, in byte[] inKeyBlob, in byte[] inClientId, in byte[] inAppData);
  android.hardware.keymaster.Certificate[] attestKey(in byte[] inKeyToAttest, in android.hardware.keymaster.KeyParameter[] inAttestParams);
