...
#ifndef HARDWARE_INTERFACES_KEYMASTER_SUPPORT_INCLUDE_KEYMASTER_TAGS_H_
#define HARDWARE_INTERFACES_KEYMASTER_SUPPORT_INCLUDE_KEYMASTER_TAGS_H_
...
using android::hardware::keymaster::KeyParameter;
using android::hardware::keymaster::Tag;
using android::hardware::keymaster::TagType;
...
/*  TODO(seleneh) change this back when aidl supports union
 *
...
/* TODO(seleneh) change this back when union support for aidl is added
 *
MAKE_TAG_ENUM_VALUE_ACCESSOR(TAG_ALGORITHM, integer)
MAKE_TAG_ENUM_VALUE_ACCESSOR(TAG_BLOB_USAGE_REQUIREMENTS, integer)
MAKE_TAG_ENUM_VALUE_ACCESSOR(TAG_BLOCK_MODE, integer)
MAKE_TAG_ENUM_VALUE_ACCESSOR(TAG_DIGEST, integer)
MAKE_TAG_ENUM_VALUE_ACCESSOR(TAG_EC_CURVE, integer)
MAKE_TAG_ENUM_VALUE_ACCESSOR(TAG_ORIGIN, integer)
MAKE_TAG_ENUM_VALUE_ACCESSOR(TAG_PADDING, integer)
MAKE_TAG_ENUM_VALUE_ACCESSOR(TAG_PURPOSE, integer)
MAKE_TAG_ENUM_VALUE_ACCESSOR(TAG_USER_AUTH_TYPE, integer)
MAKE_TAG_ENUM_VALUE_ACCESSOR(TAG_HARDWARE_TYPE, integer)
*/

MAKE_TAG_ENUM_VALUE_ACCESSOR(TAG_ALGORITHM, integer, Algorithm)
MAKE_TAG_ENUM_VALUE_ACCESSOR(TAG_BLOB_USAGE_REQUIREMENTS, integer, KeyBlobUsageRequirements)
...
// TODO(seleneh) aidl generates KeyParameter operator<, >, ==, != for cpp translation but not ndk
// translations.  We might need to add in our own function later if we use ndk
// or the KeyParameter is defined such that the aidl generated operator does not
// do the right job.

}  // namespace android::hardware::keymaster

#endif  // HARDWARE_INTERFACES_KEYMASTER_SUPPORT_INCLUDE_KEYMASTER_TAGS_H_
