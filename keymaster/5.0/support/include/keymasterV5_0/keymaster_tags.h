...
#include <aidl/android/hardware/keymaster/KeyParameter.h>
#include <aidl/android/hardware/keymaster/Tag.h>
#include <aidl/android/hardware/keymaster/TagType.h>

namespace aidl::android::hardware::keymaster {

using ::aidl::android::hardware::keymaster::KeyParameter;
using ::aidl::android::hardware::keymaster::Tag;
using ::aidl::android::hardware::keymaster::TagType;
