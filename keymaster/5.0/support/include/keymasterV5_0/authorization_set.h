...
#include <aidl/android/hardware/keymaster/EcCurve.h>
#include <aidl/android/hardware/keymaster/PaddingMode.h>

#include <keymasterV5_0/keymaster_tags.h>
...
using ::aidl::android::hardware::keymaster::BlockMode;
using ::aidl::android::hardware::keymaster::Digest;
using ::aidl::android::hardware::keymaster::EcCurve;
using ::aidl::android::hardware::keymaster::PaddingMode;
