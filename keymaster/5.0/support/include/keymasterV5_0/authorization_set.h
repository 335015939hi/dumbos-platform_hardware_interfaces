...
using android::hardware::keymaster::BlockMode;
using android::hardware::keymaster::Digest;
using android::hardware::keymaster::EcCurve;
using android::hardware::keymaster::PaddingMode;
