...
#include <aidl/android/hardware/keymaster/ErrorCode.h>
#include <aidl/android/hardware/keymaster/IKeymasterDevice.h>
...
using ::aidl::android::hardware::keymaster::TAG_ALGORITHM;
...
std::tuple<ErrorCode, AttestationRecord> parse_attestation_record(const std::vector<uint8_t>& cert);
