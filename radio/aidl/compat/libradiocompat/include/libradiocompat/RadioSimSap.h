...
class RadioSimSap : public aidl::android::hardware::radio::sim::BnSap {
    ...
    ::ndk::ScopedAStatus apduReq(int32_t token,
                                 aidl::android::hardware::radio::sim::SapApduType type,
    ...
    ::ndk::ScopedAStatus setTransferProtocolReq(
            int32_t token,
            aidl::android::hardware::radio::sim::SapTransferProtocol transferProtocol) override;
