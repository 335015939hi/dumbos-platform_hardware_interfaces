...
static_assert(aidl::android::hardware::radio::DataCallFailCause::MISSING_UKNOWN_APN ==
              static_cast<aidl::android::hardware::radio::DataCallFailCause>(
...
static_assert(aidl::android::hardware::radio::DataCallFailCause::VSNCP_APN_UNATHORIZED ==
              static_cast<aidl::android::hardware::radio::DataCallFailCause>(
...
__attribute__((warn_unused_result)) bool translate(
    ...
    out->precedence = static_cast<int8_t>(in.precedence);
    {
        ...
        aidl::android::hardware::radio::RouteSelectionDescriptorParams
                routeSelectionDescriptorParams;
        for (size_t i = 0; i < size; i++) {
...
__attribute__((warn_unused_result)) bool translate(
        ...
        aidl::android::hardware::radio::RouteSelectionDescriptorParams* out) {
