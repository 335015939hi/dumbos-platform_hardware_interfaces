...
oneway interface IRadioSim {
     ...
     *
     * Response callback is IRadioSimResponse.areUiccApplicationsEnabledResponse()
     */
     ...
     *
     * Response callback is IRadioSimResponse.enableUiccApplicationsResponse()
     */
     ...
     * @param serial Serial number of request.
     *
     * Response callback is IRadioSimResponse.getAllowedCarriersResponse()
     */
     ...
     * @param serial Serial number of request.
     *
     * Response callback is IRadioSimResponse.getCdmaSubscriptionResponse()
     */
     ...
     * @param serial Serial number of request.
     *
     * Response callback is IRadioSimResponse.getCdmaSubscriptionSourceResponse()
     */
     ...
     * @param serial Serial number of request.
     *
     * Response function is defined from IRadioSimResponse.getSimPhonebookCapacityResponse()
     */
     ...
     * @param serial Serial number of request.
     *
     * Response callback is IRadioSimResponse.getSimPhonebookRecordsResponse()
     */
     ...
     *
     * Response callback is IRadioSimResponse.iccCloseLogicalChannelResponse()
     */
     ...
     *
     * Response callback is IRadioSimResponse.iccOpenLogicalChannelResponse()
     */
     ...
     *
     * Response callback is IRadioSimResponse.iccTransmitApduBasicChannelResponse()
     */
     ...
     * @param message SimApdu to be sent
     *
     * Response callback is IRadioSimResponse.iccTransmitApduLogicalChannelResponse()
     */
     ...
     * @param serial Serial number of request.
     *
     * Response callback is IRadioSimResponse.reportStkServiceIsRunningResponse()
     */
     ...
     * @param aid AID value, See ETSI 102.221 8.1 and 101.220 4, empty string if no value
     *
     * Response callback is IRadioSimResponse.requestIccSimAuthenticationResponse()
     */
     ...
     *
     * Response callback is IRadioSimResponse.requestIsimAuthenticationResponse()
     */
     ...
     *
     * Response callback is IRadioSimResponse.sendEnvelopeWithStatusResponse()
     */
     ...
     *
     * Response callback is IRadioSimResponse.setAllowedCarriersResponse()
     */
     ...
     *
     * Response callback is IRadioSimResponse.setCarrierInfoForImsiEncryptionResponse()
     */
     ...
     *
     * Response callback is IRadioSimResponse.setCdmaSubscriptionSourceResponse()
     */
     ...
     *
     * Response callback is IRadioSimResponse.setSimCardPowerResponse().
     */
     ...
     *
     * Response callback is IRadioSimResponse.setUiccSubscriptionResponse()
     */
     ...
     *
     * Response callback is IRadioSimResponse.updateSimPhonebookRecordsResponse()
     */
