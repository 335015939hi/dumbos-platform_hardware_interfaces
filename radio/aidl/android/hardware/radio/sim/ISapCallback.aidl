...
import android.hardware.radio.sim.SapConnectRsp;
import android.hardware.radio.sim.SapDisconnectType;
import android.hardware.radio.sim.SapResultCode;
import android.hardware.radio.sim.SapStatus;
