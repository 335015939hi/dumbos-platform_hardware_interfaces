...
oneway interface IRadioModem {
     ...
     * @param serial Serial number of request.
     *
     * Response function is IRadioNetworkResponse.getBasebandVersionResponse()
     */
     ...
     * @param serial Serial number of request.
     *
     * Response callback is IRadioModemResponse.getDeviceIdentityResponse()
     */
     ...
     * @param serial Serial number of request.
     *
     * Response callback is IRadioModemResponse.getHardwareConfigResponse()
     */
     ...
     * @param serial Serial number of request.
     *
     * Response callback is IRadioModemResponse.getModemActivityInfoResponse()
     */
     ...
     * @param serial Serial number of request.
     *
     * Response callback is IRadioModemResponse.getRadioCapabilityResponse()
     */
     ...
     * @param itemId NvItem
     *
     * Response callback is IRadioModemResponse.nvReadItemResponse()
     */
     ...
     *
     * Response callback is IRadioModemResponse.nvResetConfigResponse()
     */
     ...
     *
     * Response callback is IRadioModemResponse.nvWriteCdmaPrlResponse()
     */
     ...
     *
     * Response callback is IRadioModemResponse.nvWriteItemResponse()
     */
     ...
     * @param serial Serial number of request.
     *
     * Response callback is IRadioModemResponse.requestShutdownResponse()
     */
     ...
     *
     * Response callback is IRadioModemResponse.sendDeviceStateResponse()
     */
     ...
     *
     * Response callback is IRadioModemResponse.setRadioCapabilityResponse()
     */
