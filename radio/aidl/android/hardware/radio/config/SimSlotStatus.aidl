...
parcelable SimSlotStatus {
     ...
     * must always be reported, otherwise the logicalSlotIndex and portActive info will be lost. For
     * example, the pSIM can be removed, but the slot can still be active. In that case, the
