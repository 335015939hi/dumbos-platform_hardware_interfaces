...
oneway interface IRadioConfig {
     ...
     * If eUICC physical slot supports 2 ports, then the portId is numbered 0,1 and eUICC2 supports 4
     * ports. Each portId is unique within a UICC physical slot but not
     * necessarily unique across UICC’s.
