...
oneway interface IRadioVoice {
     ...
     * @param serial Serial number of request.
     *
     * Response callback is IRadioVoiceResponse.exitEmergencyCallbackModeResponse()
     */
     ...
     * @param serial Serial number of request.
     *
     * Response callback is IRadioVoiceResponse.explicitCallTransferResponse()
     */
     ...
     * @param serial Serial number of request.
     *
     * Response callback is IRadioVoiceResponse.getPreferredVoicePrivacyResponse()
     */
     ...
     * @param serial Serial number of request.
     *
     * Response callback is IRadioVoiceResponse.getTTYModeResponse()
     */
     ...
     *
     * Response callback is IRadioVoiceResponse.handleStkCallSetupRequestFromSimResponse()
     */
     ...
     *
     * Response callback is IRadioVoiceResponse.sendBurstDtmfResponse()
     */
     ...
     *
     * Response callback is IRadioVoiceResponse.sendCDMAFeatureCodeResponse()
     */
     ...
     *
     * Response callback is IRadioVoiceResponse.setPreferredVoicePrivacyResponse()
     */
     ...
     * @param mode TtyMode
     *
     * Response callback is IRadioVoiceResponse.setTTYModeResponse()
     */
