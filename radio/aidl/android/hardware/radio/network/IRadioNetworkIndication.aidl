...
oneway interface IRadioNetworkIndication {
     ...
     * @param receivedTime milliseconds since boot that RIL sends the NITZ time to Telephony.
     * @param age milliseconds time for which nitz was cached in RIL and modem.
     */
    void nitzTimeReceived(in RadioIndicationType type, in String nitzTime, in long receivedTime, in long age);
