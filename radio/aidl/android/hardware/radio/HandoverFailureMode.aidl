...
enum HandoverFailureMode {
    /**
     * On data handover failure, fallback to the source data transport when the fail cause is
     * due to a hand off preference change.
     */
    LEGACY = 0,
    /**
    ...
    DO_FALLBACK = 1,
    /**
     * On data handover failure, retry the handover instead of falling back to the
