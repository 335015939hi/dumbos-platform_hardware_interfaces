...
public class Translate {
    ...
    static public android.hardware.radio.RouteSelectionDescriptor h2aTranslate(
        ...
        out.precedence = in.precedence;
        if (in.routeSelectionDescriptorParams != null) {
            out.routeSelectionDescriptorParams =
                    new android.hardware.radio.RouteSelectionDescriptorParams
                            [in.routeSelectionDescriptorParams.size()];
            for (int i = 0; i < in.routeSelectionDescriptorParams.size(); i++) {
                out.routeSelectionDescriptorParams[i] =
                        h2aTranslate(in.routeSelectionDescriptorParams.get(i));
            }
        }
        return out;
    }

    static public android.hardware.radio.RouteSelectionDescriptorParams h2aTranslate(
            android.hardware.radio.V1_6.RouteSelectionDescriptorParams in) {
