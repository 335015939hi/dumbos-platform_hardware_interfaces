...
parcelable ImsSmsMessage {
    ...
    int messageRef;
    /**
     * Valid field if tech is 3GPP2 and size = 1 else must be empty.
     * Only one of cdmaMessage and gsmMessage must be of size 1 based on the RadioTechnologyFamily
     * and the othere must be of size 0.
     */
    CdmaSmsMessage[] cdmaMessage;
    /**
     * Valid field if tech is 3GPP and size = 1 else must be empty.
     * Only one of cdmaMessage and gsmMessage must be of size 1 based on the RadioTechnologyFamily
     * and the othere must be of size 0.
     */
