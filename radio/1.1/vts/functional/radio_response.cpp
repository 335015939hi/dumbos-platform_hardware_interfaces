...
Return<void> RadioResponse::setSimCardPowerResponse_1_1(const RadioResponseInfo& /*info*/) {
    return Void();
}

Return<void> RadioResponse::startNetworkScanResponse(const RadioResponseInfo& /*info*/) {
    return Void();
}

Return<void> RadioResponse::stopNetworkScanResponse(const RadioResponseInfo& /*info*/) {
    return Void();
}
