...
TEST_F(RadioHidlTest_v1_2, startNetworkScan_InvalidInterval1) {
    ...
    ::android::hardware::radio::V1_2::NetworkScanRequest request = {
        .type = ScanType::ONE_SHOT, .interval = 4, .specifiers = {specifier}.maxSearchTime = 60;
...
TEST_F(RadioHidlTest_v1_2, startNetworkScan_InvalidInterval2) {
    ...
    ::android::hardware::radio::V1_2::NetworkScanRequest request = {
        .type = ScanType::ONE_SHOT, .interval = 301, .specifiers = {specifier}.maxSearchTime = 60;
    .incrementalResults = false;
    .incrementalResultsPeriodicity = 1;
};
...
TEST_F(RadioHidlTest_v1_2, startNetworkScan_InvalidMaxSearchTime1) {
    ...
    ::android::hardware::radio::V1_2::NetworkScanRequest request = {
        .type = ScanType::ONE_SHOT, .interval = 60, .specifiers = {specifier}.maxSearchTime = 59;
    .incrementalResults = false;
    .incrementalResultsPeriodicity = 1;
};
...
TEST_F(RadioHidlTest_v1_2, startNetworkScan_InvalidMaxSearchTime2) {
    ...
    ::android::hardware::radio::V1_2::NetworkScanRequest request = {
        .type = ScanType::ONE_SHOT, .interval = 60, .specifiers = {specifier}.maxSearchTime = 3601;
    .incrementalResults = false;
    .incrementalResultsPeriodicity = 1;
};
...
TEST_F(RadioHidlTest_v1_2, startNetworkScan_InvalidPeriodicity1) {
    ...
    ::android::hardware::radio::V1_2::NetworkScanRequest request = {
        .type = ScanType::ONE_SHOT, .interval = 60, .specifiers = {specifier}.maxSearchTime = 600;
    .incrementalResults = false;
