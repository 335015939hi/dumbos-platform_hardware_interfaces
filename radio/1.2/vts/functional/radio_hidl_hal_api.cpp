 ...
 */
TEST_F(RadioHidlTest_v1_2, setupDataCall) {
    ...
    radio_v1_2->setupDataCall_1_2(serial, accessNetwork, dataProfileInfo, modemCognitive,
 ...
 */
TEST_F(RadioHidlTest_v1_2, deactivateDataCall) {
    int serial = GetRandomSerialNumber();
    int cid = 1;
    V1_2::DataRequestReason reason = V1_2::DataRequestReason::NORMAL;

    radio_v1_2->deactivateDataCall_1_2(serial, cid, reason);
