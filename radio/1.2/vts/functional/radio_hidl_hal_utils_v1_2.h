...
class RadioResponse_v1_2 : public ::android::hardware::radio::V1_1::IRadioResponse {
   protected:
...
class RadioIndication_v1_2 : public ::android::hardware::radio::V1_1::IRadioIndication {
   protected:
    RadioHidlTest_v1_2& parent_v1_2;
