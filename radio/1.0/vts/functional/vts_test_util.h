...
static constexpr const char* FEATURE_TELEPHONY_GSM = "android.hardware.telephony_gsm";

static constexpr const char* FEATURE_TELEPHONY_CDMA = "android.hardware.telephony_cdma";
