...
TEST_F(RadioHidlTest, getDataRegistrationState) {
    ...
    if (cardStatus.cardState == CardState::ABSENT) {
        ...
        // Expect PRESENT state to continue the test, other than RESTRICTED or ERROR.
        EXPECT_EQ(cardStatus.cardState, CardState::PRESENT);
        ASSERT_TRUE(CheckAnyOfErrors(
            radioRsp->rspInfo.error,
            {RadioError::NONE, RadioError::NOT_PROVISIONED, RadioError::CANCELLED}, CHECK_DEFAULT));
