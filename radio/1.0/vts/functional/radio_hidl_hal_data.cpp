...
TEST_F(RadioHidlTest, getDataRegistrationState) {
    ...
    if (cardStatus.cardState == CardState::ABSENT) {
        ASSERT_TRUE(CheckAnyOfErrors(radioRsp->rspInfo.error,
                                     {RadioError::NONE, RadioError::MODEM_ERR,
                                      RadioError::NOT_PROVISIONED, RadioError::NO_RESOURCES},
                                     CHECK_GENERAL_ERROR));
    } else {
        ...
        EXPECT_EQ(totalIdentitySizeExpected, GetCellIdentityTotalSize(cellIdentities));
