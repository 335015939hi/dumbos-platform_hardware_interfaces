...
TEST_F(RadioHidlTest, setNetworkSelectionModeManual) {
    ...
    ALOGW("sanket setNetworkSelectionModeManual");
...
/*
 * Test IRadio.setLocationUpdatesResponse() for the response returned.
 */
TEST_F(RadioHidlTest, setLocationUpdatesResponse) {
    int serial = 1;
