...
TEST_F(RadioHidlTest, acknowledgeLastIncomingGsmSms) {
    ...
    bool success = true;
    radio->acknowledgeLastIncomingGsmSms(++serial, success, android::hardware::radio::V1_0::SmsAcknowledgeFailCause::MEMORY_CAPACITY_EXCEEDED);
...
TEST_F(RadioHidlTest, sendCdmaSms) {
    ...
    cdmaSmsMessage.bearerData = (std::vector<uint8_t>) {15, 0, 3, 32, 3, 16, 1, 8, 16, 53, 76, 68, 6, 51, 106, 0};
