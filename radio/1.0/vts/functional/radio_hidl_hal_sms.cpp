...
using ::android::hardware::radio::V1_0::CdmaSmsAck;
using ::android::hardware::radio::V1_0::CdmaSmsAddress;
using ::android::hardware::radio::V1_0::CdmaSmsDigitMode;
using ::android::hardware::radio::V1_0::CdmaSmsErrorClass;
using ::android::hardware::radio::V1_0::CdmaSmsNumberMode;
using ::android::hardware::radio::V1_0::CdmaSmsNumberPlan;
using ::android::hardware::radio::V1_0::CdmaSmsNumberType;
using ::android::hardware::radio::V1_0::CdmaSmsMessage;
using ::android::hardware::radio::V1_0::CdmaSmsSubaddress;
using ::android::hardware::radio::V1_0::CdmaSmsSubaddressType;
using ::android::hardware::radio::V1_0::CdmaSmsWriteArgs;
using ::android::hardware::radio::V1_0::CdmaSmsWriteArgsStatus;
using ::android::hardware::radio::V1_0::GsmSmsMessage;
using ::android::hardware::radio::V1_0::ImsSmsMessage;
using ::android::hardware::radio::V1_0::RadioTechnologyFamily;
using ::android::hardware::radio::V1_0::SmsAcknowledgeFailCause;
using ::android::hardware::radio::V1_0::SmsWriteArgs;
using ::android::hardware::radio::V1_0::SmsWriteArgsStatus;
...
TEST_F(RadioHidlTest, sendSms) {
    ...
    if (cardStatus.cardState == CardState::ABSENT) {
        ...
        EXPECT_EQ(radioRsp->sendSmsResult.errorCode, 0);
    }
    else {
...
TEST_F(RadioHidlTest, acknowledgeLastIncomingGsmSms) {
    ...
    EXPECT_EQ(radioRsp->rspInfo.error, RadioError::INVALID_STATE); // for no sim card
...
TEST_F(RadioHidlTest, deleteSmsOnSim) {
    ...
    EXPECT_EQ(radioRsp->rspInfo.error, RadioError::INVALID_MODEM_STATE); // for no sim card
...
TEST_F(RadioHidlTest, acknowledgeIncomingGsmSmsWithPdu) {
    ...
    //EXPECT_EQ(radioRsp->rspInfo.error, RadioError::MODEM_ERR); // for no sim
