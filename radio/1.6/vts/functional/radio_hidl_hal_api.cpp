...
TEST_P(RadioHidlTest_v1_6, setSimCardPower_1_6) {
    ...
    if (radioRsp_v1_6->rspInfo.error == ::android::hardware::radio::V1_6::RadioError::NONE) {
        ...
        // applictions should be an empty vector of AppStatus
        std::vector<::android::hardware::radio::V1_5::AppStatus> empty_apps = {};
        EXPECT_EQ(empty_apps, cardStatus.base.applications);
    }
