...
public class Translate {
    ...
    static public android.hardware.radio.config.PhoneCapability h2aTranslate(
        ...
        if (in.logicalModemList != null) {
            out.logicalModemList =
                    new android.hardware.radio.config.ModemInfo[in.logicalModemList.size()];
            for (int i = 0; i < in.logicalModemList.size(); i++) {
                out.logicalModemList[i] = h2aTranslate(in.logicalModemList.get(i));
            }
        }
        return out;
    }
