...
#include "android/hardware/radio/config/translate-cpp.h"

namespace android::h2a {

static_assert(android::hardware::radio::config::SlotState::INACTIVE ==
              static_cast<android::hardware::radio::config::SlotState>(
                      ::android::hardware::radio::config::V1_0::SlotState::INACTIVE));
static_assert(android::hardware::radio::config::SlotState::ACTIVE ==
              static_cast<android::hardware::radio::config::SlotState>(
...
__attribute__((warn_unused_result)) bool translate(
    ...
    out->cardState = static_cast<android::hardware::radio::CardState>(in.base.cardState);
    out->slotState = static_cast<android::hardware::radio::config::SlotState>(in.base.slotState);
    out->atr = String16(in.base.atr.c_str());
    ...
    out->iccid = String16(in.base.iccid.c_str());
    out->eid = String16(in.eid.c_str());
    return true;
}
