 ...
 */
TEST_F(RadioHidlTest_v1_3, startNetworkScan) {
    ...
    Return<void> res = radio_v1_3->startNetworkScan_1_3(serial, request);
    ASSERT_OK(res);
    ...
    if (cardStatus.base.cardState == CardState::ABSENT) {
        ASSERT_TRUE(CheckAnyOfErrors(radioRsp_v1_3->rspInfo.error, {RadioError::SIM_ABSENT}));
 ...
 */
TEST_F(RadioHidlTest_v1_3, startNetworkScan_InvalidArgument) {
    serial = GetRandomSerialNumber();
    ...
    if (cardStatus.base.cardState == CardState::ABSENT) {
        ...
        ASSERT_TRUE(
            CheckAnyOfErrors(radioRsp_v1_3->rspInfo.error, {RadioError::INVALID_ARGUMENTS}));
    }
}
 ...
 */
TEST_F(RadioHidlTest_v1_3, startNetworkScan_InvalidInterval1) {
    serial = GetRandomSerialNumber();
 ...
 */
TEST_F(RadioHidlTest_v1_3, startNetworkScan_InvalidInterval2) {
    serial = GetRandomSerialNumber();
 ...
 */
TEST_F(RadioHidlTest_v1_3, startNetworkScan_InvalidMaxSearchTime1) {
    serial = GetRandomSerialNumber();
 ...
 */
TEST_F(RadioHidlTest_v1_3, startNetworkScan_InvalidMaxSearchTime2) {
    serial = GetRandomSerialNumber();
 ...
 */
TEST_F(RadioHidlTest_v1_3, startNetworkScan_InvalidPeriodicity1) {
    serial = GetRandomSerialNumber();
 ...
 */
TEST_F(RadioHidlTest_v1_3, startNetworkScan_InvalidPeriodicity2) {
    serial = GetRandomSerialNumber();
 ...
 */
TEST_F(RadioHidlTest_v1_3, startNetworkScan_GoodRequest1) {
    serial = GetRandomSerialNumber();
 ...
 */
TEST_F(RadioHidlTest_v1_3, startNetworkScan_GoodRequest2) {
    serial = GetRandomSerialNumber();
