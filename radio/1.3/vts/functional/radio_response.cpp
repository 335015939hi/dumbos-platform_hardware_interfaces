...
/* 1.3 Apis */
Return<void> RadioResponse_v1_3::emergencyDialResponse(const RadioResponseInfo& info) {
    rspInfo = info;
    parent_v1_3.notify(info.serial);
    return Void();
}

Return<void> RadioResponse_v1_3::getDataRegistrationStateResponse_1_3(
    const RadioResponseInfo& info,
    const ::android::hardware::radio::V1_3::DataRegStateResult& dataRegResponse) {
    rspInfo = info;
...
Return<void> RadioResponse_v1_3::startNetworkScanResponse_1_3(const RadioResponseInfo& info) {
    rspInfo = info;
    parent_v1_3.notify(info.serial);
    return Void();
}