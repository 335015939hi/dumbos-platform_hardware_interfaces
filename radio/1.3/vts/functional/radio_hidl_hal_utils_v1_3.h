...
/* Callback class for radio respons v1_3 */
class RadioResponse_v1_3 : public ::android::hardware::radio::V1_3::IRadioResponse {
   ...
   public:
    ...
    // Data
    ::android::hardware::radio::V1_3::DataRegStateResult dataRegResp;
    ...
    Return<void> startNetworkScanResponse_1_3(const RadioResponseInfo& info);
};
