 ...
 */
#ifndef ANDROID_HARDWARE_RADIO_V1_4_RADIO_H
#define ANDROID_HARDWARE_RADIO_V1_4_RADIO_H
...
struct Radio : public IRadio {
    ...
    sp<::android::hardware::radio::V1_3::IRadioResponse> mRadioResponseV1_3;
    sp<::android::hardware::radio::V1_3::IRadioIndication> mRadioIndicationV1_3;
    sp<::android::hardware::radio::V1_4::IRadioResponse> mRadioResponseV1_4;
    sp<::android::hardware::radio::V1_4::IRadioIndication> mRadioIndicationV1_4;
    ...
    Return<void> setupDataCall_1_4(int32_t serial, AccessNetwork accessNetwork,
                                   const DataProfileInfo& dataProfileInfo, bool roamingAllowed,
                                   ::android::hardware::radio::V1_2::DataRequestReason reason,
    ...
    Return<void> setInitialAttachApn_1_4(int32_t serial,
                                         const DataProfileInfo& dataProfileInfo) override;

    Return<void> setDataProfile_1_4(int32_t serial,
                                    const hidl_vec<DataProfileInfo>& profiles) override;
    ...
    Return<void> emergencyDial(int32_t serial,
                               ...
                               const hidl_vec<::android::hardware::hidl_string>& urns,
                               EmergencyCallRouting routing, bool isTesting) override;

    Return<void> startNetworkScan_1_4(
            int32_t serial,
            const ::android::hardware::radio::V1_2::NetworkScanRequest& request) override;
    ...
    Return<void> setAllowedCarriers_1_4(int32_t serial,
                                        ...
                                        SimLockMultiSimPolicy multiSimPolicy) override;
...
#endif  // ANDROID_HARDWARE_RADIO_V1_4_RADIO_H