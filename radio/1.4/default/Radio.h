...
struct Radio : public IRadio {
    ...
    Return<void> supplyIccPinForApp(
            int32_t serial, const hidl_string& pin, const hidl_string& aid) override;
    Return<void> supplyIccPukForApp(int32_t serial, const hidl_string& puk, const hidl_string& pin,
            const hidl_string& aid) override;
    Return<void> supplyIccPin2ForApp(
            int32_t serial, const hidl_string& pin2, const hidl_string& aid) override;
    ...
    Return<void> dial(
            int32_t serial, const ::android::hardware::radio::V1_0::Dial& dialInfo) override;
    ...
    Return<void> sendSMSExpectMore(int32_t serial,
            const ::android::hardware::radio::V1_0::GsmSmsMessage& message) override;
    ...
    Return<void> iccIOForApp(
            int32_t serial, const ::android::hardware::radio::V1_0::IccIo& iccIo) override;
    ...
    Return<void> getFacilityLockForApp(int32_t serial, const hidl_string& facility,
            const hidl_string& password, int32_t serviceClass, const hidl_string& appId) override;
    ...
    Return<void> setBarringPassword(int32_t serial, const hidl_string& facility,
            const hidl_string& oldPassword, const hidl_string& newPassword) override;
    ...
    Return<void> setNetworkSelectionModeManual(
            int32_t serial, const hidl_string& operatorNumeric) override;
    ...
    Return<void> setBandMode(
            int32_t serial, ::android::hardware::radio::V1_0::RadioBandMode mode) override;
    ...
    Return<void> sendTerminalResponseToSim(
            int32_t serial, const hidl_string& commandResponse) override;
    ...
    Return<void> setTTYMode(
            int32_t serial, ::android::hardware::radio::V1_0::TtyMode mode) override;
    ...
    Return<void> sendBurstDtmf(
            int32_t serial, const hidl_string& dtmf, int32_t on, int32_t off) override;
    Return<void> sendCdmaSms(
            int32_t serial, const ::android::hardware::radio::V1_0::CdmaSmsMessage& sms) override;
    ...
    Return<void> writeSmsToRuim(int32_t serial,
    ...
    Return<void> acknowledgeIncomingGsmSmsWithPdu(
            int32_t serial, bool success, const hidl_string& ackPdu) override;
    ...
    Return<void> iccTransmitApduLogicalChannel(
            int32_t serial, const ::android::hardware::radio::V1_0::SimApdu& message) override;
    Return<void> nvReadItem(
            int32_t serial, ::android::hardware::radio::V1_0::NvItem itemId) override;
    Return<void> nvWriteItem(
            int32_t serial, const ::android::hardware::radio::V1_0::NvWriteItem& item) override;
    Return<void> nvWriteCdmaPrl(int32_t serial, const hidl_vec<uint8_t>& prl) override;
    Return<void> nvResetConfig(
            int32_t serial, ::android::hardware::radio::V1_0::ResetNvType resetType) override;
    Return<void> setUiccSubscription(int32_t serial,
    ...
    Return<void> sendDeviceState(int32_t serial,
            ::android::hardware::radio::V1_0::DeviceStateType deviceStateType, bool state) override;
    ...
    Return<void> startNetworkScan(int32_t serial,
    ...
    Return<void> setInitialAttachApn_1_4(int32_t serial,
            const ::android::hardware::radio::V1_4::DataProfileInfo& dataProfileInfo) override;
    Return<void> setDataProfile_1_4(int32_t serial,
            const hidl_vec<::android::hardware::radio::V1_4::DataProfileInfo>& profiles) override;
    Return<void> emergencyDial(int32_t serial,
            const ::android::hardware::radio::V1_0::Dial& dialInfo,
            hidl_bitfield<EmergencyServiceCategory> categories, const hidl_vec<hidl_string>& urns,
            ::android::hardware::radio::V1_4::EmergencyCallRouting routing,
            bool fromEmergencyDialer, bool isTesting) override;
    ...
    Return<void> setPreferredNetworkTypeBitmap(
            int32_t serial, hidl_bitfield<RadioAccessFamily> networkTypeBitmap) override;
...
// extern "C" IRadio* HIDL_FETCH_IRadio(const char* name);
