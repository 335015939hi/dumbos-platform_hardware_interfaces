...
interface ICas {
     ...
     */
    Status closeSession(in byte[] sessionId);
     ...
     * @param out sessionId the id of the newly opened session.
     */
    Status openSession(out byte[] sessionId);
     ...
     * @param out sessionId the id of the newly opened session.
     */
    Status openSessionExt(in SessionIntent intent, in ScramblingMode mode, out byte[] sessionId);
     ...
     * @return the status of the call.
     */
    Status processEcm(in byte[] sessionId, in byte[] ecm);
     ...
     * @return the status of the call.
     */
    Status provision(in String provisionString);
     ...
     * @return the status of the call.
     */
    Status refreshEntitlements(in int refreshType, in byte[] refreshData);
     ...
     * @return the status of the call.
     */
    Status sendEvent(in int event, in int arg, in byte[] eventData);
     ...
     * @return the status of the call.
     */
    Status sendSessionEvent(in byte[] sessionId, in int event, in int arg, in byte[] eventData);
     ...
     * @return the status of the call.
     */
    Status setPrivateData(in byte[] pvtData);
     ...
     * @return the status of the call.
     */
    Status setSessionPrivateData(in byte[] sessionId, in byte[] pvtData);
}
