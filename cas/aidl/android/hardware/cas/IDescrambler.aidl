...
interface IDescrambler {
    parcelable DetailedStatus {
        /*
         * The status of the descramble call.
         */
        Status status;
        /*
     ...
     *
     * @return class that encapsulates status, bytes written and detailed error.
     */
    DetailedStatus descramble(in ScramblingControl scramblingControl, in SubSample[] subSamples,
     ...
     * @return the status of the call.
     */
    Status setMediaCasSession(in byte[] sessionId);
}
