...
interface INfc {
     ...
     *
     */
    NfcStatus open(in INfcClientCallback clientCallback);
     ...
     * @return NfcStatus::OK on success and NfcStatus::FAILED on error.
     */
    NfcStatus closeForPowerOffCase();
     ...
     * @return NfcStatus::OK on success and NfcStatus::FAILED on error.
     */
    NfcStatus coreInitialized(in byte[] data);
     ...
     * @return indicates support for certain features and
     ...
     *
     * @return out NfcStatus::OK on success and NfcStatus::FAILED on error.
     */
    NfcStatus powerCycle();
