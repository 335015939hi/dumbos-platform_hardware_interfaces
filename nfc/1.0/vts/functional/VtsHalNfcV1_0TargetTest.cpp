...
//    nfc_cb_->waitForCallback();
    EXPECT_TRUE(nfc_cb_->waitForCallback());
  ...
  class NfcClientCallback : public ::testing::VtsHalHidlTargetCallbackBase, public INfcClientCallback {
    NfcHidlTest& parent_;
