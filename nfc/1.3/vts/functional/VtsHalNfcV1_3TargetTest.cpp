...
using ::android::hardware::nfc::V1_3::INfc;
...
/*
 * setVendorConfigFileName
 * calls setVendorConfigFileName() with an empty string
 * checks status
 */
TEST_F(NfcHidlTest, setVendorConfigFileName) {
    // Load default configuration when it sets an empty string.
    // Nfc hal open/close works without fail.
    nfc_->setVendorConfigFileName("");
