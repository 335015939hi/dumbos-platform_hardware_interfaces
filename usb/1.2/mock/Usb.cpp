...
#define LOG_TAG "android.hardware.usb@1.2-service.mock"
...
Status queryContaminantDetectionStatus(hidl_vec<PortStatus> *currentPortStatus_1_2) {
    std::string enabled, status;

    // Contaminant detection not supported in default implementation.
...
void populateMockPort(hidl_vec<PortStatus> *currentPortStatus_1_2, HALVersion version) {
    currentPortStatus_1_2->resize(1);
    (*currentPortStatus_1_2)[0].status_1_1.status.portName = "mock";
    (*currentPortStatus_1_2)[0].status_1_1.status.currentPowerRole = PortPowerRole::NONE;
    (*currentPortStatus_1_2)[0].status_1_1.status.currentDataRole = PortDataRole::NONE;
    (*currentPortStatus_1_2)[0].status_1_1.currentMode =
        static_cast<PortMode_1_1>(PortMode_1_1::NONE);
    (*currentPortStatus_1_2)[0].status_1_1.status.currentMode =
        static_cast<V1_0::PortMode>(PortMode_1_1::NONE);
    ...
    if (version == HALVersion::V1_0) {
        (*currentPortStatus_1_2)[0].status_1_1.status.supportedModes = V1_0::PortMode::DRP;
    } else {
        (*currentPortStatus_1_2)[0].status_1_1.supportedModes = 0 | PortMode_1_1::DRP;
...
Status getPortStatusHelper(hidl_vec<PortStatus> *currentPortStatus_1_2, HALVersion version) {
    ...
    if (result == Status::SUCCESS) {
        ...
        populateMockPort(currentPortStatus_1_2, version);
        return Status::SUCCESS;
    }
    ...
    if (usb->mCallback_1_0 != NULL) {
        if (callback_V1_2 != NULL) {
            ...
            if (status == Status::SUCCESS)
                queryContaminantDetectionStatus(currentPortStatus_1_2);
