...
<<<<<<< TARGET BRANCH (c556f1 Modify VTS NoStaleEvents test to omit on-change sensors)
...
=======
            ...
            usleep(1000);
>>>>>>> SOURCE BRANCH (26f868 Audio: Ensure input stream gets closed on the audio HAL serv)
            if (efGroup) {
