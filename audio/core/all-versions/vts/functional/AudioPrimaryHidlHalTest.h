...
class StreamWriter : public StreamWorker<IStreamOut> {
  public:
    StreamWriter(IStreamOut* stream, size_t bufferSize)
        : StreamWorker<IStreamOut>(stream), mBufferSize(bufferSize), mData(mBufferSize) {}
...
class StreamReader : public StreamWorker<IStreamIn> {
  public:
    StreamReader(IStreamIn* stream, size_t bufferSize)
        : StreamWorker<IStreamIn>(stream), mBufferSize(bufferSize), mData(mBufferSize) {}
