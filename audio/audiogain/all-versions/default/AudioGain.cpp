...
static inline Result toExtensionResult(::android::hardware::audio::CPP_VERSION::Result status) {
    switch (status) {
        ...
        case ::android::hardware::audio::CPP_VERSION::Result::INVALID_STATE:
            return Result::INVALID_STATE;
        case ::android::hardware::audio::CPP_VERSION::Result::NOT_INITIALIZED:
...
Return<Result> AudioGain::subscribe(const android::sp<IAudioGainCallback> &callback)
{
    //
    ...
    deviceFactory->openPrimaryDevice([&](::android::hardware::audio::CPP_VERSION::Result r,
        ...
        if (r != ::android::hardware::audio::CPP_VERSION::Result::OK) {
            status = ::android::hardware::audio::CPP_VERSION::Result::NOT_INITIALIZED;
            return;
        }
...
Return<Result> AudioGain::unsubscribe(const android::sp<IAudioGainCallback> &callback)
{
    //
    // Default behavior is dispatched to primary device
    //
