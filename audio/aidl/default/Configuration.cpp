...
std::unique_ptr<Configuration> getPrimaryConfiguration() {
    static const Configuration configuration = []() {
        ...
        c.routes.push_back(createRoute({telephonyRxInMix}, telephonyRxInDevice));
        c.routes.push_back(createRoute({fmTunerInMix}, fmTunerInDevice));
