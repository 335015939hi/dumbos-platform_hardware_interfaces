...
ConversionResult<aidlaudiocommon::AudioHalCapCriterion> convertCapCriterionToAidl(
        const engineconfiguration::CriterionType& xsdcCriterion);
ConversionResult<aidlaudiocommon::AudioHalCapCriterionType> convertCapCriterionTypeToAidl(
        const engineconfiguration::CriterionTypeType& xsdcCriterionType);
