...
class AudioPolicyConfigXmlConverter
    : public XmlConverter<::android::audio::policy::configuration::AudioPolicyConfiguration> {
  public:
    AudioPolicyConfigXmlConverter(const std::string& configFilePath)
        : XmlConverter(configFilePath, &::android::audio::policy::configuration::read) {}
