...
struct DriverInterface {
    ...
    // The methods below are called from a thread of the Binder pool. Access to data shared with
    // other methods of these interfaces must be done in a thread-safe manner.
