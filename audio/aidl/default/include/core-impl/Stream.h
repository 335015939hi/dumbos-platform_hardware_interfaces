...
struct DriverInterface {
    ...
    // These functions are called from Binder pool thread. It must be done in a thread-safe manner
    // if these methods and other methods in these interfaces share data.
