...
class StreamContext {
  public:
    ...
    // Ensure that this value is not used by any of StreamDescriptor.STATE_*
...
class StreamWorkerCommonLogic : public ::android::hardware::audio::common::StreamLogic {
  public:
    ...
    void setClosed() { mState = StreamContext::STATE_CLOSED; }
  ...
  protected:
    ...
    std::atomic<int> mState = StreamDescriptor::STATE_IDLE;
