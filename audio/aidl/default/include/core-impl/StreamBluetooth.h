...
struct BluetoothStream {
    std::shared_ptr<::android::bluetooth::audio::aidl::BluetoothAudioPort> btPort;
    ::aidl::android::hardware::bluetooth::audio::PcmConfiguration audioCfg;
    std::mutex mLock;
};
