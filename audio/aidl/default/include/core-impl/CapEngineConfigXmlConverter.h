...
class CapEngineConfigXmlConverter {
  ...
  private:
    ConversionResult<std::vector<aidlcommon::AudioHalCapParameter>>
    convertSettingToAidl(const capconfiguration::SettingsType::Configuration& xsdcSetting);

    ConversionResult<std::vector<aidlcommon::AudioHalCapConfiguration>>
    ...
    ConversionResult<aidlcommon::AudioHalCapParameter>
    convertParamToAidl(const capconfiguration::ConfigurableElementSettingsType& element);

    ConversionResult<aidlcommon::AudioHalCapConfiguration>
    convertConfigurationToAidl(
            const capconfiguration::ConfigurationsType::Configuration& xsdcConfiguration);
    ConversionResult<aidlcommon::AudioHalCapDomain>
