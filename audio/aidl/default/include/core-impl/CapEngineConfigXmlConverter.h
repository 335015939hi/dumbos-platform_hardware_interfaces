...
class CapEngineConfigXmlConverter {
  ...
  private:
    ...
    ConversionResult<aidlcommon::AudioHalCapSetting::ParameterSetting> convertParamToAidl(
            const ParamType& xsdcTypedParam,
    ...
    ConversionResult<aidlcommon::AudioHalCapSetting> convertSettingToAidl(
