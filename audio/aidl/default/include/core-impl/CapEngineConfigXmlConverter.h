...
class CapEngineConfigXmlConverter {
  ...
  private:
    ...
    ConversionResult<aidlcommon::AudioHalCapSetting::ParameterSetting>
    convertParamToAidl(const ParamType& xsdcTypedParam,
                       const capconfiguration::ConfigurableElementSettingsType& element,
                       aidlcommon::AudioHalCapSetting::ParameterSetting::Value::Tag valueTag);
    ...
    ConversionResult<aidlcommon::AudioHalCapSetting>
