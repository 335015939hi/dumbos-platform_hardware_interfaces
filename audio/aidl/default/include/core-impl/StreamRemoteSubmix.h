...
const AudioFormatDescription kDefaultFormat =
        AudioFormatDescription{.type = AudioFormatType::PCM, .pcm = PcmType::INT_16_BIT};
const AudioChannelLayout kDefaultChannelLayout =
...
struct AudioConfig {
    ...
    AudioFormatDescription format = kDefaultFormat;
    AudioChannelLayout channelLayout = kDefaultChannelLayout;
    size_t frameSize;
    size_t frameCount;
};
