...
class BluetoothAudioPort {
  public:
    ...
    virtual bool getPresentationPosition(
            ::aidl::android::hardware::bluetooth::audio::PresentationPosition&) const {
        return false;
    }
...
class BluetoothAudioPortAidl : public BluetoothAudioPort {
  public:
    BluetoothAudioPortAidl() = default;
  ...
  protected:
    uint16_t mCookie = ::aidl::android::hardware::bluetooth::audio::kObserversCookieUndefined;
    GUARDED_BY(mCvMutex) BluetoothStreamState mState = BluetoothStreamState::DISABLED;
