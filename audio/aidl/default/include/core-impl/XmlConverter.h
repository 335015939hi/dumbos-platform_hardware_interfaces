  ...
  public:
    XmlConverter(const std::string& configFilePath,
        ...
        : mRequestedFilePath(configFilePath),
          ...
          mXsdcConfig{mIsRequestedFilePathReadable ? readXmlConfig(mRequestedFilePath.c_str())
                                                   : std::nullopt},
