...
using aidl::android::hardware::audio::effect::DownmixSwImplUUID;
...
extern "C" binder_exception_t createEffect(const AudioUuid* in_impl_uuid,
    ...
    if (!in_impl_uuid || *in_impl_uuid != DownmixSwImplUUID) {
...
IEffect::Status DownmixSw::effectProcessImpl(float* in, float* out, int process) {
