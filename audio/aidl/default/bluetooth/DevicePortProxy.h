...
class BluetoothAudioPort {
  public:
     ...
     ***/
    virtual bool SetUp(const ::aidl::android::media::audio::common::AudioDeviceDescription&) {
        return false;
    }
...
class BluetoothAudioPortAidl : public BluetoothAudioPort {
  public:
    ...
    bool SetUp(const ::aidl::android::media::audio::common::AudioDeviceDescription& description)
            override;
    ...
    void UpdateSourceMetadata(const ::aidl::android::hardware::audio::common::SourceMetadata&
                                      source_metadata) const override;
    ...
    virtual void UpdateSinkMetadata(
            const ::aidl::android::hardware::audio::common::SinkMetadata& sink_metadata) const;
  ...
  protected:
    ...
    ::aidl::android::hardware::bluetooth::audio::SessionType session_type_;
