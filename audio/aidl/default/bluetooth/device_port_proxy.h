...
class BluetoothAudioPort {
 public:
   ...
   ***/
  virtual bool SetUp(AudioDeviceDescription) { return false; }
   ...
   * Bluetooth stack
   ***/
  virtual bool LoadAudioConfig(PcmConfiguration*) const { return false; };
  ...
  ***/
   ...
   ***/
  virtual void UpdateSourceMetadata(const SourceMetadata*) const {};
   ...
   ***/
  virtual void SetState(BluetoothStreamState state) { (void) state; }
...
class BluetoothAudioPortAidl : public BluetoothAudioPort {
 public:
  ...
  bool SetUp(AudioDeviceDescription description) override;
  ...
  void UpdateSourceMetadata(
      const SourceMetadata* source_metadata) const override;

  /***
   * Called by the Audio framework / HAL when the metadata of the stream's
   * sink has been changed.
   ***/
  virtual void UpdateSinkMetadata(const SinkMetadata* sink_metadata) const;
 ...
 private:
  ...
  bool init_session_type(AudioDeviceDescription description);
...
class BluetoothAudioPortAidlOut : public BluetoothAudioPortAidl {
 public:
  ...
  bool LoadAudioConfig(PcmConfiguration* audio_cfg) const override;
};
