...
void ModuleUsb::onMasterMuted(bool muted) {
    usb::UsbAlsaMixerControl::getInstance()->setMasterMuted(muted);
}

void ModuleUsb::onMasterVolumeChanged(float volume) {
    usb::UsbAlsaMixerControl::getInstance()->setMasterVolume(volume);
}
