...
struct CapConfigurableDomainTraits : public BaseSerializerTraits<AudioHalCapDomain, std::vector<AudioHalCapDomain>> {
...
struct ConfigurationTraits : public BaseSerializerTraits<AudioHalCapConfiguration, std::vector<AudioHalCapConfiguration>> {
...
struct ConfigurableElementTraits : public BaseSerializerTraits<std::string, std::vector<std::string>> {
...
struct CapSettingTraits : public BaseSerializerTraits<AudioHalCapSetting, std::vector<AudioHalCapSetting>> {
    static constexpr const char *tag = "Configuration";
...
::android::status_t ConfigurableElementTraits::deserialize(_xmlDoc *doc __unused, const _xmlNode *child,
