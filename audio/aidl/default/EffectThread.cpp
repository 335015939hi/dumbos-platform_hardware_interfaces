...
void EffectThread::threadLoop() {
    ...
    while (true) {
        /**
         * wait for the EventFlag without lock, it's ok because the mEfGroup will not change in the
         * life cycle of workerThread (threadLoop).
         */
        uint32_t efState = 0;
