...
interface IModule {
  ...
  oneway void updateAudioMode(android.hardware.audio.core.AudioMode mode);
  oneway void updateScreenRotation(android.hardware.audio.core.IModule.ScreenRotation rotation);
  oneway void updateScreenState(boolean isTurnedOn);
  @VintfStability
