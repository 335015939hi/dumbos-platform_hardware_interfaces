...
@VintfStability
union Spatializer {
  android.hardware.audio.effect.Spatializer.Id id;
  android.hardware.audio.effect.VendorExtension vendor;
  android.hardware.audio.effect.Spatializer.Level level;
  android.hardware.audio.effect.Spatializer.HeadTrackingMode headTrackingMode;
  android.media.audio.common.AudioChannelLayout[] supportedChannelLayout;
  android.hardware.audio.effect.Spatializer.Mode mode;
  float[6] headToStage;
