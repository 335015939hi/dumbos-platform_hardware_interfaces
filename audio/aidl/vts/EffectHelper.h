...
class EffectHelper {
  public:
    ...
    void open(std::shared_ptr<IEffect> effect, const Parameter::Common& common,
        ...
        mIFrameSize = ::aidl::android::hardware::audio::common::getFrameSizeInBytes(
                common.input.base.format, common.input.base.channelMask);
        mInputSizeInFloat = common.input.frameCount * mIFrameSize / sizeof(float);
        mOFrameSize = ::aidl::android::hardware::audio::common::getFrameSizeInBytes(
                common.output.base.format, common.output.base.channelMask);
        mOutputSizeInFloat = common.output.frameCount * mOFrameSize / sizeof(float);
    }
    ...
    static void processAndWriteToOutput(std::vector<float>& inputBuffer,
        ...
        if (version == -1) {
            ASSERT_TRUE(effect->getInterfaceVersion(&version).isOk());
        }
    ...
    size_t mIFrameSize, mOFrameSize;
    size_t mInputSizeInFloat, mOutputSizeInFloat;
};
