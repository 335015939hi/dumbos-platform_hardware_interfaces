...
class ModuleConfig {
  public:
    ...
    std::vector<aidl::android::media::audio::common::AudioPort> getAudioPortsForDeviceTypes(
            std::vector<aidl::android::media::audio::common::AudioDeviceType> deviceTypes);
    ...
    std::vector<aidl::android::media::audio::common::AudioPort> getMixPorts(
            bool isInput, bool connectedOnly) const {
    ...
    std::vector<aidl::android::media::audio::common::AudioPort> getNonBlockingMixPorts(
            bool connectedOnly, bool singlePort) const;
    ...
    void onExternalDeviceConnected(aidl::android::hardware::audio::core::IModule* module,
                                   const aidl::android::media::audio::common::AudioPort& port);
    void onExternalDeviceDisconnected(aidl::android::hardware::audio::core::IModule* module,
                                      const aidl::android::media::audio::common::AudioPort& port);
