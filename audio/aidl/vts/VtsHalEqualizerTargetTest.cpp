...
class EqualizerTest : public ::testing::TestWithParam<EqualizerParamTestParam>,
  ...
  public:
    ...
    void SetUp() override {
        ...
        HELPER_ASSERT(create, mFactory, mEffect, mIdentity);
        ...
        HELPER_ASSERT(open, mEffect, common, specific, &ret, EX_NONE);
        ASSERT_NE(nullptr, mEffect);
        ASSERT_NO_FATAL_FAILURE(setTagRange());
    }
    void TearDown() override {
        HELPER_ASSERT(close, mEffect);
        HELPER_ASSERT(destroy, mFactory, mEffect);
    }
