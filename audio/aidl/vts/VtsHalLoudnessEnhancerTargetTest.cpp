...
class LoudnessEnhancerParamTest : public ::testing::TestWithParam<LoudnessEnhancerParamTestParam>,
  ...
  public:
    ...
    void SetUp() override {
        ...
        EFFECT_HELPER(create, mFactory, mEffect, mIdentity);
        ...
        EFFECT_HELPER(open, mEffect, common, specific, &ret, EX_NONE);
        ASSERT_NE(nullptr, mEffect);
    }
    void TearDown() override {
        EFFECT_HELPER(close, mEffect);
        EFFECT_HELPER(destroy, mFactory, mEffect);
    }
