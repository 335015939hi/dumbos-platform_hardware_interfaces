...
static const NamedCommandSequence kReadOrWriteSeq = std::make_pair(
        ...
        std::vector<CommandAndState>{std::make_pair(StreamDescriptor::CommandCode::START,
                                     ...
                                     std::make_pair(StreamDescriptor::CommandCode::BURST,
                                                    StreamDescriptor::State::READY)});
static const NamedCommandSequence kDrainSeq = std::make_pair(
        std::string("Drain"),
...
static const NamedCommandSequence kStandbySeq = std::make_pair(
        ...
        std::vector<CommandAndState>{
                ...
                std::make_pair(StreamDescriptor::CommandCode::BURST,
                               StreamDescriptor::State::READY)});
static const NamedCommandSequence kPauseSeq = std::make_pair(
        std::string("Pause"),
        std::vector<CommandAndState>{
                std::make_pair(StreamDescriptor::CommandCode::START,
                               StreamDescriptor::State::READY),
                ...
                std::make_pair(StreamDescriptor::CommandCode::FLUSH,
                               StreamDescriptor::State::IDLE)});
static const NamedCommandSequence kFlushSeq = std::make_pair(
        std::string("Flush"),
        std::vector<CommandAndState>{
                std::make_pair(StreamDescriptor::CommandCode::FLUSH, StreamDescriptor::State::IDLE),
                std::make_pair(StreamDescriptor::CommandCode::STANDBY,
                               StreamDescriptor::State::STANDBY),
                std::make_pair(StreamDescriptor::CommandCode::FLUSH,
                               StreamDescriptor::State::STANDBY),
...
INSTANTIATE_TEST_SUITE_P(
        ...
        testing::Combine(testing::ValuesIn(android::getAidlHalInstanceNames(IModule::descriptor)),
                         testing::Values(kReadOrWriteSeq, kDrainSeq, kStandbySeq, kPauseSeq,
                                         kFlushSeq),
