...
class WithRemoteSubmix {
  ...
  private:
    ...
    std::unique_ptr<WithDevicePortConnectedState> mConnectedPort = nullptr;
    std::unique_ptr<WithAudioPatch> mPatch = nullptr;
    std::unique_ptr<WithStream<Stream>> mStream = nullptr;
};
