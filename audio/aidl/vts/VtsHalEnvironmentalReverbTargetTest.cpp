...
class EnvironmentalReverbHelper : public EffectHelper {
  public:
    EnvironmentalReverbHelper(std::pair<std::shared_ptr<IFactory>, Descriptor::Identity> pair) {
...
INSTANTIATE_TEST_SUITE_P(
        ...
        [](const testing::TestParamInfo<EnvironmentalReverbRoomLevelTest::ParamType>& info) {
            ...
            address << "factory_" << instance.first.get();
            std::string name = address.str() + "_roomLevel" + roomLevel;
            std::replace_if(
...
INSTANTIATE_TEST_SUITE_P(
        ...
        [](const testing::TestParamInfo<EnvironmentalReverbRoomHfLevelTest::ParamType>& info) {
            ...
            std::ostringstream address;
            address << "factory_" << instance.first.get();
            std::string name = address.str() + "_roomHfLevel" + roomHfLevel;
            std::replace_if(
                    name.begin(), name.end(), [](const char c) { return !std::isalnum(c); }, '_');
            return name;
        });
...
INSTANTIATE_TEST_SUITE_P(
        ...
        [](const testing::TestParamInfo<EnvironmentalReverbDecayTimeTest::ParamType>& info) {
            ...
            std::ostringstream address;
            address << "factory_" << instance.first.get();
            std::string name = address.str() + "_decayTime" + decayTime;
            std::replace_if(
                    name.begin(), name.end(), [](const char c) { return !std::isalnum(c); }, '_');
            return name;
        });
...
INSTANTIATE_TEST_SUITE_P(
        ...
        [](const testing::TestParamInfo<EnvironmentalReverbDecayHfRatioTest::ParamType>& info) {
            ...
            std::ostringstream address;
            address << "factory_" << instance.first.get();
            std::string name = address.str() + "_decayHfRatio" + decayHfRatio;
            std::replace_if(
                    name.begin(), name.end(), [](const char c) { return !std::isalnum(c); }, '_');
            return name;
        });
...
INSTANTIATE_TEST_SUITE_P(
        ...
        [](const testing::TestParamInfo<EnvironmentalReverbDecayHfRatioTest::ParamType>& info) {
            ...
            std::ostringstream address;
            address << "factory_" << instance.first.get();
            std::string name = address.str() + "_level" + level;
            std::replace_if(
                    name.begin(), name.end(), [](const char c) { return !std::isalnum(c); }, '_');
            return name;
        });
...
INSTANTIATE_TEST_SUITE_P(
        ...
        [](const testing::TestParamInfo<EnvironmentalReverbDelayTest::ParamType>& info) {
            ...
            std::ostringstream address;
            address << "factory_" << instance.first.get();
            std::string name = address.str() + "_delay" + delay;
            std::replace_if(
                    name.begin(), name.end(), [](const char c) { return !std::isalnum(c); }, '_');
            return name;
        });
...
INSTANTIATE_TEST_SUITE_P(
        ...
        [](const testing::TestParamInfo<EnvironmentalReverbDiffusionTest::ParamType>& info) {
            ...
            std::ostringstream address;
            address << "factory_" << instance.first.get();
            std::string name = address.str() + "_diffusion" + diffusion;
            std::replace_if(
                    name.begin(), name.end(), [](const char c) { return !std::isalnum(c); }, '_');
            return name;
        });
...
INSTANTIATE_TEST_SUITE_P(
        ...
        [](const testing::TestParamInfo<EnvironmentalReverbDensityTest::ParamType>& info) {
            ...
            std::ostringstream address;
            address << "factory_" << instance.first.get();
            std::string name = address.str() + "_density" + density;
            std::replace_if(
                    name.begin(), name.end(), [](const char c) { return !std::isalnum(c); }, '_');
            return name;
        });
...
INSTANTIATE_TEST_SUITE_P(
        ...
        [](const testing::TestParamInfo<EnvironmentalReverbBypassTest::ParamType>& info) {
            ...
            std::ostringstream address;
            address << "factory_" << instance.first.get();
            std::string name = address.str() + "_bypass" + bypass;
            std::replace_if(
                    name.begin(), name.end(), [](const char c) { return !std::isalnum(c); }, '_');
            return name;
        });
