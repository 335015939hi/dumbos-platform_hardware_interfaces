...
std::vector<ParamTagValuePair> reverbParams = {
        {EnvironmentalReverb::decayTimeMs, {100, 500, 1500, 2000}},
        {EnvironmentalReverb::roomLevelMb, {-3000, -2000, -1000, -500, 0}},
        {EnvironmentalReverb::decayHfRatioPm, {100, 150, 200, 500, 600, 1000}},
        {EnvironmentalReverb::roomHfLevelMb, {-4000, -2000, -1000, -500, 0}},
        {EnvironmentalReverb::levelMb, {-6000, -3000, -2000, -1000, -500, 0}}};
...
INSTANTIATE_TEST_SUITE_P(
        ...
        [](const testing::TestParamInfo<MinimumParamValueTest::ParamType>& info) {
            ...
            std::ostringstream oss;
            oss << static_cast<int>(val.first);
            std::string name = getPrefix(descriptor) + "Tag_00" + oss.str();
