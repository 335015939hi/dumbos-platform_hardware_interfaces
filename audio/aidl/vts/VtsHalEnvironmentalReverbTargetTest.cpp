...
using ParamTagValuePair =
        std::pair<aidl::android::hardware::audio::effect::EnvironmentalReverb::Tag,
                  std::vector<int>>;
using TagMinValuePair =
        std::pair<aidl::android::hardware::audio::effect::EnvironmentalReverb::Tag, int>;
...
TEST_P(EnvironmentalReverbDecayTimeTest, SetAndGetDecayTime) {
    createEnvParam(EnvironmentalReverb::decayTimeMs, mDecayTime);
    ASSERT_NO_FATAL_FAILURE(
            setAndVerifyParam(isParamValid(mEnvParam) ? EX_NONE : EX_ILLEGAL_ARGUMENT, mEnvParam,
...
TEST_P(EnvironmentalReverbHfRatioTest, SetAndGetHfRatio) {
    createEnvParam(EnvironmentalReverb::decayHfRatioPm, mHfRatio);
    ASSERT_NO_FATAL_FAILURE(
            setAndVerifyParam(isParamValid(mEnvParam) ? EX_NONE : EX_ILLEGAL_ARGUMENT, mEnvParam,
...
TEST_P(EnvironmentalReverbRoomLevelTest, SetAndGetRoomLevel) {
    createEnvParam(EnvironmentalReverb::roomLevelMb, mRoomLevel);
    ASSERT_NO_FATAL_FAILURE(
            setAndVerifyParam(isParamValid(mEnvParam) ? EX_NONE : EX_ILLEGAL_ARGUMENT, mEnvParam,
...
TEST_P(EnvironmentalReverbLevelTest, SetAndGetLevel) {
    createEnvParam(EnvironmentalReverb::levelMb, mLevel);
    ASSERT_NO_FATAL_FAILURE(
            setAndVerifyParam(isParamValid(mEnvParam) ? EX_NONE : EX_ILLEGAL_ARGUMENT, mEnvParam,
...
TEST_P(EnvironmentalReverbHfLevelTest, SetAndGetHfLevel) {
    createEnvParam(EnvironmentalReverb::roomHfLevelMb, mRoomHfLevel);
    ASSERT_NO_FATAL_FAILURE(
            setAndVerifyParam(isParamValid(mEnvParam) ? EX_NONE : EX_ILLEGAL_ARGUMENT, mEnvParam,
...
TEST_P(EnvironmentalReverbDelayTest, SetAndGetDelay) {
    createEnvParam(EnvironmentalReverb::delayMs, mDelay);
    ASSERT_NO_FATAL_FAILURE(
            setAndVerifyParam(isParamValid(mEnvParam) ? EX_NONE : EX_ILLEGAL_ARGUMENT, mEnvParam,
...
TEST_P(EnvironmentalReverbDensityTest, SetAndGetDensity) {
    createEnvParam(EnvironmentalReverb::densityPm, mDensity);
    ASSERT_NO_FATAL_FAILURE(
            setAndVerifyParam(isParamValid(mEnvParam) ? EX_NONE : EX_ILLEGAL_ARGUMENT, mEnvParam,
...
TEST_P(EnvironmentalReverbDiffusionTest, SetAndGetDiffusion) {
    createEnvParam(EnvironmentalReverb::diffusionPm, mDiffusion);
    ASSERT_NO_FATAL_FAILURE(
            setAndVerifyParam(isParamValid(mEnvParam) ? EX_NONE : EX_ILLEGAL_ARGUMENT, mEnvParam,
