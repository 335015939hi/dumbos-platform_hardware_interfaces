...
class EnvironmentalReverbHelper : public EffectHelper {
  public:
    ...
    static std::vector<int> getRoomLevelValues() {
    ...
    static std::vector<int> getRoomHfLevelValues() {
        auto descList = EffectFactoryHelper::getAllEffectDescriptors(IFactory::descriptor,
                                                                     kEnvReverbTypeUUID);
    ...
    static std::vector<int> getDecayTimeValues() {
        auto descList = EffectFactoryHelper::getAllEffectDescriptors(IFactory::descriptor,
                                                                     kEnvReverbTypeUUID);
    ...
    static std::vector<int> getDecayHfRatioValues() {
        auto descList = EffectFactoryHelper::getAllEffectDescriptors(IFactory::descriptor,
                                                                     kEnvReverbTypeUUID);
    ...
    static std::vector<int> getLevelValues() {
        auto descList = EffectFactoryHelper::getAllEffectDescriptors(IFactory::descriptor,
                                                                     kEnvReverbTypeUUID);
    ...
    static std::vector<int> getDelayValues() {
        auto descList = EffectFactoryHelper::getAllEffectDescriptors(IFactory::descriptor,
                                                                     kEnvReverbTypeUUID);
        const auto max = std::max_element(
                descList.begin(), descList.end(),
    ...
    static std::vector<int> getDiffusionValues() {
        auto descList = EffectFactoryHelper::getAllEffectDescriptors(IFactory::descriptor,
                                                                     kEnvReverbTypeUUID);
        const auto max = std::max_element(
                descList.begin(), descList.end(),
    ...
    static std::vector<int> getDensityValues() {
        auto descList = EffectFactoryHelper::getAllEffectDescriptors(IFactory::descriptor,
                                                                     kEnvReverbTypeUUID);
        const auto max = std::max_element(
                descList.begin(), descList.end(),
