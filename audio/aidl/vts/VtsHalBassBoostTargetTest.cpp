...
const std::vector<int> kStrengthValues = {MIN_STRENGTH - 1, MIN_STRENGTH, MAX_STRENGTH,
                                          MAX_STRENGTH + 2};
...
class BassBoostParamTest : public ::testing::TestWithParam<BassBoostParamTestParam>,
  ...
  public:
    ...
    Parameter::Specific getDefaultParamSpecific() {
        BassBoost bb = BassBoost::make<BassBoost::strengthPm>(MIN_STRENGTH);
    ...
    int mParamStrength = MIN_STRENGTH;
    ...
    bool isStrengthInRange(const BassBoost::Capability& cap, int strength) const {
        return cap.strengthSupported && strength >= MIN_STRENGTH && strength <= MAX_STRENGTH;
    }
