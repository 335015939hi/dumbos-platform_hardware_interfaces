        ...
        for (const auto& criterionRule : rule.criterionRules) {
            ...
            switch (selectionCriterion.getTag()) {
                ...
                case AudioHalCapCriterionV2::forceUseForCommunication: {
                    ...
                    validateAudioHalCapRule(
                            matchingCriterion
                                    .get<AudioHalCapCriterionV2::forceUseForCommunication>(),
                ...
                case AudioHalCapCriterionV2::forceUseForMedia: {
                    EXPECT_EQ(criterionValue.getTag(), TypeTag::forcedConfigType);
                    validateAudioHalCapRule(
                            matchingCriterion.get<AudioHalCapCriterionV2::forceUseForMedia>(),
                            criterionValue.get<TypeTag::forcedConfigType>(), matchesWhen);
                    break;
                }
                case AudioHalCapCriterionV2::forceUseForRecord: {
                    EXPECT_EQ(criterionValue.getTag(), TypeTag::forcedConfigType);
                    validateAudioHalCapRule(
                            matchingCriterion.get<AudioHalCapCriterionV2::forceUseForRecord>(),
                            criterionValue.get<TypeTag::forcedConfigType>(), matchesWhen);
                    break;
                }
                case AudioHalCapCriterionV2::forceUseForDock: {
                    EXPECT_EQ(criterionValue.getTag(), TypeTag::forcedConfigType);
                    validateAudioHalCapRule(
                            matchingCriterion.get<AudioHalCapCriterionV2::forceUseForDock>(),
                            criterionValue.get<TypeTag::forcedConfigType>(), matchesWhen);
                    break;
                }
                case AudioHalCapCriterionV2::forceUseForSystem: {
                    EXPECT_EQ(criterionValue.getTag(), TypeTag::forcedConfigType);
                    validateAudioHalCapRule(
                            matchingCriterion.get<AudioHalCapCriterionV2::forceUseForSystem>(),
                            criterionValue.get<TypeTag::forcedConfigType>(), matchesWhen);
                    break;
                }
                case AudioHalCapCriterionV2::forceUseForHdmiSystemAudio: {
                    ...
                    validateAudioHalCapRule(
                            matchingCriterion
                                    .get<AudioHalCapCriterionV2::forceUseForHdmiSystemAudio>(),
                            criterionValue.get<TypeTag::forcedConfigType>(), matchesWhen);
                    break;
                }
                case AudioHalCapCriterionV2::forceUseForEncodedSurround: {
                    ...
                    validateAudioHalCapRule(
                            matchingCriterion
                                    .get<AudioHalCapCriterionV2::forceUseForEncodedSurround>(),
                            criterionValue.get<TypeTag::forcedConfigType>(), matchesWhen);
                    break;
                }
                case AudioHalCapCriterionV2::forceUseForVibrateRinging: {
                    ...
                    validateAudioHalCapRule(
                            matchingCriterion
                                    .get<AudioHalCapCriterionV2::forceUseForVibrateRinging>(),
                            criterionValue.get<TypeTag::forcedConfigType>(), matchesWhen);
                    break;
                }
                default:
