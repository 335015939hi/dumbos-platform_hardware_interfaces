...
union LoudnessEnhancer {
    ...
    /**
     * Capability MUST be supported by LoudnessEnhancer implementation.
     */
    @VintfStability
    ...
    /**
     * The maximum gain in megabel (mB) applied applied to the signal to process, default value is
     * 0.
     */
    int gainMb;
}
