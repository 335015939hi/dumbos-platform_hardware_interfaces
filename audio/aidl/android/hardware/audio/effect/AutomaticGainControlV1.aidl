...
union AutomaticGainControlV1 {
     ...
     * scale).
     * Must be in range of AutomaticGainControlV1.Capability.targetLevelDbFsRange.
     */
    int targetLevelDbFs;
    /*
     ...
     * Must be in range of AutomaticGainControlV1.Capability.compressionGainDbRange.
     */
