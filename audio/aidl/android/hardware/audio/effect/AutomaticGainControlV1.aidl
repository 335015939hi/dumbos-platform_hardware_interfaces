...
union AutomaticGainControlV1 {
    ...
    parcelable Capability {
        ...
        /**
         * Range of targetLevelDbFs supported by implementation.
         */
        Range.Int targetLevelDbFsRange;
        /**
         * Range of compressionGainDb supported by implementation.
         */
        Range.Int compressionGainDbRange;
    }

    /**
     * Target peak level (or envelope) of the AGC implementation in dBFs (decibels from digital
     * full-scale).
     * Must in range of AutomaticGainControlV1.Capability.targetLevelDbFsRange.
     */
    int targetLevelDbFs;
    /*
     ...
     * Must in range of AutomaticGainControlV1.Capability.compressionGainDbRange.
     */
