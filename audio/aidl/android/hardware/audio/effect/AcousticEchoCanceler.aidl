...
union AcousticEchoCanceler {
     ...
     * Must never be negative, and not larger than maxEchoDelayMs in capability.
     */
    int echoDelayMs;
    /**
     * If AEC mobile mode enabled.
     * Can only be false if AEC implementation indicate not support modile mode by set
