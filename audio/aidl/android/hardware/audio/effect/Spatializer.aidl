 ...
 *
 * A Spatializer implementation must report the support range of  parameter with Capability.Range.
 * spatializer.
 *
 * See more detals about Range in Range.aidl.
 */
@VintfStability
union Spatializer {
    /**
    ...
    /**
     * Vendor extension implementation definition for additional parameters.
     */
    VendorExtension vendor;

    /**
     * The level of spatialization.
     * Align with SpatializationLevel.aidl in android.media package.
     */
    @VintfStability
    @Backing(type="byte")
    enum Level {
    ...
    /**
     * Foldable device hinge angle as a float value in radians.
     */
    float hingeAngle;
