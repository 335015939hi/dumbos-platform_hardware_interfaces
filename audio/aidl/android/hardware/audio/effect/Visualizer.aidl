...
union Visualizer {
    ...
    union GetOnlyParameters {
        ...
        /**
         * Gets the latest captureSamples of PCM samples (8 bits per sample) as std::vector.
         */
    ...
    /**
     * Current capture size in sample. The capture size must be in Capability.captureSizeRange.
     */
    int captureSamples;
    /**
