...
parcelable Capability {
     ...
     * This extension can be used when vendor have a new effect implementation and need
     ...
     * the ParcelableHolder in each effect definition. For example: Equalizer.vendorExtension.
     */
