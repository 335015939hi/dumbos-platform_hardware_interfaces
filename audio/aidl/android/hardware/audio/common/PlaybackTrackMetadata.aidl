...
import android.media.audio.common.AudioContentTypeStable;
import android.media.audio.common.AudioUsageStable;
...
parcelable PlaybackTrackMetadata {
    AudioUsageStable usage = AudioUsageStable.INVALID;
    AudioContentTypeStable contentType = AudioContentTypeStable.UNKNOWN;
    /**
