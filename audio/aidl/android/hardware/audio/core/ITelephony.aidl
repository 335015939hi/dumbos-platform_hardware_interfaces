...
interface ITelephony {
    ...
    parcelable TelecomConfig {
         ...
         */
        @nullable TtyModeWrapper ttyMode;
        /**
     ...
     * unset must retain their current values. In the returned parcelable, all
     * parameter fields known to the HAL module must be populated to their
     * current values. The client can pass an unitialized parcelable in order to
