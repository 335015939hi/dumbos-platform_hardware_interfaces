...
interface IModule {
     ...
     *
     * If the HAL module supports Bluetooth the SCO Link and Hands-Free Profile
     * functionality, it must return an instance of the IBluetooth
     * interface. The same instance must be returned during the lifetime of the
     * HAL module. If the HAL module does not support BT SCO, a null must be
     * returned, without throwing any errors.
     *
