...
interface IModule {
     ...
     *
     * This method is used to inform the HAL module that disconnectExternalDevice(int) will
     * be called soon. The HAL module can rely on this method to abort active data operations
