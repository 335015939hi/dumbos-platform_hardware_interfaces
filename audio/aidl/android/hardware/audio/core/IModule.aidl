...
interface IModule {
     ...
     * to 2.0f.
     *
     * @param minSpeed The minimum allowed speed factor.
     * @param maxSpeed The maximum allowed speed factor.
     * @param minPitch The minimum allowed pitch factor.
     * @param maxPitch The maximum allowed pitch factor.
     * @throws EX_UNSUPPORTED_OPERATION If setting of playback rate parameters
     *                                  is not supported by the module.
     */
    void getSupportedPlaybackRateFactors(
            out Float minSpeed, out Float maxSpeed, out Float minPitch, out Float maxPitch);
