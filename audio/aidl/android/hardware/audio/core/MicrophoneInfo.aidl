...
/**
 * Structure providing information on a microphone. It indicates the location
 * and orientation of the microphone on the device as well as useful information
