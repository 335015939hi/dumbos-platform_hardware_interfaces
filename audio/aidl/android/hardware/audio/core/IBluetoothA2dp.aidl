 ...
 * Distribution Profile) profiles. This interface is optional to implement and
...
interface IBluetoothA2dp {
     ...
     *
     * @param parameter Optional vendor-specific parameters.
     * @throw EX_UNSUPPORTED_OPERATION If the module does not support codec reconfiguration.
     */
    void reconfigureOffload(in @nullable VendorParameter[] parameters);
}
