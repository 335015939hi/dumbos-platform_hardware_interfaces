...
interface IBluetooth {
    ...
    parcelable ScoConfig {
         ...
         */
        @nullable Boolean isWidebandEnabled;
        /**
         * The name of the BT SCO headset used for debugging purposes. Can be
         * empty.
         */
     ...
     *
     * The client can pass an unitialized parcelable in order to retrieve the
