...
interface IComponentListener {
     ...
     */
    oneway void onError(in Status status, in int errorCode);
     ...
     */
    oneway void onFramesRendered(in RenderedFrame[] renderedFrames);
     ...
     */
    oneway void onInputBuffersReleased(in InputBuffer[] inputBuffers);
     ...
     */
    oneway void onTripped(in SettingResult[] settingResults);
     ...
     */
    oneway void onWorkDone(in WorkBundle workBundle);
}
