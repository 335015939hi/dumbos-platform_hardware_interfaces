...
interface IGraphicBufferAllocator {
     ...
     *
     * File descriptors are checked whether there are events using ::poll for readable status.
     * Specifically \p ready is used for waiting until being ready to allocate.
