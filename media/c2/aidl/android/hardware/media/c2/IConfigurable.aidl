...
import android.hardware.media.c2.ConfigResult;
...
interface IConfigurable {
     ...
     */
    ConfigResult config(in byte[] inParams, in boolean mayBlock);
     ...
     * @param mayBlock Whether this call may block or not.
     * @return Flattened representation of C2Param objects.
     * @throws ServiceSpecificException with one of the following values:
     ...
     *   - `Status::CORRUPTED` - Some unknown error occurred.
     */
    byte[] query(in int[] indices, in boolean mayBlock);
