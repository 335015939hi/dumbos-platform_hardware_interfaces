<<<<<<< TARGET BRANCH (2ed3dd [automerger skipped] Merge "vts: supplicant: Remove optional)
=======
/*
...
>>>>>>> SOURCE BRANCH (a30a31 Merge "omx: validate only standard OMX roles" into android11)
