...
import android.hardware.contexthub.MotionEvent;
import android.hardware.contexthub.MotionSubscription;

@VintfStability
interface IUnifiedMotionContextCallback {
    /**
    ...
    /**
     * Callback to alert the client when the UMC service is disconnected or unavailable.
     */
    void onDisconnect();
}