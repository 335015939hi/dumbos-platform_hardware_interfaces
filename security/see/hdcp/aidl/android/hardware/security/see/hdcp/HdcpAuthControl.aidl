...
interface IHdcpAuthControl {
     ...
     *       + ERROR_HDCP_LEVEL_INVALID if the requested HDCP |level| is greater
     *               than |HdcpLevels.maxLevel|
     ...
     * @return:
     *     Implicit error codes:
     *       + ERROR_HDCP_LEVEL_NO_PENDING when there is no outstanding pending
     *               HDCP level request
     *
     */
