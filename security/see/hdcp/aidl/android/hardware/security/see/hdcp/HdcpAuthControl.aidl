...
interface IHdcpAuthControl {
     ...
     *       + ERROR_HDCP_INVALID if the requested HDCP level is greater
     *               than maxHdcpLevel (see getLevels)
     *       + ERROR_HDCP_NOT_SUPPORTED if HDCP auth level cannot be controlled
     *
     */
     ...
     * @return:
     *     Implicit error codes:
     *       + ERROR_HDCP_NO_PENDING when there is no outstanding pending HDCP
     *               level request
     *
     */
