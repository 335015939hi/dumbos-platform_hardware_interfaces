 ...
 * and increments the `global sequence number`. A client's unique identifier is the combination of
 * the instance's sequence number and the client's sequence number.
 */
@VintfStability
