...
/**
 * DICE certificate chain - CBOR encoded according to ExplicitKeyDiceCertChain.cddl from
...
parcelable ExplicitKeyDiceCertChain {
    /* Data is CBOR encoded according to the CDDL in ExplicitKeyDiceCertChain.cddl */
    byte[] diceCertChain;
}
