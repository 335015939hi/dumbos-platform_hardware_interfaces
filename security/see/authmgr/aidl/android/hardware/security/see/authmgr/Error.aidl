...
enum Error {
    ...
    CONNECTION_HANDOVER_FAILED = -7,
    /**
     * An authentication requred request (e.g. phase 2) is invoked on a non-authenticated
     * connection
     */
    CONNECTION_NOT_AUTHENTICATED = -8,
    /* There is no pending connection to authorize in phase 2 */
    NO_CONNECTION_TO_AUTHORIZE = -9,
}
