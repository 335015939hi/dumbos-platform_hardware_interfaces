...
/*
 * parcelable SymmetricOperationParameters - Parameters needed to perform symmetric cryptographic
 *                                           operations.
 *
 * @key:
 ...
 * @parameters:
 *      Parameters that specify the desired cryptographic operation.
 */
