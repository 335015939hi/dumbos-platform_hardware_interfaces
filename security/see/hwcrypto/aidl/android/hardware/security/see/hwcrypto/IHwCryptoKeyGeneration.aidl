...
interface IHwCryptoKeyGeneration {
    ...
    /*
     * import_wrapped_key() - Imports a previosly exported wrapped key.
     *
     * @key_to_be_imported:
     *     key to be imported.
     * @wrapping_key:
    ...
    HwCryptoKeyResult import_wrapped_key(
            in byte[] key_to_be_imported, in HwCryptoKeyMaterial wrapping_key);
    ...
    VectorResult export_wrapped_key(
            in HwCryptoKeyMaterial key_to_be_exported, in HwCryptoKeyMaterial wrapping_key);
