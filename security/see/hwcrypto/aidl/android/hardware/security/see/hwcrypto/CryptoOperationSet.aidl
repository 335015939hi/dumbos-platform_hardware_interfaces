...
/*
 * parcelable CryptoOperationSet - Type that describes a set of crypto operations to execute
 *
 * @context:
 *      Context to be used to issue the operations. If NULL, a new context will be created and
 *      returned.
 * @operations:
