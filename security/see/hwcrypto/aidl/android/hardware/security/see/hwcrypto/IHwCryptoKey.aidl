...
interface IHwCryptoKey {
    ...
    /*
     * process_command_list() - Executes a list of cryptographic commands in order
     *
     * @operations:
     ...
     */
    CryptoOperationResult[] process_command_list(inout CryptoOperationSet[] operations,
            out CryptoOperationErrorAdditionalInfo additional_error_info);
}
