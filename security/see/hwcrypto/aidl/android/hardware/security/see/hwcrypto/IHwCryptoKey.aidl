...
interface IHwCryptoKey {
     ...
     * @import_domain:
     *     domain where we want to import the new key (HW Block, Secure Execution Enviroment,
     *     SW library).
     *
     * Return:
     ...
     * @key_implementation:
     *     domain that should create the key (HW Block, Secure Execution Enviroment, SW library).
     *
     * Return:
     *      Ok(HwCryptoKeyMaterial) on success, Err(HAlErrorCode) on error.
     */
