...
interface IHwCryptoDeviceKeyAccess {
     ...
     *     When implementing this function, this parameter shall be one of the components feeded
     *     to the KDF and it needs to be checked against the caller DICE certificate before
     *     being used.
     * @context:
