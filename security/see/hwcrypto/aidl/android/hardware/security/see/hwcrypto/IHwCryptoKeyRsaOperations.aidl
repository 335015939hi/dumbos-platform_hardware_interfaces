...
import android.hardware.security.see.hwcrypto.base_types.RsaDecryptParameters;
...
interface IHwCryptoKeyRsaOperations {
    ...
    AccumulatingOperationResult begin_sign(
            in OpaqueKeyMaterial key, in RsaSignParameters parameters);
    ...
    VectorResult get_public_key(in OpaqueKeyMaterial key);
}
