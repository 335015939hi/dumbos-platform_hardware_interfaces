...
/*
 * parcelable CryptoOperationErrorAdditionalInfo - Type that provides more information about
 *                                                 failures when processing a list of commands.
 *
 * @failing_command:
 *      Index indicating the first failing step on a set of commands. No more commands would have
 *      been executed after this one failed.
 */
