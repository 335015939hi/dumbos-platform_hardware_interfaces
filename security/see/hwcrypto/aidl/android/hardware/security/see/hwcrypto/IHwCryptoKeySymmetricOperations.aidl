...
interface IHwCryptoKeySymmetricOperations {
     ...
     */
    IEmittingOperation begin(in OpaqueKeyMaterial key, in SymmetricOperation direction,
     ...
     */
    IAeadOperation begin_aead(in OpaqueKeyMaterial key, in SymmetricOperation direction,
     ...
     *      Ok(IEmittingOperation) on success, specific error code on error.
     */
    IDmaEmittingOperation begin_dma(in OpaqueKeyMaterial key, in SymmetricOperation direction,
            in SymmetricCryptoParameters parameters);
     ...
     *      Ok(IAeadOperation) on success, specific error code on error.
     */
    IDmaAeadOperation begin_dma_aead(in OpaqueKeyMaterial key, in SymmetricOperation direction,
            in SymmetricAuthCryptoParameters parameters);
}
