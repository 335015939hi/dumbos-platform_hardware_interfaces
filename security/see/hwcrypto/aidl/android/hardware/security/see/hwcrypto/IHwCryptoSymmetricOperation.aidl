...
/*
 * interface IHwCryptoSymmetricOperation - Interface used to start different symmetric cryptographic
 *                                         operations.
 *
 */
interface IHwCryptoSymmetricOperation {
    /*
    ...
    /*
     * begin_aead() - start an authenticated encryption with additional data cryptographic
     *                operation.
     * @key:
     *      key to be used on the operation
     * @parameters:
    ...
    /*
     * begin_dma_aead() - start an authenticated encryption with additional data cryptographic
     *                operation using DMA.
     * @key:
     *      key to be used on the operation
     * @parameters:
