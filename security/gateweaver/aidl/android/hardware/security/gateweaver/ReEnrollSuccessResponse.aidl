 ...
 * Note: we do not include the arc encrypting the new K_cred here, because it needs to be obtaiend
 * by calling "verify", similar to how "create" is followed by "verify".
 */
@VintfStability
@RustDerive(Clone=true, Eq=true, PartialEq=true)
parcelable ReEnrollSuccessResponse {
    Arc newGWBlob;
