...
interface IGateWeaver {
     ...
     *                    that this GW blob wa created in (e.g. hash of the GW's DICE policy)
     *
     ...
     *
     * @return arc from step 8.ii on success or the corresponding error response on failures as
     * described above
     */
