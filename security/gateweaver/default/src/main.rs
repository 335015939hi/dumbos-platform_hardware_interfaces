...
fn main() {
    ...
    let service = GateWeaverService::new_as_binder(gw_channel, ke_channel, km_channel);
    ...
    info!("Registered GateWeaver service, joining threadpool.");
