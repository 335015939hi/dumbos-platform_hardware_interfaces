 ...
 *     2. a policy specifying hsow to verify the certificate chain - if a policy is not provided,
 ...
 *        1. Retain access to persistent resources from the newer versions of the same party who
 *           created them, even when parts of the cerificate chain are updated in the new version.
 *        2. Deny access to the new persistent resources from the older versions of the same party
