...
interface IAuthGraphCommon {
     ...
     *
     * ErrorCode::OPERATION_NOT_SUPPORTED must be returned if the method is not implemented.
     *
     ...
     * channel keys agreed by the two domains.
     ...
     * These outputs are included in the returned type CreateChannelResult.
     *
     ...
     *        keys via ECDH.
     *
     * @param initChannelResult: InitChannelResult if it was returned in initiChannel() method.
     *
     ...
     * transcript. The updated channel arcs are returned in VerifyChannelResult.
     *
     ...
     *        transcript.
     *
     * @param createChannelResult: CreateChannelResult if it was returned in createChannel() method.
     *
     * @return VerifyChannelResult
     */
    VerifyChannelResult verifyChannel(in byte[] signatureOfOtherParty,
            in @nullable CreateChannelResult createChannelResult);
}
