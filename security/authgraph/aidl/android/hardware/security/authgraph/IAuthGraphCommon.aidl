...
interface IAuthGraphCommon {
     ...
     * transcript. The updated and finalized channel arcs are returned in VerifyChannelResult.
     *
     ...
     */
    FinalizeChannelResult finalizeChannel(in byte[] signatureOfOtherParty,
