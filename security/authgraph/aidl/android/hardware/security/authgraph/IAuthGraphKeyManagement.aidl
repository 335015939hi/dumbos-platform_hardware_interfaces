...
interface IAuthGraphKeyManagement {
    /*
     * This operation creates a new secret key and then returns a persistent arc
     ...
     *    then CHECK that limitations of the childArcCaps is greater then or equal
     ...
     *         childArcCaps then the one in later is less then or equal to the
     *         former.
     *       - CHECK that if maxUsageCount constraint is defined in both
     *         wrappingArc and childArcCaps then the one in later is less then or
     *         equal to the former.
     *
     ...
     *              of the wrappingArc and adding new permissions and limitations
     *              to it from childArcCaps as follows:
     ...
     *           arc such that resulting limitation set is equal to or more then
     ...
     *        - Else
                  ...
                  less then destArc e.g. if sourceArc has SinkId specified and
     ...
     */
    android.hardware.security.authgraph.Arc(in android.hardware.security.authgraph.Arc sourceArc,
