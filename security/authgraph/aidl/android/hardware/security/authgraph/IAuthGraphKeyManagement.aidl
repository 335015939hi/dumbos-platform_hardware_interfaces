...
interface IAuthGraphKeyManagement {
     ...
     *    9. Extract a cryptographic secret S from Z, using the nonce created in step #7 as the
     *       salt
     ...
     *   15. Create an arc that encrypts the symmetric encryption key derived in step #10s with
