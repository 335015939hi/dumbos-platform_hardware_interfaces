...
interface IAuthGraphKeyManagement {
    /*
     * This method creates a new arc with capabilties derived from wrappingArc
     ...
     *    greater then or equal to parentArc's limitations as follows:
     ...
     *    permission then it is euqal to and destArc's sinkId policy.
