...
interface IAuthGraphKeyManagement {
     ...
     *            i. CHECK whether `channelKey` is an arc that is encrypted with the source's
     *               per-boot key and has KeyType = ChannelKey and "sink_id" in the protected
     *               headers.
     ...
     *                   b. CHECK whether the "sink_id" in the protected headers of `channelKey` in
     ...
     *                   d. Create an AuthKeyPackage to be returned to the caller, with `channelKey`
