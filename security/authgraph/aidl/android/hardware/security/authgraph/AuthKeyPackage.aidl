...
/**
 * AuthKeyPackage holds the mapping between the shared key setup between a source and a sink via the
...
parcelable AuthKeyPackage {
    /**
     * The arc that encrypts the shared key setup between the source and the sink, with the source's
     * per-boot key.
     */
    Arc channelKey;
    /**
