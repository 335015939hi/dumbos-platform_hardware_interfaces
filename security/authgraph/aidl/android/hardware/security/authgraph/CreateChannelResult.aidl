...
parcelable CreateChannelResult {
    ...
    /**
     * The arc from the derived outgoing channel key to a hello message, concatenated with the
     * timestamp. This is to verify the created channel keys are usable.
     */
    byte[] encryptedHelloMessage;
}
