...
union PubKey {
    ...
    /**
     * Public key signed with the long term signing key of the domain. This variant is used during
     * the key exchange protocol, where the peers identity need to be verified.
     */
