...
interface IAuthGraphKeyExchange {
     ...
     *        If `ownKey` is not in the in-memory reocords for unfinished instances of a key
     *        agreement protocol, return error: INVALID_KE_KEY. Similarly, if the public key or the
