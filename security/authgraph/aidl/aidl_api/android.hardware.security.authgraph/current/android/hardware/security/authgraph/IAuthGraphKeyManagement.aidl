...
interface IAuthGraphKeyManagement {
  android.hardware.security.authgraph.SourceKey createOrUnlockSourceKeys(in android.hardware.security.authgraph.Arc credKey, in android.hardware.security.authgraph.SourceKey sourceKey);
  ...
  android.hardware.security.authgraph.KeyWrappingKeyPackage recoverKeyWrappingKeyWithKeyExchange(in android.hardware.security.authgraph.Arc sharedKey, in android.hardware.security.authgraph.Arc authKey, in android.hardware.security.authgraph.KeyWrappingKeyDeriveInfo keyWrappingKeyDeriveInfo);
  android.hardware.security.authgraph.KeyWrappingKeyPackage recoverKeyWrappingKey(in android.hardware.security.authgraph.Arc sharedKey, in android.hardware.security.authgraph.Arc authKey, in android.hardware.security.authgraph.Arc keyWrappingKeyHandle);
}
