...
interface IAuthGraphKeyManagement {
  android.hardware.security.authgraph.Arc create(in android.hardware.security.authgraph.Arc wrappingArc, in @nullable android.hardware.security.authgraph.Capability caps, in android.hardware.security.authgraph.Role role);
