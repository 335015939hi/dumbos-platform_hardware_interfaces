...
interface IAuthGraphKeyManagement {
  ...
  android.hardware.security.authgraph.KeyWrappingKeyPackage createKeyWrappingKeyWithKeyExchange(in android.hardware.security.authgraph.Arc primaryExchangePubKey);
  ...
  android.hardware.security.authgraph.KeyWrappingKeyPackage recoverKeyWrappingKeyWithKeyExchange(in android.hardware.security.authgraph.KeyWrappingKeyDeriveInfo keyWrappingKeyInfo, in android.hardware.security.authgraph.Arc sharedKey, in android.hardware.security.authgraph.Arc authKey);
