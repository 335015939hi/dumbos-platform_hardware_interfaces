...
fn test_nonsecure_source_mainline() {
    vts::source::test_mainline(require_nonsecure!());
}
#[test]
fn test_nonsecure_source_corrupt_sig() {
    vts::source::test_corrupt_sig(require_nonsecure!());
}
#[test]
fn test_nonsecure_source_corrupt_keys() {
    vts::source::test_corrupt_key(require_nonsecure!());
}
#[test]
fn test_nonsecure_sink_mainline() {
    vts::sink::test_mainline(require_nonsecure!());
}
#[test]
fn test_nonsecure_sink_corrupt_sig() {
    vts::sink::test_corrupt_sig(require_nonsecure!());
}
#[test]
fn test_nonsecure_sink_corrupt_keys() {
    vts::sink::test_corrupt_keys(require_nonsecure!());
}
