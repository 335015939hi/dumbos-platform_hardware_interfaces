...
using all_tags_t = MetaList<
        ...
        TAG_ORIGINATION_EXPIRE_DATETIME_t, TAG_USAGE_EXPIRE_DATETIME_t, TAG_MAX_USES_PER_BOOT_t,
        TAG_USAGE_COUNT_LIMIT_t, TAG_USER_ID_t, TAG_USER_SECURE_ID_t, TAG_NO_AUTH_REQUIRED_t,
        TAG_AUTH_TIMEOUT_t, TAG_ALLOW_WHILE_ON_BODY_t, TAG_UNLOCKED_DEVICE_REQUIRED_t,
        TAG_APPLICATION_ID_t, TAG_APPLICATION_DATA_t, TAG_CREATION_DATETIME_t,
        TAG_ROLLBACK_RESISTANCE_t, TAG_HARDWARE_TYPE_t, TAG_ROOT_OF_TRUST_t, TAG_NONCE_t,
