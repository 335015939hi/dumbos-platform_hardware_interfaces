...
using all_tags_t = MetaList<
        ...
        TAG_UNLOCKED_DEVICE_REQUIRED_t, TAG_APPLICATION_DATA_t, TAG_CREATION_DATETIME_t,
        TAG_ROLLBACK_RESISTANCE_t, TAG_HARDWARE_TYPE_t, TAG_ROOT_OF_TRUST_t, TAG_ASSOCIATED_DATA_t,
        ...
        TAG_ATTESTATION_ID_MANUFACTURER_t, TAG_ATTESTATION_ID_MODEL_t, TAG_ATTESTATION_ID_SERIAL_t,
        TAG_ATTESTATION_ID_IMEI_t, TAG_ATTESTATION_ID_MEID_t, TAG_RESET_SINCE_ID_ROTATION_t,
        TAG_PURPOSE_t, TAG_ALGORITHM_t, TAG_BLOCK_MODE_t, TAG_DIGEST_t, TAG_PADDING_t, TAG_ORIGIN_t,
