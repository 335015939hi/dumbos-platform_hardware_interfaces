...
void KeyMintAttestationFuzzer::generateAttestKey(const AuthorizationSet& keyDesc,
                                                 ...
                                                 vector<KeyCharacteristics>* keyCharacteristics,
                                                 vector<Certificate>* certChain) {
    AuthorizationSet keyDescAttest = keyDesc;
    keyDescAttest.push_back(TAG_PURPOSE, KeyPurpose::ATTEST_KEY);
    generateKey(keyDescAttest, attestKey, keyBlob, keyCharacteristics, certChain);
}
...
void KeyMintAttestationFuzzer::process() {
    ...
    generateAttestKey(createAuthSetForAttestKey(&mFdp), {}, &attestKey.keyBlob,
