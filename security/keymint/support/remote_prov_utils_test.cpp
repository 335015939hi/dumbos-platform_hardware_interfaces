...
TEST(RemoteProvUtilsTest, compareUdsPubFromAuthenticatedRequests) {
    ...
    auto udsPub1 = getUdsPubFromAuthenticatedRequest(kCsrWithSharedUdsRoot1, "default");
    ASSERT_TRUE(udsPub1) << "Error: " << udsPub1.message();

    auto udsPub2 = getUdsPubFromAuthenticatedRequest(kCsrWithSharedUdsRoot2, "strongbox");
