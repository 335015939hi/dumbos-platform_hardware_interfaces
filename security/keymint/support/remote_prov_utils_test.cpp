...
inline const std::vector<uint8_t> kX25519Eek{
        };

inline const std::vector<uint8_t> kX25519EekId{0xd0, 0xae, 0xc1, 0x15, 0xca, 0x2a, 0xcf, 0x73,
                                               0xae, 0x6b, 0xcc, 0xcb, 0xd1, 0x96, 0x1d, 0x65,
                                               0xe8, 0xb1, 0xdd, 0xd7, 0x4a, 0x1a, 0x37, 0xb9,
                                               0x43, 0x3a, 0x97, 0xd5, 0x99, 0xdf, 0x98, 0x08};

inline const std::vector<uint8_t> kX25519EekPublic{0xbe, 0x85, 0xe7, 0x46, 0xc4, 0xa3, 0x42, 0x5a,
                                                   0x40, 0xd9, 0x36, 0x3a, 0xa6, 0x15, 0xd0, 0x2c,
                                                   0x58, 0x7e, 0x3d, 0xdc, 0x33, 0x02, 0x32, 0xd2,
                                                   0xfc, 0x5e, 0x1e, 0x87, 0x25, 0x5f, 0x72, 0x60};

inline const std::vector<uint8_t> kX25519EekPrivate{0x47, 0x66, 0x65, 0xdb, 0xaa, 0xe1, 0x1d, 0xdb,
                                                    0xd3, 0x03, 0xf7, 0xad, 0x68, 0xbb, 0xff, 0x8d,
                                                    0x90, 0xaf, 0x8a, 0x4f, 0xb8, 0xbf, 0x7c, 0xf3,
                                                    0x39, 0xc7, 0xe9, 0x73, 0xec, 0x70, 0x75, 0x8c};

inline const std::vector<uint8_t> kTestEekId{0x74, 0x65, 0x73, 0x74, 0x49, 0x64, 0x00};

inline const std::vector<uint8_t> kP256EekPublic{
        0xe0, 0x41, 0xcf, 0x2f, 0x0f, 0x34, 0x0f, 0x1c, 0x33, 0x2c, 0x41, 0xb0, 0xcf,
        0xd7, 0x0c, 0x30, 0x55, 0x35, 0xd2, 0x1e, 0x6a, 0x47, 0x13, 0x4b, 0x2e, 0xd1,
        0x48, 0x96, 0x7e, 0x24, 0x9c, 0x68, 0x1f, 0xce, 0x45, 0xc5, 0xfb, 0x61, 0xba,
        0x81, 0x21, 0xf9, 0xe5, 0x05, 0x9b, 0x9b, 0x39, 0x0e, 0x76, 0x86, 0x86, 0x47,
        0xb8, 0x1e, 0x2f, 0x45, 0xf1, 0xce, 0xaf, 0xda, 0x3f, 0x80, 0x68, 0xdb};

inline const std::vector<uint8_t> kP256EekPrivate{
        0x00, 0xd1, 0x0a, 0x51, 0x59, 0xb2, 0xa0, 0x39, 0x43, 0xc8, 0x58,
        0xf1, 0xdc, 0x3f, 0xc4, 0x0a, 0x03, 0x39, 0x31, 0x9d, 0x34, 0x01,
        0x8f, 0x30, 0xa9, 0xc4, 0x46, 0x7e, 0x64, 0x61, 0x35, 0x6d, 0xdf};

inline const std::vector<uint8_t> kLegacyCsrDeviceInfo{
        };

inline const std::vector<uint8_t> kLegacyCsrChallenge{0x01, 0x02, 0x03, 0x04, 0x05, 0x06,
                                                      0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c,
                                                      0x0d, 0x0e, 0x0f, 0x10};

inline const std::vector<uint8_t> kLegacyCsrProtectedData{
        };

inline const std::vector<uint8_t> kLegacyCsrKeysToSign1{
        0xa4, 0x01, 0x02, 0x20, 0x01, 0x21, 0x58, 0x20, 0xe5, 0xc5, 0x8e, 0x3f, 0xe4, 0x40, 0x9f,
        0xc3, 0x7f, 0x02, 0x98, 0xb1, 0x03, 0xef, 0xe9, 0x77, 0xc7, 0x05, 0xb4, 0x82, 0xa2, 0xed,
        0xd0, 0x72, 0x26, 0x00, 0xd0, 0x3c, 0x43, 0x05, 0xd7, 0xe9, 0x22, 0x58, 0x20, 0x72, 0x17,
        0x98, 0x87, 0x84, 0x6e, 0x1d, 0xcd, 0x6b, 0x0a, 0xdd, 0x6e, 0x08, 0x05, 0x7a, 0x98, 0xa2,
        0xc4, 0x04, 0x63, 0xe0, 0xd2, 0x24, 0xec, 0x33, 0x3b, 0xe0, 0x12, 0x0a, 0x3b, 0xda, 0x45,
};

inline const std::vector<uint8_t> kLegacyCsrKeysToSign2{
        0xa4, 0x01, 0x02, 0x20, 0x01, 0x21, 0x58, 0x20, 0x00, 0xb4, 0x79, 0x5c, 0x13, 0xa0, 0xa0,
        0x6c, 0xaf, 0xb1, 0x4b, 0x66, 0x5f, 0xd0, 0x98, 0x76, 0x12, 0x27, 0x5c, 0xb1, 0xcf, 0x0b,
        0x58, 0x00, 0x59, 0xa0, 0x0c, 0xa8, 0x22, 0x36, 0x39, 0x6f, 0x22, 0x58, 0x20, 0x60, 0xda,
        0x4a, 0x63, 0x10, 0x56, 0x29, 0xe1, 0xf5, 0x3a, 0xb5, 0xdc, 0x27, 0x52, 0xd1, 0x7b, 0xf8,
        0x0a, 0x43, 0x35, 0x29, 0x0f, 0xdc, 0xbc, 0xc7, 0x9c, 0xf6, 0x84, 0xa8, 0x00, 0x66, 0xe9};

inline const std::vector<uint8_t> kLegacyCsrKeysToSignMac{
        0xe1, 0x78, 0x98, 0x16, 0x4b, 0x02, 0xe4, 0xb9, 0x3e, 0x87, 0x3a,
        0x2b, 0xb7, 0x0c, 0xa6, 0xf1, 0x5e, 0xf5, 0xbb, 0xfd, 0x30, 0x41,
        0x7f, 0x3c, 0xf7, 0x50, 0x7e, 0xf2, 0x6f, 0x1a, 0x4e, 0x80};
...
TEST(RemoteProvUtils, validateCsrV1Functionality) {
    auto eekChain = EekChain{.chain = getProdEekChain(RpcHardwareInfo::CURVE_P256),
                             .last_pubkey = kP256EekPublic,
                             .last_privkey = kP256EekPrivate};
    auto rpcHardwareInfo = RpcHardwareInfo{.versionNumber = 2};
    auto keysToSign = cppbor::Array();
    keysToSign.add(cppbor::EncodedItem(kLegacyCsrKeysToSign1));
    keysToSign.add(cppbor::EncodedItem(kLegacyCsrKeysToSign2));

    auto result = verifyProductionProtectedData(
            DeviceInfo{kLegacyCsrDeviceInfo}, keysToSign, kLegacyCsrKeysToSignMac,
            ProtectedData{kLegacyCsrProtectedData}, eekChain, kTestEekId, rpcHardwareInfo,
            DEFAULT_INSTANCE_NAME, kLegacyCsrChallenge);
    ASSERT_TRUE(result) << result.message();
}
