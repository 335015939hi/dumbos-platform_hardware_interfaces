...
interface IKeyMintDevice {
     ...
     * == HMAC Keys ==
     *
     * Tag::KEY_SIZE must be provided to generate an HMAC key, and its value must be between 64 and
     * 512 bits (inclusive) and a multiple of 8.  If omitted or invalid, generateKey() must return
