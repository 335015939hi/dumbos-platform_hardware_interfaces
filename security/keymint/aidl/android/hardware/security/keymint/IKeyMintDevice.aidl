...
interface IKeyMintDevice {
     ...
     * operation.
     *
     * Implementations may return ErrorCode::UNIMPLEMENTED if they don't support wrapped storage
     * keys.
     *
     * May also return an ErrorCode from the underlying device (reported as a
