...
parcelable KeyCharacteristics {
     ...
     * A key can have different properties for it enforced by components of different security
     * levels. For example, some properties are provided by the platform and the IKeyMintDevice
     * uses them as-is.
