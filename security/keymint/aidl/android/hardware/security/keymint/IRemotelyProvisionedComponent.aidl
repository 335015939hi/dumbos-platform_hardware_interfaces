...
interface IRemotelyProvisionedComponent {
    ...
    /**
     * HALs such as KeyMint have rollback protections applied to the keys that they generate. Since
     * the IRPC HAL is designed to be added as a component onto these other HALs, these rollback
     * protections also apply to the keys that are generated through this interface.
     *
