...
interface IKeyMintOperation {
     ...
     *   used as the OAEP digest algorithm, MGF1 must be used as the mask generation function,
     *   and the digest specified with Tag::RSA_OAEP_MGF_DIGEST is used as the MGF1 digest
     *   algorithm (defaulting to SHA1 if this tag is absent).
     *
     * -- ECDSA keys --
     *
