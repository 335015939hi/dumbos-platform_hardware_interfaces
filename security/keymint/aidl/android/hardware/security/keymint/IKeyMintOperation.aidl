...
interface IKeyMintOperation {
     ...
     *
     * See the Authorization Enforcement section for update().
     *
     ...
     *
     * In this case, the key requires an authorization per operation, and this method must receive a
     * non-null and valid HardwareAuthToken.  For the auth token to be valid, all of the following
     * has to be true:
     *
     ...
     *
     * Authorization per operation keys must be authorized as described for begin().
     *
