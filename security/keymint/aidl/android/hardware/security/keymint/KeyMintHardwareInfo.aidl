...
parcelable KeyMintHardwareInfo {
    ...
    /**
     * keyMintName is the name of the IKeyMintDevice implementation. The name shall not be empty.
     */
     ...
     * to distinguish between different implementations from the same author. The name shall not be
     * empty.
     */
