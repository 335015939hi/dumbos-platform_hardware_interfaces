...
parcelable KeyCreationResult {
     ...
     *
     * There are a few variations in what is contained in these certificates, depending on whether
     ...
     *     contain only a single self-signed certificate.
     *
     ...
     *     chain must contain only a single certificate with an empty signature.
     *
