...
parcelable KeyCreationResult {
     ...
     *     key.  KeyMint implementations are not required to support factory-provisioned attestation
     *     keys.
     *
     ...
     * }
     *
     * Attestations generated by StrongBox KeyMint implementations shall not include the
     * rootOfTrust, osVersion, osPatchLevel, vendorPatchLevel or bootPatchLevel fields.  Callers
     * desiring confirmation of the device state must generate an attestation from a TEE KeyMint.
     */
