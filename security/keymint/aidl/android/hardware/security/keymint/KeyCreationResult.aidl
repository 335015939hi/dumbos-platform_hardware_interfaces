...
parcelable KeyCreationResult {
     ...
     * }
     *
     * StrongBox KeyMint implementations shall not include the rootOfTrust, osVersion, osPatchLevel,
     * vendorPatchLevel or bootPatchLevel fields.  Callers desiring confirmation of the device state
     * must generate an attestation from a TEE KeyMint.  In addition, StrongBox KeyMint
     * implementations shall not provision a factory attestation key so are unable to implement case
     * 1 above.
     */
