...
parcelable ProtectedData {
     ...
     *     AdditionalDKSignatures = {
     *         + SignerName => DKSignature
     *     }
     *
     *     SignerName = tstr
     *
     *     DKSignature = {
     *         format: int,                 // Format identifier indicating the comments of
     *                                      // the "chain" label. e.g. DKCoseKeyChainFormat
     *         chain: any
     *     }
     *
     *     DKCoseKeyChainFormat = 1
     *
     *     DKCoseKeyChain = [
     *         PubKeyEd25519 / PubKeyECDSA256,  // Root signing key for the DK platform provider
     *         + COSE_Sign1                     // Contains a chain of signatures rooted in the
     *                                          // root COSE_Key, terminating in the DK. The payload
     *                                         // of each signature is the subject key.
     *     ]
     *
