...
parcelable ProtectedData {
     ...
     *     // defines it's own configuration values for the Configuration Descriptor field. See
     ...
     *                                      // the "chain" label. e.g. DKCertChainFormat
     *         chain: any
     *     }
     *
     *     DKCertChainFormat = 1
     ...
     *     ]
     *
     *     CertificatePayload = {                       // CWT [RFC8392]
     *         1 : tstr,                                // Issuer
     *         2 : tstr,                                // Subject
     *         -4670552 : bstr .cbor PubKeyEd25519 /
     *                    bstr .cbor PubKeyECDSA256,    // Subject Public Key
     ...
     *     }
     *
     *     CertificateInput = [                         // COSE Sig_structure
     *         context: "Signature1",
     *         protected: bstr .cbor {
     *             1 : AlgorithmEdDSA / AlgorithmES256, // Algorithm
     *         },
