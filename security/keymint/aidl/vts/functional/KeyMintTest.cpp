...
TEST_P(ImportKeyTest, RsaOaepMGFDigestSuccess) {
    ...
    assert_mgf_digests_present_or_not_in_key_characteristics(key_characteristics_, mgf_digests,
                                                             true);
...
TEST_P(ImportKeyTest, RsaOaepMGFDigestDefaultSuccess) {
    ...
    assert_mgf_digests_present_or_not_in_key_characteristics(key_characteristics_, defaultDigest,
                                                             false);
}
...
TEST_P(EncryptionOperationsTest, RsaOaepSuccess) {
    ...
    assert_mgf_digests_present_or_not_in_key_characteristics(key_characteristics_, mgf_digest,
                                                             true);
