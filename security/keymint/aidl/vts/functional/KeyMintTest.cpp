...
TEST_P(EncryptionOperationsTest, Aes128CBCNoPaddingOneByteAtATime) {
    ...
    CheckEncryptOneByteAtATime(/*isStreamCipher*/ false, /*isAuthenticatedCipher*/ false, kat_key,
                               BlockMode::CBC, PaddingMode::NONE, kat_iv, kat_plaintext,
                               kat_ciphertext);
}
...
TEST_P(EncryptionOperationsTest, Aes128CBCPKCS7PaddingOneByteAtATime) {
    ...
    CheckEncryptOneByteAtATime(/*isStreamCipher*/ false, /*isAuthenticatedCipher*/ false, kat_key,
                               BlockMode::CBC, PaddingMode::PKCS7, kat_iv, kat_plaintext,
                               kat_ciphertext);
}
...
TEST_P(EncryptionOperationsTest, Aes128CTRNoPaddingOneByteAtATime) {
    ...
    CheckEncryptOneByteAtATime(/*isStreamCipher*/ true, /*isAuthenticatedCipher*/ false, kat_key,
                               BlockMode::CTR, PaddingMode::NONE, kat_iv, kat_plaintext,
                               kat_ciphertext);
}
...
TEST_P(EncryptionOperationsTest, Aes128ECBNoPaddingOneByteAtATime) {
    ...
    CheckEncryptOneByteAtATime(/*isStreamCipher*/ false, /*isAuthenticatedCipher*/ false, kat_key,
                               BlockMode::ECB, PaddingMode::NONE, "", kat_plaintext,
                               kat_ciphertext);
}
...
TEST_P(EncryptionOperationsTest, Aes128ECBPKCS7PaddingOneByteAtATime) {
    ...
    CheckEncryptOneByteAtATime(/*isStreamCipher*/ false, /*isAuthenticatedCipher*/ false, kat_key,
                               BlockMode::ECB, PaddingMode::PKCS7, "", kat_plaintext,
                               kat_ciphertext);
}
...
TEST_P(EncryptionOperationsTest, Aes128GCMNoPaddingOneByteAtATime) {
    ...
    CheckEncryptOneByteAtATime(/*isStreamCipher*/ true, /*isAuthenticatedCipher*/ true, kat_key,
                               BlockMode::GCM, PaddingMode::NONE, kat_iv, kat_plaintext,
                               kat_ciphertext);
}
...
TEST_P(EncryptionOperationsTest, Aes192CBCNoPaddingOneByteAtATime) {
    if (SecLevel() == SecurityLevel::STRONGBOX) {
        GTEST_SKIP() << "Key size 192 not supported by Strongbox.";
    }
