...
TEST_P(EarlyBootKeyTest, DISABLED_FullTest) {
    ...
    EXPECT_TRUE(
            contains(HwEnforcedAuthorizations(aesKeyData.characteristics), TAG_EARLY_BOOT_ONLY));
    EXPECT_TRUE(
            contains(HwEnforcedAuthorizations(hmacKeyData.characteristics), TAG_EARLY_BOOT_ONLY));
    EXPECT_TRUE(
            contains(HwEnforcedAuthorizations(rsaKeyData.characteristics), TAG_EARLY_BOOT_ONLY));
    EXPECT_TRUE(
            contains(HwEnforcedAuthorizations(ecdsaKeyData.characteristics), TAG_EARLY_BOOT_ONLY));
