...
TEST_P(NewKeyGenerationTest, EcdsaAttestationTags) {
    ...
    auto extra_tags = AuthorizationSetBuilder()
                              ...
                              .Authorization(TAG_USAGE_EXPIRE_DATETIME, 1619621648000)
                              ...
                              .Authorization(TAG_ATTESTATION_APPLICATION_ID, "opaque_der_blob");
    ...
    // Device attestation IDs should be rejected for normal attestation requests.
