...
TEST_P(ImportKeyTest, RsaOaepMGFDigestSuccess) {
    ...
    check_mgf_digests(key_characteristics_, mgf_digests);
 ...
 * Test should import RSA key with OAEP padding and deafult mgf-digest (SHA1) and
...
TEST_P(ImportKeyTest, RsaOaepMGFDigestDefaultSuccess) {
    ...
    ASSERT_FALSE(is_mgf_digest_exists(key_characteristics_, Digest::SHA1));
...
TEST_P(EncryptionOperationsTest, RsaOaepSuccess) {
    ...
    ASSERT_TRUE(is_mgf_digest_exists(key_characteristics_, mgf_digest));
...
TEST_P(EncryptionOperationsTest, RsaOaepWithMGFDigestSuccess) {
    ...
    // Make sure explicitly specified mgf-digests exist in key characteristics.
    check_mgf_digests(key_characteristics_, digests);
