...
/*
 * EncryptionOperationsTest.DESedeCBCNoPaddingOneByteAtATime
 * Verifies input and output sizes of DESede/CBC/NoPadding Algorithm.
 */
TEST_P(EncryptionOperationsTest, DESedeCBCNoPaddingOneByteAtATime) {
    string kat_key = hex2str("5EBE2294ECD0E0F08EAB7690D2A6EE6926AE5CC854E36B6B");
    string kat_iv = hex2str("DFCA366848DEA6BB");
    string kat_plaintext = hex2str("31323334353637383132333435363738");
    string kat_ciphertext = hex2str("e70bb5761d796d7b0eb40b5b60deb6a9");
    DESedeCheckEncryptOneByteAtATime(kat_key, BlockMode::CBC, PaddingMode::NONE, kat_iv,
                                     kat_plaintext, kat_ciphertext);
}

/*
 * EncryptionOperationsTest.DESedeCBCPKCS7PaddingOneByteAtATime
 * Verifies input and output sizes of DESede/CBC/PKCS7Padding Algorithm.
 */
TEST_P(EncryptionOperationsTest, DESedeCBCPKCS7PaddingOneByteAtATime) {
    string kat_key = hex2str("5EBE2294ECD0E0F08EAB7690D2A6EE6926AE5CC854E36B6B");
    string kat_iv = hex2str("DFCA366848DEA6BB");
    string kat_plaintext = hex2str("31323334353637383132333435363738");
    string kat_ciphertext = hex2str("e70bb5761d796d7b0eb40b5b60deb6a9726f72d97cf2ada4");
    DESedeCheckEncryptOneByteAtATime(kat_key, BlockMode::CBC, PaddingMode::PKCS7, kat_iv,
                                     kat_plaintext, kat_ciphertext);
}

/*
 * EncryptionOperationsTest.DESedeECBNoPaddingOneByteAtATime
 * Verifies input and output sizes of DESede/ECB/NoPadding Algorithm.
 */
TEST_P(EncryptionOperationsTest, DESedeECBNoPaddingOneByteAtATime) {
    string kat_key = hex2str("5EBE2294ECD0E0F08EAB7690D2A6EE6926AE5CC854E36B6B");
    string kat_plaintext = hex2str("31323334353637383132333435363738");
    string kat_ciphertext = hex2str("ade119f9e35ab3e9ade119f9e35ab3e9");
    DESedeCheckEncryptOneByteAtATime(kat_key, BlockMode::ECB, PaddingMode::NONE, "", kat_plaintext,
                                     kat_ciphertext);
}

/*
 * EncryptionOperationsTest.DESedeECBPKCS7PaddingOneByteAtATime
 * Verifies input and output sizes of DESede/ECB/PKCS7Padding Algorithm.
 */
TEST_P(EncryptionOperationsTest, DESedeECBPKCS7PaddingOneByteAtATime) {
    string kat_key = hex2str("5EBE2294ECD0E0F08EAB7690D2A6EE6926AE5CC854E36B6B");
    string kat_plaintext = hex2str("31323334353637383132333435363738");
    string kat_ciphertext = hex2str("ade119f9e35ab3e9ade119f9e35ab3e94bcb01bbc0d05526");
    DESedeCheckEncryptOneByteAtATime(kat_key, BlockMode::ECB, PaddingMode::PKCS7, "", kat_plaintext,
                                     kat_ciphertext);
}
