...
TEST_P(NewKeyGenerationTest, RsaZenHotdog) {
    ...
    AidlBuf app_id("This is a long application ID that will be bound into the encrypted keyblob");
    AidlBuf app_data(
            "This is long chunk of application specific data that will be bound into the encrypted "
            "keyblob");
    auto attest_app_id =
    ...
    auto builder = AuthorizationSetBuilder()
                           ...
                           .Authorization(TAG_APPLICATION_ID, app_id)
