...
// `ro.product.<property>`.
template <Tag tag>
void addAttestationId(AuthorizationSetBuilder* attestation_id_tags,
                      TypedTag<TagType::BYTES, tag> ttag, const char* prop) {
    ...
    if (!prop_value.empty()) {
        add_tag_from_prop(attestation_id_tags, ttag, prop_name.string());
    } else {
...
TEST_P(AttestKeyTest, EcdsaAttestationID) {
    ...
    addAttestationId(&attestation_id_tags, TAG_ATTESTATION_ID_BRAND, "brand");
    addAttestationId(&attestation_id_tags, TAG_ATTESTATION_ID_DEVICE, "device");
    addAttestationId(&attestation_id_tags, TAG_ATTESTATION_ID_PRODUCT, "name");
    addAttestationId(&attestation_id_tags, TAG_ATTESTATION_ID_MANUFACTURER, "manufacturer");
    addAttestationId(&attestation_id_tags, TAG_ATTESTATION_ID_MODEL, "model");
