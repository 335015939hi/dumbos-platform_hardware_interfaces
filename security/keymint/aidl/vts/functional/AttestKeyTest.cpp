...
class AttestKeyTest : public KeyMintAidlTestBase {
  ...
  protected:
    ...
    const string FEATURE_STRONGBOX_KEYSTORE =
    ...
    bool is_strongbox_enabled(void) const {
        if (DeviceSupportsFeature(FEATURE_STRONGBOX_KEYSTORE)) {
    ...
    // Check if chipset is to be launched with Android S (or later) with
    ...
    bool is_chipset_allowed_km4_strongbox(void) const {
        ...
        const string allowed_soc_models[] = {
                "SM8450", "SM8475", "SM8550", "SXR2230P"
        };
    ...
    //    that allows Android S (or later) versions to be launched with
    //    KeyMaster 4.0 in StrongBox
