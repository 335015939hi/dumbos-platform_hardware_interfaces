...
void check_cose_key(const vector<uint8_t>& data, bool testMode) {
    ...
    ASSERT_TRUE(parsedPayload->asMap()->get(-2)->asBstr()) << "value with key -2 was not a bstr";
    ...
    ASSERT_TRUE(parsedPayload->asMap()->get(-3)->asBstr()) << "value  with key -3 was not a bstr";
