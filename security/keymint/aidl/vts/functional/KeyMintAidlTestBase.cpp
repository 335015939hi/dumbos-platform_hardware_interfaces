...
void KeyMintAidlTestBase::DESedeCheckEncryptOneByteAtATime(const string& key, BlockMode block_mode,
    ...
    CheckEncryptOneByteAtATime(block_mode, 8 /*block_size*/, padding_mode, iv, plaintext,
                               exp_cipher_text);
}
...
void KeyMintAidlTestBase::CheckEncryptOneByteAtATime(BlockMode block_mode, const int block_size,
    ...
    if (is_stream_cipher) {
        ...
        // StrongBox doesn't require 1:1 in:out, so just compare the full ciphertext.
