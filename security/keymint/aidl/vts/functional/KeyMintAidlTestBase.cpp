...
bool KeyMintAidlTestBase::IsRkpSupportRequired() const {
    // This technically contradicts VSR-12 requirements, but when Android 12
    // shipped, there was a bug that skipped the tests if KeyMint 2 was not
    // present. As a result, many chipsets were allowed to ship without RKP
    // support. The RKP requirements were hardened in VSR-13.
