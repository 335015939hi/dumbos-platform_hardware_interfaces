...
std::set<std::string> getAllowedVbStates() {
    static const std::set<std::string> set{"green", "yellow", "orange"};
    return set;
}

std::set<std::string> getAllowedBootloaderStates() {
    static const std::set<std::string> set{"locked", "unlocked"};
    return set;
}

std::set<std::string> getAllowedSecurityLevels() {
    static const std::set<std::string> set{"tee", "strongbox"};
    return set;
}

std::set<std::string> getAllowedAttIdStates() {
    static const std::set<std::string> set{"locked", "open"};
    return set;
}
