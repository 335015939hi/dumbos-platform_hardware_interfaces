  ...
  public:
    virtual void SetUp() override {
        ...
        std::shared_ptr<::keymaster::AndroidKeymaster> sharedKm =
                std::shared_ptr<::keymaster::AndroidKeymaster>(new ::keymaster::AndroidKeymaster(
                        [&]() -> auto {
                            auto context = new PureSoftKeymasterContext(
                                    KmVersion::KEYMINT_1, static_cast<keymaster_security_level_t>(
        ...
        provisionable_ = ndk::SharedRefBase::make<RemotelyProvisionedComponent>(sharedKm);
    }
 ...
 */
TEST_F(GenerateKeyTests, generateEcdsaP256Key_prodMode) {
 ...
 */
TEST_F(GenerateKeyTests, generateEcdsaP256Key_testMode) {
    MacedPublicKey macedPubKey;
    bytevec privateKeyBlob;
    bool testMode = true;
    auto status = provisionable_->generateEcdsaP256KeyPair(testMode, &macedPubKey, &privateKeyBlob);
 ...
 * content.
 */
TEST_F(CertificateRequestTest, EmptyRequest_testMode) {
    bool testMode = true;
 ...
 * able to decrypt.
 */
TEST_F(CertificateRequestTest, EmptyRequest_prodMode) {
    bool testMode = false;
    bytevec keysToSignMac;
    ProtectedData protectedData;
    auto challenge = randomBytes(32);
 ...
 */
TEST_F(CertificateRequestTest, NonEmptyRequest_testMode) {
    bool testMode = true;
 ...
 * able to decrypt.
 */
TEST_F(CertificateRequestTest, NonEmptyRequest_prodMode) {
    bool testMode = false;
    generateKeys(testMode, 4 /* numKeys */);
 ...
 */
TEST_F(CertificateRequestTest, NonEmptyRequest_prodKeyInTestCert) {
 ...
 */
TEST_F(CertificateRequestTest, NonEmptyRequest_testKeyInProdCert) {
