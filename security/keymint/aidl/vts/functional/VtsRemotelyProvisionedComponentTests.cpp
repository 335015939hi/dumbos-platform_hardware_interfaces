 ...
 */
TEST_F(GenerateKeyTests, generateEdd25519Key_prodMode) {
    MacedPublicKey macedPubKey;
    bytevec privateKeyBlob;
    bool testMode = false;
    auto status = provisionable_->generateEd25519KeyPair(testMode, &macedPubKey, &privateKeyBlob);
 ...
 */
TEST_F(GenerateKeyTests, generateEdd25519_testMode) {
    MacedPublicKey macedPubKey;
    bytevec privateKeyBlob;
    bool testMode = true;
    auto status = provisionable_->generateEd25519KeyPair(testMode, &macedPubKey, &privateKeyBlob);
  ...
  protected:
    ...
    void generateKeys(bool testMode, size_t numKeys) {
        ...
        for (auto& key : keysToSign_) {
            bytevec privateKeyBlob;
            auto status = provisionable_->generateEd25519KeyPair(testMode, &key, &privateKeyBlob);
