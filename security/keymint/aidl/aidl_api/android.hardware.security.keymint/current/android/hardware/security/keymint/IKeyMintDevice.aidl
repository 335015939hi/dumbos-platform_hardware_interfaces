...
interface IKeyMintDevice {
  ...
  @nullable android.hardware.security.keymint.CertificateChain generateKey(in android.hardware.security.keymint.KeyParameter[] keyParams, out android.hardware.security.keymint.ByteArray generatedKeyBlob, out android.hardware.security.keymint.KeyCharacteristics generatedKeyCharacteristics);
  @nullable android.hardware.security.keymint.CertificateChain importKey(in android.hardware.security.keymint.KeyParameter[] keyParams, in android.hardware.security.keymint.KeyFormat keyFormat, in byte[] keyData, out android.hardware.security.keymint.ByteArray importedKeyBlob, out android.hardware.security.keymint.KeyCharacteristics keyCharacteristics);
  @nullable android.hardware.security.keymint.CertificateChain importWrappedKey(in byte[] wrappedKeyData, in byte[] wrappingKeyBlob, in byte[] maskingKey, in android.hardware.security.keymint.KeyParameter[] unwrappingParams, in long passwordSid, in long biometricSid, out android.hardware.security.keymint.ByteArray importedKeyBlob, out android.hardware.security.keymint.KeyCharacteristics keyCharacteristics);
