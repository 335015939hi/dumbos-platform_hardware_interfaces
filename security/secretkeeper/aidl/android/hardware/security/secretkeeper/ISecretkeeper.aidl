...
interface ISecretkeeper {
     ...
     * cryptographically secure channel. The client acts as P1 (source) and Secretkeeper as
     * P2 (sink). The interface returned here can be used to invoke methods on the sink.
     *
