...
CredentialData::CredentialData(bool in_testCredential, std::vector<uint8_t>& in_challenge,
...
void CredentialData::setCredentialKeys(std::vector<uint8_t>& priKey, std::vector<uint8_t>& pubKey) {
...
CredentialData::presentationPackageGenerate(uint64_t validityPeriodMillis, uint64_t currentTime) {
...
std::optional<std::vector<uint8_t>> CredentialData::getEncryptedCredData(
...
bool CredentialData::currentPresentationPackageSet(
...
void CredentialData::clearPresentationPackage() {
    mUsageCount = 0;
...
std::optional<std::vector<uint8_t>> CredentialData::getCurrentSigningCertificate() {
...
void CredentialData::resetUsageCount() {
    mUsageCount = 0;
}

uint32_t CredentialData::getUsageCount() {
    return mUsageCount;
}
}  // namespace aidl::android::security::identity::direct_access
