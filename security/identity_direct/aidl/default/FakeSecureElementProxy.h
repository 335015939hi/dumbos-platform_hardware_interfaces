...
#include "common/SecureHardwareDirectAccessProvisioningProxy.h"
...
class FakeSecureElementProxy : public SecureHardwareDirectAccessProvisioningProxy {
  public:
    FakeSecureElementProxy();
    ~FakeSecureElementProxy() {}
    ...
    int32_t presentationPackageGenerate(uint32_t credentialSlot, uint64_t validityPeriodMillis,
  ...
  private:
    std::vector<std::shared_ptr<ProvisionData>> mProvisionData;
};
