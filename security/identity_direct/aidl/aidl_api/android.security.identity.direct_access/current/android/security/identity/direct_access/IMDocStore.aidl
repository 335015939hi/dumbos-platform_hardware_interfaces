...
interface IMDocStore {
  ...
  android.hardware.identity.Certificate[] createMDocCredential(in int credentialSlot, in boolean testCredential, in byte[] challenge);
  android.security.identity.direct_access.IMDocCredential lookupMDocCredential(in int credentialSlot);
