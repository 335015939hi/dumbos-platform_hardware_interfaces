...
/**
 * DICE input values for certificate and CDI generation as defined here:
 * https://pigweed.googlesource.com/open-dice/+/refs/heads/main/docs/specification.md#input-values
 * @hide
 */
