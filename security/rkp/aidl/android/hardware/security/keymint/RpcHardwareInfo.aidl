...
parcelable RpcHardwareInfo {
     ...
     * here must match the version reported in the top level AuthenticatedRequest produced by the
     * HAL interface. This field primarily acts as a convenience for the system components
     * interacting with the HALs.
     */
    int versionNumber;
