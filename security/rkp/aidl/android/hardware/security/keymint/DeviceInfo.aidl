...
parcelable DeviceInfo {
     ...
     * canonicalized according to the Length-First Map Key Ordering specified in RFC 8949,
     * Section 4.2.3. The ordering presented here is non-canonical to group similar entries
     * semantically.
     *
