...
keys to for specific applications, like Widevine, and for services, like VM
attestation. These privileged VMs are identified by their DICE chain through a
combination of the [RKP VM marker][rkp-vm-marker] (key `-70006`) and the
component name.
