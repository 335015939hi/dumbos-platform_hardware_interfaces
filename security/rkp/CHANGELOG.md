...
## Releases
* **Android S (12):**
  * Introduce IRemotelyProvisionedComponent v1
* **Android T (13):**
  * Introduce IRemotelyProvisionedComponent v2
* **Android U (14):**
  * Introduce IRemotelyProvisionedComponent v3
  * Split build of RKP HAL from KeyMint HAL.
...
* The RKP HAL now builds separately from KeyMint.
  ...
  * Source files that reference the generated code for RKP must use the new
    include path: `"aidl/android/hardware/security/rkp"` (instead of
